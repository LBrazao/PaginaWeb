...
<head>
	...
	<title>noticia generallllll</title>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td width="70%" valign="top" class="seccionNoticia"> <!--NOTICIA-->
				...
				<div class="tituloNoticia">noticia generallllll</div><br>
				
				<table style="font-size:25px;"> <tr> 
					<td width="700">18/04/2018</td> 
					<td width="700" style="color:red;text-align:right"> </td>
				</tr></table><br>
				
				<div>
					<div class="video_en_vivo" style="border-bottom:3px solid #FF0000"><iframe src="https://www.youtube.com/embed/_3UlWhZig_o" scrolling="no" frameborder="0" name="contenedor_videos_categoria" id="contenedor_videos_categoria">    </iframe></div>
				</div><br>
...
En el sector privado, las empresas que gozan de la máxima calificación AAA por parte de Fix son Arcor, PAE, YPF, Banco Nación, BICE, BBVA Francés, Santander Río, HSBC, Itaú y Cetelem.
			...
			<tr>
				...
				<td width="209"  style="background-color:#FFFFFF; border-radius:7px;">
					...
					<?php
						mostrar_noticia(6,'inicio-horizontal.html');
					?>
