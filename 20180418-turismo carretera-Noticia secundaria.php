...
<head>
	...
	<title>Noticia secundaria</title>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td width="70%" valign="top" class="seccionNoticia"> <!--NOTICIA-->
				...
				<div class="tituloNoticia">Noticia secundaria</div><br>
				...
				<div>
					<img id="imagen_noticia" src="./fotos/sabado021cross1chico.jpg" width="80%" style="display:block;margin:auto;" />
				</div><br>
