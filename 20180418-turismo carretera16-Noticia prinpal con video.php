...
<head>
	...
	<title>Noticia prinpal con video</title>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td width="70%" valign="top" class="seccionNoticia"> <!--NOTICIA-->
				...
				<div class="tituloNoticia">Noticia prinpal con video</div><br>
				...
				<div>
					<div class="video_en_vivo" style="border-bottom:3px solid #FF0000"><iframe src="https://www.youtube.com/embed/frX266zsV8E" scrolling="no" frameborder="0" name="contenedor_videos_categoria" id="contenedor_videos_categoria">    </iframe></div>
				</div><br>
