...
<head>
	...
	<title>Noticia secundaria en categoria  con video </title>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td width="70%" valign="top" class="seccionNoticia"> <!--NOTICIA-->
				...
				<div class="tituloNoticia">Noticia secundaria en categoria  con video </div><br>
				...
				<div>
					<div class="video_en_vivo" style="border-bottom:3px solid #FF0000"><iframe src="https://www.youtube.com/embed/qMxX-QOV9tI" scrolling="no" frameborder="0" name="contenedor_videos_categoria" id="contenedor_videos_categoria">    </iframe></div>
				</div><br>
				
				<div class="desarrollo_noticia cuerpoNoticia">
					Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria <br>Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria <br><br>Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria Noticia principal en categoria v<br>
				</div> <br>
				
				<div>
					<img id="imagen_noticia" src="./fotos/auto.jpg" width="80%" style="display:block;margin:auto;" />
				</div><br>
