...
<head>
	...
	<title>prueba con archivo texto </title>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td width="70%" valign="top" class="seccionNoticia"> <!--NOTICIA-->
				...
				<div class="tituloNoticia">prueba con archivo texto </div><br>
				
				<table style="font-size:25px;"> <tr> 
					<td width="700">21/05/2018</td> 
					<td width="700" style="color:red;text-align:right">tc pista</td>
				</tr></table><br>
				...
				<div class="desarrollo_noticia cuerpoNoticia">
					prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto <br><br>prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto v<br>prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto prueba con archivo texto 
				</div>
