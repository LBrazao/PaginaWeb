	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td width="70%" valign="top" class="seccionNoticia"> <!--NOTICIA-->
				...
				<div class="tituloNoticia">prionci</div><br>
				
				<table style="font-size:25px;"> <tr> 
					<td width="700">07/06/2018</td> 
					<td width="700" style="color:red;text-align:right">turismo carretera</td>
				</tr></table><br>
				
				<div>
					<img id="imagen_noticia" src="./fotos/bicentenario002.jpg" width="80%" style="display:block;margin:auto;" />
				</div><br>
				
				<div class="desarrollo_noticia cuerpoNoticia">
					 sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda sadasdasadasda
				</div>
