...
<title>PRUEBA DE NOTICIA | TC La Revista</title>
...
echo $carga;
$carga=file_get_contents("cabeza fecha TC 1.html");
echo $carga;
?>
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">PRUEBA DE NOTICIA</span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">31 de enero del 2016 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              <td width="35%"><div align="right" class="Estilo15">Por Pablo Barraza </div></td>
            </tr>
            <tr>
              <td colspan="2"><span class="Estilo11"><iframe src="http://www.youtube.com/embed/hAc5tTOTKwc" width="754" height="425" frameborder="0" allowfullscreen="allowfullscreen"></iframe></span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/TC-fecha1-PRUEBA DE NOTICIAphp" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div> <iframe
  src="https://platform.twitter.com/widgets/tweet_button.html?size=l&url=https%3A%2F%2Fdev.twitter.com%2Fweb%2Ftweet-button&via=TCLAREVISTA=twitterapi%2Ctwitter&text=PRUEBA DE NOTICIA"
  width="140"
  height="28"
  scrolling="no"
  ...
  style="border: 0; overflow: hidden;">
          ...
          <p><span class="Estilo11">Esta <i><b>es una pr</b></i>ueba de ar<b>mado de noticias</b></span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/TC-fecha1-PRUEBA DE NOTICIAphp" data-width="504" data-numposts="5" data-colorscheme="light"></div>
