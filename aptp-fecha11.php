...
<title>Turismo Pista en Junín | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Junín<br />
        ...
        <div class="subtitle">FECHA 11 | TURISMO PISTA </div></td>
...
$cadena=file_get_contents('aptp-fecha11-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTPf11.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("aptp-fecha11-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("aptp-fecha11-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("aptp-fecha11-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTPf11.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_vitwLhdBYYBa8MDULfwEj1z1D9aUTYUFbtEY1ZCIKEz"><a href="http://www.tutiempo.net">Tutiempo.net</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vitwLhdBYYBa8MDULfwEj1z1D9aUTYUFbtEY1ZCIKEz"></script></td>
        </tr>
      </table></td>
  </tr>
</table>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div style="padding:4px"> <a href="tc-fecha16.php"><img src="boton fecha tc.png" width="187" height="34" border="0" /></a><br />
							<a href="tcpista-fecha16.php"><img src="boton fecha tc pista.png" width="187" height="34" border="0" /></a><br />
                            </div></td>
                      </tr>
                  </table>
