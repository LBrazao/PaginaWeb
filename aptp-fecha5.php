...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">La Plata <br />
        ...
        <div class="subtitle">FECHA 5 | TURISMO PISTA </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">DURACIÓN:</span> 14 y 16 vueltas <br />
...
$cadena=file_get_contents('aptp-fecha5-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTPf5.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("aptp-fecha5-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("aptp-fecha5-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("aptp-fecha5-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTPf5.php');
echo $cadena;
?>
          </div></div>
	  ...
	  <table width="314" height="120" border="0" cellpadding="0" cellspacing="0" background="fondo clima.jpg" style="margin-left:5px">
        <tr>
          <td><!-- www.TuTiempo.net - Ancho:312px - Alto:120px -->
              <div id="TT_RhtAbhdhtc8a81DULAw1jkDEjtaU1YW2rt1tEsyoa1z"><a href="http://www.tutiempo.net/argentina/posadas.html">Pronóstico meteorológico para Posadas</a></div>
            <script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RhtAbhdhtc8a81DULAw1jkDEjtaU1YW2rt1tEsyoa1z"></script></td>
        </tr>
      </table></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><div class="newsfecha">
                  <?php
$cadena=file_get_contents('TP.php');
echo $cadena;
?>
                </div>
                    <table style="margin-top:4px; margin-right:8px" width="151" border="0" align="right" cellpadding="0" cellspacing="0">
                      <tr>
                        <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasnoticias" href="aptp-noticias.php">MAS NOTICIAS</a></li></td>
                      </tr>
                  </table></td>
              </tr>
            </table>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Renzo Cerretti (Previa) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="cerretti.jpg" width="120" height="140" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;No se ha logrado coronar un buen resultado en San Jorge pero estamos en busca de ese resultado, confiando en poder conseguirlo en La Plata, dónde volveremos a utilizar el Ford Ka que hemos usado en la primera parte del año y que nos ha dado grandes alegrías en la pasada temporada. Le agradezco como siempre al equipo por el trabajo brindado y todas las publicidades que nos apoyan de manera constante&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
