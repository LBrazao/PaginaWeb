...
<title>Turismo Pista en La Plata | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">San Luis <br />
        ...
        <div class="subtitle">FECHA 9 | TURISMO PISTA </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">DURACIÓN:</span> 15 vueltas <br />
...
$cadena=file_get_contents('aptp-fecha9-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
<div style="margin-left:5px;">
      ...
      <table width="314" height="360" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
        <tr>
          <td valign="top">
		  <script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTPf9.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("aptp-fecha9-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("aptp-fecha9-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("aptp-fecha9-noticias.php");
        }, 60000);
    });
</script> 

<div id="tv1" class="tv1-sinaltura" style="height:308px">
<div id="actualizacion" class="news"><?php
$cadena=file_get_contents('onlineTPf9.php');
echo $cadena;
?>
          </div></div>
            ...
            <table width="309" height="37" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="151" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:4px">
                  <tr>
                    <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasnoticias" href="aptp-posiciones.php">CAMPEONATO</a></li></td>
                  </tr>
                </table></td>
                <td><table width="151" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:4px">
                  <tr>
                    <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasnoticias" href="aptp-calendario.php">CARRERAS</a></li></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
...
<div id="TT_vitArBYxYcWc8L6ULAwkD1j1D9lU1Y8FbYktEZyIKkz">El tiempo por Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vitArBYxYcWc8L6ULAwkD1j1D9lU1Y8FbYktEZyIKkz"></script></td>
        </tr>
      </table></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/IgFOp8mXVT0" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
						  ...
						  <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('aptp-fecha9-videos.php');
echo $cadena;
?>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="211" height="27"><span class="Estilo125">Rafael Fossaceca (Previa) </span></td>
                                <td width="46"><div align="right" class="Verdanamarron">
                                  <table width="46" height="19" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFF00">
                                    <tr>
                                      <td><div align="center" class="Estilo126">3</div></td>
                                    </tr>
                                  </table>
                                </div></td>
                              </tr>
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="fossaceca.jpg" width="120" height="166" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;El auto está listo para el fin de semana, se hizo un repaso general, un trabajo exhaustivo para controlar elementos tanto del chasis como del motor, cambios de pastillas y discos de frenos y todo aquello que hiciera falta para estar tranquilo en un circuito exigente como este y donde no se puede regalar nada en este momento del campeonato. la expectativa es  la misma de todos, ya que hay que conocer el circuito, andar lo más rápido posible sin especulaciones y dar lo mejor de nosotros para cerrar un buen fin de semana&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
              ...
              <table width="265" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"> <a href="tc-fecha13.php"><img src="boton fecha tc.png" width="187" height="34" border="0" /></a><br />
                              ...
                              <a href="crosscountry1-fecha11.php"><img src="boton fecha cross country mundial.png" width="187" height="34" border="0" /></a></div></td>
                      </tr>
                  </table>
