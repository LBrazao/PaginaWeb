...
.resultados tbody tr:first-child, resultados tbody tr:nth-child(50n+2){
display:none;
}
...
.resultados tbody tr:nth-child(50n+3), .resultados tbody tr td:first-child{
font-weight:bold;
color:#FF0000;
text-align:center;
}
...
<table width="341" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="535"><span style="font-family:Arial, Helvetica, sans-serif" class="Estilo9 Estilo1 Estilo7"><strong><i>Carrera 2 (Clase 1) </i>           </strong></span><span class="Estilo6"> - <u>FINALIZADO</u></span></td>
  </tr>
</table> 

<?php

$twit = file_get_contents('http://aptpweb.com.ar/resultados/2015/2015-10/c1fi2.html');
