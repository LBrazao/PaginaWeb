...
<title>Argentinos en el exterior | Facundo Regal&iacute;a, Tati Mercado, Pechito L&oacute;pez, Sebasti&aacute;n Porto, Ezequiel Iturrioz</title>
  ...
  <tr>
    <td valign="top"><div style="padding:8px;">
      <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
        <tr>
          <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="argentinos-regalia-presentacion.jpg" width="233" height="136" border="0"/><br />
                  <div class="playfoto"><a href="argentinos-regalia-presentacion.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1"/></a></div>
          </div></td>
          <td width="348"><div style="padding:4px;"><a href="argentinos-regalia-presentacion.php" class="titulofotos">Presentaci&oacute;n Regal&iacute;a GP2 </a><br />

 						  <a href="argentinos-regalia-presentacion.php" class="subtitulofotos">VER FOTOS >></a></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
