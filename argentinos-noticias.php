...
<head>
<title>Argentinos en el exterior | Facundo Regalía, Tati Mercado, Pechito López, Sebastián Porto, Ezequiel Iturrioz</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="775" valign="top"><div class="cabezaenvivo"><span class="textoenvivo">NOTICIAS</span></div> 
      <table width="775" height="1006" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
  <tr>
    <td valign="top"><div style="padding:8px;"><span class="noticias1">
      <?php
$cadena=file_get_contents('ARG.php');
echo $cadena;
?>
    </span></div></td>
  </tr>
