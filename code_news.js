            ...
            init: function(e) {
                ...
                return this.each(function() {
                    ...
                    if (e.horizontalScroll) {
                        ...
                        k.wrapInner("<table class='mCSB_container' style='position:absolute; left:0;' />").children(".mCSB_container").css({
                            width: k.children().outerWidth(),
                            position: "relative"
                        }).unwrap()
                    } else {
                        g.wrapInner("<table class='mCSB_container' style='position:relative; top:0;' />")
                    }
