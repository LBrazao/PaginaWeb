...
<title>Rally Cross Country Argentino | Calendario</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="775" valign="top"><div class="cabezaenvivo"><span class="textoenvivo">CALENDARIO</span></div> 
      <table width="775" height="437" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
  <tr>
    <td valign="top"><div style="padding:8px;">
      <table class="tablacalendar" width="636" border="0" cellspacing="0" cellpadding="0">
        <tr id="fecha_activa" onclick="window.open('crosscountry-fecha1.php','_self')">
          <td><div align="center" class="titulodepie"><span class="Estilo2">1.</span></div></td>
          <td><span class="titulodepie">20 de Marzo </span></td>
          <td><span class="titulodepie"><strong>Mina Clavero </strong></span></td>
          <td><div align="center"><img src="play calendario.png" alt="a" width="35" height="35" /></div></td>
        </tr>
        <tr id="fecha_activa" onclick="window.open('desafiortua40.html','_self')">
          <td width="64" height="35"><div align="center" class="titulodepie"><span class="Estilo2">2.</span></div></td>
          <td width="184"><span class="titulodepie">17 al 23 de Junio </span></td>
          <td><span class="titulodepie"><strong>Desaf&iacute;o Ruta 40 </strong></span></td>
          <td><div align="center"><img src="play calendario.png" alt="a" width="35" height="35" /></div></td>
        </tr>
        <tr id="fecha_activa" onclick="window.open('crosscountry-fecha3.php','_self')">
          <td><div align="center" class="titulodepie"><span class="Estilo2">3.</span></div></td>
          <td><span class="titulodepie">7 de Agosto </span></td>
          <td><span class="titulodepie"><strong>La Cumbre </strong></span></td>
          <td><div align="center"><img src="play calendario.png" alt="a" width="35" height="35" /></div></td>
        </tr>
        <tr id="fecha_activa" onclick="window.open('crosscountry-fecha4.php','_self')">
        ...
        <tr id="fecha_activa" onclick="window.open('crosscountry-fecha5.php','_self')">
          <td><div align="center" class="titulodepie"><span class="Estilo2">5.</span></div></td>
          <td width="184"><span class="titulodepie">30 de octubre </span></td>
