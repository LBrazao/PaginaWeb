...
<title>Rally Cross Country de Chos Malal | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Chos Malal <br />
    </div>
        <div class="subtitle">FECHA 5 | CROSS COUNTRY  </div></td>
    <td width="489">&nbsp;</td>
  </tr>
</table>
...
$cadena=file_get_contents('crosscountry-fecha5-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineCARCCf5.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("crosscountry-fecha5-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("crosscountry-fecha5-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("crosscountry-fecha5-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineCARCCf5.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_thtgLxYhYaDaWTpU1AwkDkDkjtaUMYc2bt1YkZi5K1j">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_thtgLxYhYaDaWTpU1AwkDkDkjtaUMYc2bt1YkZi5K1j"></script></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/3qtOREqkb6U" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <div id="actualizacion_videos">
                        <?php
$cadena=file_get_contents('crosscountry-fecha5-videos.php');
echo $cadena;
?>
                      </div>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="207" height="27"><span class="Estilo125">Juan Manuel Silva (Previa) </span></td>
                                    ...
                                    <table width="49" height="23" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="49"><table width="46" height="19" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFF00">
                                            <tr>
                                              <td><div align="center" class="Estilo126">303</div></td>
                                            </tr>
                                        </table></td>
                                      </tr>
                                    </table>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="silva3.jpg" width="120" height="167" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Para mí no va a ser una carrera tan fuerte como en el Desafío Ruta 40. Allí surgieron muchos inconvenientes que se repararon para esta y vamos a ir a probar esas modificaciones pero no va a ser una carrera de tanta exigencia porque no tenemos mucho tiempo para trabajar antes del Dakar. Pero sí hacer una carrera más rápida que en un Dakar calculo y de allí vamos a hacer algunas pruebas en Buenos Aires con los amortiguadores nuevos que están llegando&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
