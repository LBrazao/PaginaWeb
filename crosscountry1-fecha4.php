...
<title>Rally Cerdeña | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Cerdeña <br />
    </div>
        <div class="subtitle">FECHA 4 | CROSS COUNTRY MUNDIAL </div></td>
    <td width="489">&nbsp;</td>
  </tr>
</table>
...
$cadena=file_get_contents('crosscountry1-fecha4-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineWRCCCf4.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("crosscountry1-fecha4-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("crosscountry1-fecha4-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("crosscountry1-fecha4-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineWRCCCf4.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_thjArhthYAC92LvAMAwFd2Y2t9aA1jC2LY1tksCoK1z"><a href="http://www.tutiempo.net">El tiempo por Tutiempo.net</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_thjArhthYAC92LvAMAwFd2Y2t9aA1jC2LY1tksCoK1z"></script></td>
  </tr>
</table>
              ...
              <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/kbk4dEXfoM4" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('crosscountry1-fecha4-videos.php');
echo $cadena;
?>
                            </div>
                  ...
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                          <tr>
                            <td width="222" height="27"><span class="Estilo125">Kevin Benavidez (Final) </span></td>
                                ...
                                <table width="49" height="23" border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td width="49"><table width="46" height="19" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFF00">
                                        <tr>
                                          <td><div align="center" class="Estilo126">8</div></td>
                                        </tr>
                                    </table></td>
                                  </tr>
                                </table>
                          ...
                          <tr>
                            <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><img src="benavides2.jpg" width="120" height="172" /></td>
                                </tr>
                              </table>
                                <span class="Verdanachico">&quot;Fue una carrera totalmente distinta para mí, con un tipo de navegación y roadbook que nunca había entrenado y con la moto de Enduro. Tuve una muy buena performance en cuanto a velocidad pero me costo encontrar el punto de equilibrio entre la conducción agresiva de Enduro con el chip de rally en cuanto la navegación.. Muchas notas en el roadbook, un promedio de 3 notas por km.. Cometí varios errores sobre todo en la segunda, cuarta y quinta etapa, que me perdí un poco y ayer una penalización que nos alejó del podio. Me voy muy contento ya que de estos errores se aprende muchísimo, y además me gusto mucho la carrera, muy técnica, agotadora y con unos paisajes muy lindos en la isla de Cerdeña. Fue un muy buen entrenamiento para seguir con mi preparación al Dakar&quot;</span><span class="Verdanachico"></span></td>
                          </tr>
                        </table>
                      <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          <tr>
