...
<title>Rally Baja Italia | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Baja Italia  <br />
    </div>
        <div class="subtitle">FECHA 5 | CROSS COUNTRY MUNDIAL </div></td>
    <td width="489">&nbsp;</td>
  </tr>
</table>
...
$cadena=file_get_contents('crosscountry1-fecha5-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineWRCCCf5.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("crosscountry1-fecha5-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("crosscountry1-fecha5-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("crosscountry1-fecha5-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineWRCCCf5.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_thtgrxYhtUcBzL6U1ArkjEjEDtuUMDW2LtEtEsCIqED"><a href="http://www.tutiempo.net">El tiempo por Tutiempo.net</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_thtgrxYhtUcBzL6U1ArkjEjEDtuUMDW2LtEtEsCIqED"></script></td>
  </tr>
</table>
              ...
              <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/C6qCaGAhPFc" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('crosscountry1-fecha5-videos.php');
echo $cadena;
?>
                            </div>
                  ...
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
						...
						<a href="tcpista-fecha8.php"><img src="boton fecha tc pista.png" width="187" height="34" border="0" /></a><br />
                            ...
                            <a href="nascar-fecha16.php"><img src="boton fecha nascar.png" width="187" height="34" border="0" /></a></div></td>
                  </tr>
                </table>
