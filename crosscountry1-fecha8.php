...
<title>Baja Hungría | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Baja Hungría  <br />
    </div>
        <div class="subtitle">FECHA 8 | CROSS COUNTRY MUNDIAL </div></td>
    <td width="489">&nbsp;</td>
  </tr>
</table>
...
$cadena=file_get_contents('crosscountry1-fecha8-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineWRCCCf8.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("crosscountry1-fecha8-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("crosscountry1-fecha8-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("crosscountry1-fecha8-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineWRCCCf8.php');
echo $cadena;
?>
          </div></div>
            ...
            <table width="309" height="37" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="151" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:4px">
                  <tr>
                    <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasnoticias" href="crosscountry1-posiciones.php">CAMPEONATO</a></li></td>
                  </tr>
                </table></td>
                <td><table width="151" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:4px">
                  <tr>
                    <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasnoticias" href="crosscountry1-calendario.php">CARRERAS</a></li></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
...
<div id="TT_thngLhYBdrM9nLpKMAwEDkDEz9nKMS4FrtkYkZi5qkD"><a href="http://www.tutiempo.net">El tiempo 15 días</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_thngLhYBdrM9nLpKMAwEDkDEz9nKMS4FrtkYkZi5qkD"></script></td>
  </tr>
</table>
              ...
              <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/https://www.youtube.com/watch?v=-fzjcIbsm2U" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('crosscountry1-fecha8-videos.php');
echo $cadena;
?>
                            </div>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="../crosscountry1-fecha8-viernes.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="../crosscountry1-fecha8-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="../crosscountry1-fecha8-domingo.php">Las fotos de la última en Hungría </a></td>
                      </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Nasser Al-Attiyah (Ganador) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="alattiyah.jpg" width="120" height="142" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Realmente es una victoria muy importante para nosotros, por lo que  tratamos de dar lo mejor desde el inicio de la carrera. Hoy salimos a correr con una ventaja por lo que tratamos de no tomar riesgos y tratar de terminar la etapa. Me alegro de que hemos ganado y estamos liderando el Mundial, me gustó mucho esta carrera y repito que no es tan fácil como muchos dicen. Si depende de mí, voy a volver el año que viene, porque los tramos y la organización también son buenas&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div style="padding:4px"> <a href="toprace-fecha8.php"><img src="boton fecha top race.png" width="187" height="34" border="0" /></a><br />
                                ...
                                <a href="nascar-fecha23.php"><img src="boton fecha nascar.png" width="187" height="34" border="0" /></a></div></td>
                      </tr>
                    </table>
