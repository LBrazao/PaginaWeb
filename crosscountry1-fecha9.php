...
<title>Rally Atacama | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Atacama<br />
    </div>
        <div class="subtitle">FECHA 9 | CROSS COUNTRY MUNDIAL </div></td>
    <td width="489">&nbsp;</td>
  </tr>
</table>
...
$cadena=file_get_contents('crosscountry1-fecha9-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineWRCCCf9.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("crosscountry1-fecha9-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("crosscountry1-fecha9-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("crosscountry1-fecha9-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineWRCCCf9.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_RBtwLBtBdWcBz1pULfwlo2olotnUMzalbYkd1ZioK1D">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RBtwLBtBdWcBz1pULfwlo2olotnUMzalbYkd1ZioK1D"></script></td>
  </tr>
</table>
              ...
              <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/WNT99P5R0SU" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('crosscountry1-fecha9-videos.php');
echo $cadena;
?>
                            </div>
