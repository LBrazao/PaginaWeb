...
<title>Rally Cross Country Mundial | Fotos</title>
  ...
  <tr>
    <td valign="top"><div style="padding:8px;">
      <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
        <tr>
          <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="../crosscountry1-fecha12-domingo.jpg" width="233" height="136" border="0"/><br />
                  <div class="playfoto"><a href="../crosscountry1-fecha12-domingo.php" onmouseover="changefoto1(), MM_swapImage('camara1','','camara.png',1)"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" onmouseout="changefotosalir()"/></a></div>
          </div></td>
          <td width="348"><div style="padding:4px;"><a href="../crosscountry1-fecha12-domingo.php" class="titulofotos">Baja Portalegre </a><br />
              <a href="../crosscountry1-fecha12-domingo.php" class="subtitulofotos">VER FOTOS &gt;&gt;</a></div></td>
        </tr>
      </table>
      <br />
      <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
        <tr>
          <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="../crosscountry1-fecha8-domingo.jpg" width="233" height="136" border="0"/><br />
                  <div class="playfoto"><a href="../crosscountry1-fecha8-domingo.php" onmouseover="changefoto1(), MM_swapImage('camara1','','camara.png',1)"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" onmouseout="changefotosalir()"/></a></div>
          </div></td>
          <td width="348"><div style="padding:4px;"><a href="../crosscountry1-fecha8-domingo.php" class="titulofotos">Baja Hungr&iacute;a </a><br />
              <a href="../crosscountry1-fecha8-domingo.php" class="subtitulofotos">VER FOTOS &gt;&gt;</a></div></td>
        </tr>
      </table>
      <br />
      <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
        <tr>
          <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="../crosscountry1-fecha4-etapa5.jpg" width="233" height="136" border="0"/><br />
                  <div class="playfoto"><a href="../crosscountry1-fecha4-etapa5.php" onmouseover="changefoto1(), MM_swapImage('camara1','','camara.png',1)"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" onmouseout="changefotosalir()"/></a></div>
          </div></td>
          <td width="348"><div style="padding:4px;"><a href="../crosscountry1-fecha4-etapa5.php" class="titulofotos">Rally de Marruecos </a><br />
              <a href="../crosscountry1-fecha4-etapa5.php" class="subtitulofotos">VER FOTOS &gt;&gt;</a></div></td>
        </tr>
      </table>
      </div></td>
  </tr>
