...
<table width="341" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td width="535"><span style="font-family:Arial, Helvetica, sans-serif; font-size:18px"><strong><i>Clasificación </i>           </strong></span><span class="Estilo6"> - <u>FINALIZADO</u></span></td>
  </tr>
</table> 
...
$twit = file_get_contents('http://www.formula1.com/content/fom-website/en/championship/results/2015-race-results/2015-belgium-results/qualifying.html');
...
$twit = file_get_contents('http://www.caranddriverthef1.com/formula1/resultados/2015/gp-belgica-f1-2015-parrilla');
