...
$cadena=file_get_contents('f1-fecha19-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineF1f19.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("f1-fecha19-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("f1-fecha19-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("f1-fecha19-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineF1f19.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_tBngbBYxdMp9pTvKMfrlolIFotuKTrt2rtEYkcyIq1D"><a href="http://www.tutiempo.net">Tutiempo.net</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_tBngbBYxdMp9pTvKMfrlolIFotuKTrt2rtEYkcyIq1D"></script></td>
  </tr>
</table>
                    ...
                    <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="f1-fecha19-domingo.jpg" width="233" height="136" border="0"/><br />
                                      <div class="playfoto"><a href="f1-fecha19-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                              </div></td>
                            </tr>
                            <tr>
                              <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="f1-fecha19-domingo.php">Fotos del domingo </a></td>
                            </tr>
                        </table></td>
                        <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="f1-fecha19-sabado.jpg" width="233" height="136" border="0"/><br />
                                    <div class="playfoto"><a href="f1-fecha19-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                            </div></td>
                          </tr>
                          <tr>
                            <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="f1-fecha19-sabado.php">Fotos del viernes y sábado </a></td>
                          </tr>
                        </table></td>
                      </tr>
                    </table>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="202" height="27"><span class="Estilo125">Nico Rosberg (Ganador) </span></td>
                                <td width="55"><div align="right" class="Verdanamarron">
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="rosberg1.jpg" width="120" height="163" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Austin fue el peor momento de la temporada. Fue un fin de semana complicado y desde entonces he vuelto más fuerte y estoy muy contento con ello. Estoy emocionado de como ha se ha dado el final de temporada. El año que viene puede llegar cuando quiera. Podría empezar mañana si fuese por mí, no hay prolema, no necesito vacaciones. Es genial terminar la temporada así, irme de vacaciones así y muchas gracias, habéis estado increíbles de nuevo este fin de semana, por todo vuestro apoyo y por todo, gracias a mi equipo, a este coche fantástico que me habéis dado de nuevo hoy, simplemente increíble&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
						  ...
						  <a href="renault-fecha11.php"><img src="boton fecha renault.png" width="187" height="34" border="0" /></a><br />
                              ...
                              <a href="wtcc-fecha12.php"><img src="boton fecha wtcc.png" width="187" height="34" border="0" /></a>
                            </div></td>
                      </tr>
                  </table>
