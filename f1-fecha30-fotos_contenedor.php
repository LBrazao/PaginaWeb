...
body {
	...
	background-image: url(cabeza%20f1%20fecha13.jpg);
...
<div class="con_margen"><table width="100%" height="180" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="656"><div class="titlecategoria_new">Malasia</div>
      <div class="subtitle_new">FECHA 30 | FÓRMULA 1 </div></td>
...
<script type="text/javascript">
  ...
  success: function() {
   ...
   $("#contenido").load("f1-fecha30-fotos.php");
};
function resultados() {
            ...
            $("#contenido").load("f1-fecha30-resultados.php");
	...
	function noticias() {
			...
			$('#campeonato').removeClass('boton_activo');
            $("#contenido").load("f1-fecha30-noticias.php");
	};
	function campeonato() {
			$('#resultados').removeClass('boton_activo');
			$('#fotos').removeClass('boton_activo');
            ...
            $("#contenido").load("f1-posiciones_fecha.php");
        
		
	};
	$(document).ready(function(){
        setInterval(function() {
            $("#comentarios").load("onlineF1f14.php");
        }, 100000);
    });
	
	$(document).ready(function(){
        setInterval(function() {
            $("#resultados_contenedor").load("f1-fecha30-resultados.html");
        }, 60000);
    });
</script>
	  ...
	  <table id="encabezado_monitoreo" width="80%" border="0" cellspacing="0" cellpadding="5">
        <tr>
          <td id="resultados"  onclick="resultados()" width="20%" align="center">RESULTADOS</td>
          <td id="fotos" class="boton_activo" onclick="fotos()" width="20%" align="center">FOTOS</td>
