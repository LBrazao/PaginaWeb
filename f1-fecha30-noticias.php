...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="75%" valign="top" style="border-right:1px dashed #999999; padding-right:8px"><span style="padding-top:35px">
      <?php
$cadena=file_get_contents('f1-noticias_insertadas.html');
echo $cadena;
?>
    </span></td>
