...
<table width="341" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td width="535"><span style="font-family:Arial, Helvetica, sans-serif; font-size:18px"><strong><i>1º Entrenamiento</i></strong></span></td>
  </tr>
</table> 
...
$twit = file_get_contents('http://www.formula1.com/content/fom-website/en/championship/results/2016-race-results/2016-monaco-results/practice-1.html');
...
$cadenaABuscar = str_replace('<span class="tla">SIR', '<span class="tla">',$cadenaABuscar);
$cadenaABuscar = str_replace('<span class="tla">OCO', '<span class="tla">',$cadenaABuscar);
$cadenaABuscar = str_replace('<td class="number">45</td>', '<td class="number">45</td><td><img src="banderita de francia.JPG" /></td>',$cadenaABuscar);
$cadenaABuscar = str_replace('<td class="number">46</td>', '<td class="number">46</td><td><img src="banderita rusia.JPG" /></td>',$cadenaABuscar);
$cadenaABuscar = str_replace('<td class="number">47</td>', '<td class="number">47</td><td><img src="banderita belgica.JPG" /></td>',$cadenaABuscar);
$cadenaABuscar = str_replace('<td class="number">34</td>', '<td class="number">34</td><td><img src="banderita mexico.png" /></td>',$cadenaABuscar);
...
$twit = file_get_contents('http://www.caranddriverthef1.com/formula1/resultados/2016/gp-monaco-f1-2016-libres-1');
