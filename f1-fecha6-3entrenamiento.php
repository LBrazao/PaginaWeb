...
<table width="341" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td width="535"><span style="font-family:Arial, Helvetica, sans-serif; font-size:18px"><strong><i>3º Entrenamiento</i></strong></span></td>
  </tr>
</table> 
...
$twit = file_get_contents('http://www.formula1.com/content/fom-website/en/championship/results/2016-race-results/2016-monaco-results/practice-3.html');
...
$twit = file_get_contents('http://www.caranddriverthef1.com/formula1/resultados/2016/gp-monaco-f1-2016-libres-3');
