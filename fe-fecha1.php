...
<title>Fórmula E China | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
body {
	...
	background-image: url(cabeza%20fe%20fecha10.jpg);
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Beijing<br />
    </div>
        <div class="subtitle">FECHA 1 | FÓRMULA E </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><div align="center"><img src="circuito beijing.png" width="238" height="108" border="0" /></div></td>
        </tr>
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">DURACIÓN:</span> 29 vueltas <br />
                    <span style="font-weight:bold">EXTENSI&Oacute;N:</span> 2925 metros </div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
$cadena=file_get_contents('fe-fecha10-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineFEf11.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("fe-fecha10-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("fe-fecha10-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("fe-fecha10-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineFEf11.php');
echo $cadena;
?>
          </div></div>
		  <table width="309" height="37" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td><table width="151" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:4px">
                  <tr>
                    <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasnoticias" href="fe-calendario.php">CARRERAS</a></li></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
...
<div id="TT_tBjALxthtIjBd1vA1fwED1zkjtuAT2h2rdktEciIa1z">El tiempo por Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_tBjALxthtIjBd1vA1fwED1zkjtuAT2h2rdktEciIa1z"></script></td>
  </tr>
</table>
        ...
        <td width="508" valign="top"><li class="cabezanoticias"><span class="textoenvivo" >VIDEOS</span></li>
              ...
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/4mNOSOJXDJs" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
					...
					<div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('fe-fecha10-videos.php');
echo $cadena;
?>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="fe-fecha10-domingo.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="fe-fecha10-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="fe-fecha10-domingo.php">Fórmula E en Londres </a></td>
                        </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Nelson Piquet Jr. (Campeón) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="piquet1.jpg" width="120" height="165" /></td>
                                    </tr>
                                  </table>
                                <span class="Verdanachico">&quot;Hemos trabajado muy duro desde el comienzo de la temporada cuando estábamos completamente perdidos. Cuando estaba en la primera carrera se me hacía difícil pensar incluso que pudiésemos conseguir algún podio en la temporada pero lo pudimos revertir.<br />
                                Esta mañana, cuando comenzó a llover justo en mi grupo de clasificación pensé que nada podía ser peor, pero  el lado positivo fue que eso me quitó presión porque ya no tenía nada más que perder, entonces ataqué todo lo que pude y llegué sexto entrando en los puntos que me permitieron llevarme el título&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"> <a href="stc2000-fecha5.php"><img src="boton fecha stc2000.png" width="187" height="34" border="0" /></a><br />
                              ...
                              <a href="crosscountry-fecha2.php"><img src="boton fecha cross country.png" width="187" height="34" border="0" /></a> </div></td>
                      </tr>
                  </table>
