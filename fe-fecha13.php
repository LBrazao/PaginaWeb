...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineFEf13.php");
        }, 100000);
    });
</script>
...
$cadena=file_get_contents('onlineFEf13.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_vhnwrBtxtnnaMLpKMArlo252I9nKT4SFLtkY1ciIqkz">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vhnwrBtxtnnaMLpKMArlo252I9nKT4SFLtkY1ciIqkz"></script></td>
  </tr>
</table>
        ...
        <td width="508" valign="top"><li class="cabezanoticias"><span class="textoenvivo" >VIDEOS</span></li>
              ...
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/nXmyE3S1Gls" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                </table></td>
              </tr>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="fe-fecha13-sabado.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="fe-fecha13-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="fe-fecha13-sabado.php">Las fotos de la carrera  </a></td>
                      </tr>
                    </table></td>
                        ...
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              ...
                              <tr>
                                ...
                                <span class="Verdanachico">&quot;Hoy, con el calor, había muchas otras cosas para preocuparse. Especialmente la temperatura de la batería. Así que al comienzo de la carrera, tomé las primeras vueltas con tranquilidad para ver dónde estábamos parados, y tuvimos el ritmo para pasar a los otros. Tengo que decir que tenía todo bajo control y que incluso me tomé un poco de márgen al principio. Luego en el segundo coche tuvimos algunos problemas más en los frenos, por lo que era bastante difícil de conducir. En esta categoría no tiene sentido tener una gran diferencia, porque si usas la energía para crear una brecha y luego tienes un coche de seguridad, toda la energía se ha ido. Así que lo mejor es crear un poco de espacio, eso te hace sentir seguro, así que si cometiste un pequeño error, podrías recuperarlo.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
