...
<title>Fórmula E Malasia | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
body {
	...
	background-image: url(cabeza%20fe%20fecha1.jpg);
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Malasia<br />
        ...
        <div class="subtitle">FECHA 2 | FÓRMULA E </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><div align="center"><img src="circuito putrajaya.png" width="238" height="108" border="0" /></div></td>
        </tr>
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">DURACIÓN:</span> 33 vueltas <br />
                    <span style="font-weight:bold">EXTENSI&Oacute;N:</span> 2500 metros </div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
$cadena=file_get_contents('fe-fecha12-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineFEf12.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("fe-fecha12-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("fe-fecha12-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("fe-fecha12-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineFEf12.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_RhtArxYBdUY9DT6U1frEjkDkztaUTDa2LYkt1Zi5qEz">El tiempo por Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RhtArxYBdUY9DT6U1frEjkDkztaUTDa2LYkt1Zi5qEz"></script></td>
  </tr>
</table>
        ...
        <td width="508" valign="top"><li class="cabezanoticias"><span class="textoenvivo" >VIDEOS</span></li>
              ...
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/0CnNBjl5ig8" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
					...
					<div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('fe-fecha12-videos.php');
echo $cadena;
?>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="fe-fecha2-carrera.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="../fe-fecha2-carrera.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="../fe-fecha2-carrera.php">Las fotos de la última en Malasia </a></td>
                      </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Sebastien Buemi (Previa) </span></td>
                              ...
                              <tr>
                                ...
                                <span class="Verdanachico">&quot;Estábamos felices de lograr todos los puntos que podíamos obtener en Beijing, ahora hay que empezar de cero. Espero que podamos mostrar un muy buen nivel de rendimiento de nuevo, lo que significaría que iríamos á las próximas carreras nuevamente como candidatos.<br />
                                Pero sabemos que aquí y en las próximas carreras de uruguay y Argentina las temperaturas van a ser altas, por lo que la gestión de la batería podría ser un poco más compleja que  lo que era en Beijing.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
