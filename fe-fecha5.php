...
<title>Fórmula E México | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">México<br />
        ...
        <div class="subtitle">FECHA 5 | FÓRMULA E </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><div align="center"><img src="circuito mexico1.png" width="238" height="108" border="0" /></div></td>
        </tr>
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">DURACIÓN:</span> 43 vueltas <br />
                    <span style="font-weight:bold">EXTENSI&Oacute;N:</span> 2092 metros </div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
$cadena=file_get_contents('fe-fecha5-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineFEf5.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("fe-fecha5-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("fe-fecha5-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("fe-fecha5-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineFEf5.php');
echo $cadena;
?>
          </div></div>
        ...
        <td width="508" valign="top"><li class="cabezanoticias"><span class="textoenvivo" >VIDEOS</span></li>
              ...
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/AUZlZAjt5CQ" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
					...
					<div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('fe-fecha5-videos.php');
echo $cadena;
?>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="fe-fecha5-sabado.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="fe-fecha5-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="fe-fecha5-sabado.php">Actividad del sábado  </a></td>
                      </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Jerome D'Ambrosio (Ganador) </span></td>
                                  ...
                                  <table width="49" height="23" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td width="49"><table width="46" height="19" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFF00">
                                          <tr>
                                            <td><div align="center" class="Estilo126">7</div></td>
                                          </tr>
                                      </table></td>
                                    </tr>
                                  </table>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="dambrosio.jpg" width="120" height="155" /></td>
                                    </tr>
                                  </table>
                                <span class="Verdanachico">&quot;Fue realmente una lucha confusa con Seb (Buemi). Acabamos de hablar sobre ello en el podio, pero necesito ver una repetición para ver lo que realmente sucedió allí. En un momento nos tocamos en la primera curva y todo fue bien. Luego se me ha adelantado, pero cortando la chicana. Luego me quiso ceder la posición pero lo hizo en un lugar que era imposible adelantarle, por lo tanto, se creó un gran lío pero creo que al final todo terminó como debía terminar&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
