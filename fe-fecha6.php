...
<title>Fórmula E Los Ángeles | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Los Ángeles <br />
    </div>
        <div class="subtitle">FECHA 6 | FÓRMULA E </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><div align="center"><img src="circuito long beach1.png" width="238" height="108" border="0" /></div></td>
        </tr>
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">DURACIÓN:</span> 39 vueltas <br />
                    <span style="font-weight:bold">EXTENSI&Oacute;N:</span> 2100 metros </div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
$cadena=file_get_contents('fe-fecha6-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineFEf6.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("fe-fecha6-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("fe-fecha6-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("fe-fecha6-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineFEf6.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_RxjkkEk111h9hMDALAw1j1zEDtlATCIFbtkYEcy5a1j"><a href="http://www.tutiempo.net/tiempo/Long_Beach/K5L8.htm">Long Beach</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RxjkkEk111h9hMDALAw1j1zEDtlATCIFbtkYEcy5a1j"></script></td>
  </tr>
</table>
        ...
        <td width="508" valign="top"><li class="cabezanoticias"><span class="textoenvivo" >VIDEOS</span></li>
              ...
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/5f86N8LpAks" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
					...
					<div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('fe-fecha6-videos.php');
echo $cadena;
?>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="/2015/fe-fecha6-carrera.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="/2015/fe-fecha6-carrera.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="/2015/fe-fecha6-carrera.php">La última carrera en Los Ángeles </a></td>
                      </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Nelson Piquet Jr. (Previa) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="piquet.jpg" width="120" height="158" /></td>
                                    </tr>
                                  </table>
                                <span class="Verdanachico">&quot;El arranque de la semana me hizo aún más pesimista después de ver cómo quedó la primera chicana; es mucho más estrecha y los lugares donde más sufrimos son los frenajes y aceleraciones bruscas. La aceleración para nosotros es un  problema. En este circuito tenés solo una horquilla y el resto es bastante fluido, pero después de caminar que me di cuenta de que será mucho más lento que el año pasado y que no estará a nuestro favor. Es lo que hay.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
