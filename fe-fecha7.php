...
<title>Fórmula E Paris | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">París <br />
    </div>
        <div class="subtitle">FECHA 7 | FÓRMULA E </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><div align="center"><img src="circuito paris.png" width="238" height="108" border="0" /></div></td>
        </tr>
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">DURACIÓN:</span> 45 vueltas <br />
                    <span style="font-weight:bold">EXTENSI&Oacute;N:</span> 1930 metros </div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
$cadena=file_get_contents('fe-fecha7-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("fe-fecha7-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("fe-fecha7-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("fe-fecha7-noticias.php");
        }, 60000);
    });
</script> 
...
<div id="TT_txngrhthdKlatT6K1AwkxEhEB9uK1MSlrY1Y1syIK1j"><a href="http://www.tutiempo.net/tiempo/Paris_Le_Bourget/LFPB.htm">Paris / Le Bourget</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_txngrhthdKlatT6K1AwkxEhEB9uK1MSlrY1Y1syIK1j"></script></td>
  </tr>
</table>
        ...
        <td width="508" valign="top"><li class="cabezanoticias"><span class="textoenvivo" >VIDEOS</span></li>
              ...
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/mH1TlTqaaII" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
					...
					<div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('fe-fecha7-videos.php');
echo $cadena;
?>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Lucas di Grassi (Ganador) </span></td>
                                  ...
                                  <table width="49" height="23" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td width="49"><table width="46" height="19" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFF00">
                                          <tr>
                                            <td><div align="center" class="Estilo126">11</div></td>
                                          </tr>
                                      </table></td>
                                    </tr>
                                  </table>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="digrassi1.jpg" width="120" height="169" /></td>
                                    </tr>
                                  </table>
                                <span class="Verdanachico">&quot;Creo quela largada más perfecta que logramos hasta ahora. Sam tenía muy poca adherencia de las ruedas e intenté evitar cualquier incidente. Jean-Eric hizo una muy buena largada y me obligó a mirar constantemente los espejos para tratar de que no se me metiera por el lado interno. A partir de ahí intenté hacer una diferencia lo más que pude hasta que llegó la neutralización de la carrera. Después de la parada en boxes, tenía los neumáticos muy fríos y el auto se me iba para todos lados mientras trataba de que tomen temperatura. Para ver gente de todo el que anima la pista, en el interior de la pista y el exterior.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
