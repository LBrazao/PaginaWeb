...
<title>Fórmula E Londres | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Londres <br />
    </div>
        <div class="subtitle">FECHA 9 | FÓRMULA E </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><div align="center"><img src="circuito londres.png" width="238" height="108" border="0" /></div></td>
        </tr>
        <tr>
...
$cadena=file_get_contents('fe-fecha9-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineFEf9.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("fe-fecha9-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("fe-fecha9-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("fe-fecha9-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineFEf9.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_RBjgrxYxtId9ELDALAwEj1D1jtuALh22LdEdksioKEj">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RBjgrxYxtId9ELDALAwEj1D1jtuALh22LdEdksioKEj"></script></td>
  </tr>
</table>
        ...
        <td width="508" valign="top"><li class="cabezanoticias"><span class="textoenvivo" >VIDEOS</span></li>
              ...
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/NXY8aq5FWGY" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
					...
					<div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('fe-fecha9-videos.php');
echo $cadena;
?>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Sebastien Buemi (Campeón) </span></td>
                              ...
                              <tr>
                                ...
                                <span class="Verdanachico">&quot;La acción de Di Grassi en el final no fue inesperada, no me sorprendió que me chocara intentando dejarme afuera de carrera para él ganar el campeonato, pero por suerte el campeón fue el mejor piloto y el mejor equipo.<br />
                                Inclusive cada vez que yo salía a pista a intentar hacer el récord de vuelta para ganar los puntos, él venía atrás mío y me molestaba para que no lo logre.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
						  ...
						  <a href="renault-fecha6.php"><img src="boton fecha renault.png" width="187" height="34" border="0" /></a><br />
                              ...
                              <a href="nascar-fecha17.php"><img src="boton fecha nascar.png" width="187" height="34" border="0" /></a><br />
                          </div></td>
                      </tr>
                  </table>
