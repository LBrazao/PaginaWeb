...
<title>F&oacute;rmula E | Fotos</title>
  ...
  <tr>
    <td valign="top"><div style="padding:8px;">
      <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
        <tr>
          <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="no hay fotos.jpg" width="233" height="136" border="0"/><br />
                  <div class="playfoto"><a href=""><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1"/></a></div>
          </div></td>
          <td width="348"><div style="padding:4px;"><a href="" class="titulofotos">No hay fotos por el momento...</a><br />

 						  <a href="" class="subtitulofotos">VER FOTOS >></a></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
