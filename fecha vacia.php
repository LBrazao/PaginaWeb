...
<title>Top Race en Junín | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
  ...
  <tr>
    ...
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><a href="toprace-fecha1-analisis.php"><img src="circuito junin.png" width="238" height="108" border="0" /></a></td>
        </tr>
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">R&Eacute;CORD:</span> A. Canapino (1'21&quot;406)<br />
            <span style="font-weight:bold">EXTENSI&Oacute;N:</span> 4200 metros
</div></td>
        </tr>
      </table>
    </div></td>
  ...
  <tr>
    <td width="671" valign="top"><div class="cabezatiempos"><span class="textoenvivo">TIEMPOS EN VIVO  </span></div> 
      <table width="671" height="405" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
        <tr>
          <td valign="bottom"><table width="661" height="400" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="514"><iframe src="toprace-fecha1-1entrenamiento.html" name="resultados" width="514" height="400" frameborder="0" allowfullscreen="allowfullscreen"></iframe></td>
              <td valign="bottom" background="fondo semitransparente.png"><table width="100%" height="397" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="272" valign="top"><table width="139" height="31" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                    <tr>
                      <td background="boton resultados.jpg"><div align="center"><a class="botonresultados" target="resultados" href="toprace-fecha1-1entrenamiento.html">1&ordm; Entrenamiento </a></div></td>
                    </tr>
                  </table>
                    ...
                    <table width="139" height="31" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                      <tr>
                        <td background="boton resultados inactivo.jpg"><div align="center"><span class="botonresultados_inactivo" target="resultados" href="">2&ordm; Entrenamiento </span></div></td>
                      </tr>
                    </table>
                    <table width="100%" height="3" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                    ...
                    <table width="139" height="31" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                      <tr>
                        <td background="boton resultados inactivo.jpg"><div align="center"><span class="botonresultados_inactivo" target="resultados" href="">Clasificaci&oacute;n Gral.</span></div></td>
                      </tr>
                    </table>
                    <table width="100%" height="3" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                    ...
                    <table width="139" height="31" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                      <tr>
                        <td background="boton resultados inactivo.jpg"><div align="center"><span class="botonresultados_inactivo" target="resultados" href="">1&ordm; Serie </span></div></td>
                      </tr>
                    </table>
                    <table width="100%" height="3" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                    ...
                    <table width="139" height="31" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                      <tr>
                        <td background="boton resultados inactivo.jpg"><div align="center"><span class="botonresultados_inactivo" target="resultados" href="">2&ordm; Serie </span></div></td>
                      </tr>
                    </table>
                    <table width="100%" height="3" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                    ...
                    <table width="139" height="31" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                      <tr>
                        <td background="boton resultados inactivo.jpg"><div align="center"><span class="botonresultados_inactivo" target="resultados" href="">Final</span></div></td>
                      </tr>
                    </table>
                    <table width="100%" height="3" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                ...
                <tr>
                  <td valign="bottom" background="fondo semitransparente.png"><table width="100%" height="3" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td></td>
                      </tr>
                    </table>
                    <table width="139" height="31" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                    <tr>
                      <td background="boton resultados.jpg"><div align="center"><a class="botonresultados_horarios" target="resultados" href="toprace-fecha1-cronograma.html">HORARIOS</a></div></td>
                    </tr>
                  </table>
                    <table width="100%" height="3" border="0" cellpadding="0" cellspacing="0">
                      <tr>
    ...
    <td width="319" valign="top">
      ...
      <table width="309" height="333" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
        <tr>
          <td valign="top">
...
$cadena=file_get_contents('onlineTRV6f1.php');
echo $cadena;
?>
          </div>
      ...
      <table width="309" height="8" border="0" cellpadding="0" cellspacing="0" background="pie relatos.png">
        <tr>
          <td></td>
        </tr>
      </table></div>
            ...
            <table width="508" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><div class="newsfecha">
                    <?php
$cadena=file_get_contents('F1.php');
echo $cadena;
?>
                  </div>
                    <table style="margin-top:4px; margin-right:8px" width="151" border="0" align="right" cellpadding="0" cellspacing="0">
                      <tr>
                        <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasnoticias" href="f1-noticias.php">MAS NOTICIAS</a></li></td>
                      </tr>
                  </table></td>
              </tr>
            </table>
          ...
          <td width="269" valign="top"><table width="265" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              <td><li class="cabezafechas"><a class="textoenvivovinculos" href="toprace-fecha1-declaraciones.php">DECLARACIONES</a></li>         
              ...
              <tr>
                <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                    <tr>
                      <td width="222" height="27"><span class="Estilo125">Próximamente...</span></td>
                    ...
                    <tr>
                      <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                          ...
                          <span class="Verdanachico">&quot;Próximamente...&quot;</span><span class="Verdanachico"></span></td>
                    </tr>
                  </table>
                  <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                  ...
                  <table style="margin-right:8px" width="151" border="0" align="right" cellpadding="0" cellspacing="0">
                    <tr>
                      <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasfotos" href="toprace-fecha1-declaraciones.php">VER M&Aacute;S  </a></li></td>
                    </tr>
                  </table></td>
              </tr>
            </table>
			...
			<table width="265" height="211" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <div style="padding:4px"><a href="topraceseries-fecha1.php"><img src="boton fecha tr series.png" width="187" height="34" border="0" /></a><br />
                    <a href="tn-fecha1.php"><img src="boton fecha tn.png" width="187" height="34" border="0" /></a></div></td>
              </tr>
            </table>
