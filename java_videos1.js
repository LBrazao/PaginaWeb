 ...
 $.fn.amazingslider = function(options) {
  ...
  AmazingSlider.prototype = {
   ...
   createNav: function() {
    ...
    var $nav = $(".amazingslider-nav-" + this.id, this.container);
    var $navContainer = $(".amazingslider-nav-container-" + this.id, this.container);
    var $bulletWrapper = $("<div class='amazingslider-bullet-wrapper-" + this.id + "'></div>");
    $navContainer.css({
     overflow: "hidden"
    });
   ...
   createNavBullet: function(index) {
    ...
    var $bullet = $("<div class='amazingslider-bullet-" + this.id + "-" + index + "' style='position:relative;float:" + f + ";" + b + "margin-" + marginF + ":" + spacing + "px;width:143px;height:124px;cursor:pointer;'></div>");
    ...
    if (this.options.navstyle == "bullets") {
     ...
     $(imgLoader).load(function() {
      if (instance.options.navthumbstyle != "textonly") {
       ...
       $bullet.append("<div class='amazingslider-bullet-image-" + instance.id + "' style='display:block;position:absolute;width:143px;height:81px;overflow:hidden;'><img src='" + instance.elemArray[index][ELEM_THUMBNAIL] + "' style='" +
        style + "' /></div>");
       if (instance.options.navshowplayvideo && (instance.elemArray[index][ELEM_VIDEO].length > 0 || instance.elemArray[index][ELEM_LINK] && instance.elemArray[index][ELEM_LIGHTBOX] && instance.checkVideoType(instance.elemArray[index][ELEM_LINK]) > 0)) $bullet.append("<div style='display:block;position:absolute;margin-left:0;margin-top:0;width:143px;height:81px;" + 'background:url("' + instance.options.skinsfolder + instance.options.navplayvideoimage +
        '") no-repeat center center;' + "' ></div>")
      }
      if (instance.options.navthumbstyle != "imageonly") {
       var thumbtitle = "<div class='amazingslider-bullet-text-" + instance.id + "' style='display:block;position:absolute;overflow:hidden;";
       if (instance.options.navthumbstyle == "imageandtitle") thumbtitle += "margin-left:0px;margin-top:83px;width:143px;height:auto;";
