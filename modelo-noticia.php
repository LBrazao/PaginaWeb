...
<head>
	...
	<title>Alonso abre una escuela de karting en China</title>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td width="70%" valign="top" class="seccionNoticia"> <!--NOTICIA-->
				...
				<div class="tituloNoticia">Alonso abre una escuela de karting en China</div><br>
				
				<table style="font-size:25px;"> <tr> 
					<td width="700">10/04/2018</td> 
					<td width="700" style="color:red;text-align:right">Formula 1</td>
				</tr></table><br>
				...
				<div class="desarrollo_noticia cuerpoNoticia">
					La actividad empresarial de Fernando Alonso fuera de los circuitos continúa su expansión. Si el pasado año se lanzaba con su nueva marca de ropa y complementos, Kimoa y posteriormente creaba su propio equipo de eSports, en esta ocasión amplía horizontes y traslada su actividad hasta china.

					De la mano de la empresa de comunicación Shanghai Yi Qian, ahora da un paso más con la apertura de la 'Alonso New Energy Karting Center and School', que buscará encontrar al nuevo Alonso en China. 

					Juntos planean desarrollar al menos 40 pistas de karting y entre tres y cinco escuelas de karting con 20 pistas, además de una escuela de karting para niños de 3 a 5 años. La escuela tendrá sede en Shanghai, Beijing, Shenzhen, Guangzhou y otras ciudades del país asiático.
				</div>
