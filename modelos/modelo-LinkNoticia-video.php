	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td width="70%" valign="top" class="seccionNoticia"> <!--NOTICIA-->
				...
				<div class="tituloNoticia">[[[[TITULO]]]]</div><br>
				
				<table style="font-size:25px;"> <tr> 
					<td width="700">[[[[FECHA]]]]</td> 
					<td width="700" style="color:red;text-align:right">[[[[CATEGORIA]]]]</td>
				</tr></table><br>
				
				<div>
					<div class="video_en_vivo" style="border-bottom:3px solid #FF0000"><iframe src="[[[[VIDEO-URL]]]]" scrolling="no" frameborder="0" name="contenedor_videos_categoria" id="contenedor_videos_categoria">    </iframe></div>
				</div><br>
				...
				<div>
					<img id="imagen_noticia" src="[[[[FOTO]]]]" width="100%" style="display:block;margin:auto;" />
				</div><br>
			...
			<tr>
				...
				<td width="209"  style="background-color:#FFFFFF; border-radius:7px;">
					...
					<?php
						mostrar_noticia(6,'[[[[NOTICIAS CATEGORIA]]]]');
					?>
