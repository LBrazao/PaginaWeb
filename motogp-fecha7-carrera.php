...
.fonts12 tbody tr td:nth-child(10n+4){
font-weight:bold;
text-align:left;
}
...
<table width="341" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="535"><span style="font-family:Arial, Helvetica, sans-serif" ><strong><i>Carrera </i>           </strong></span></td>
  </tr>
</table> 
...
$twit = file_get_contents('http://www.motogp.com/es/Results+Statistics/2016/CAT/MotoGP/RAC');
...
$cadenaABuscar = str_replace('<th>Puntos </th>', '',$cadenaABuscar);
$cadenaABuscar = str_replace('<th>Equipo</th>', '',$cadenaABuscar);
$cadenaABuscar = str_replace('<th>País</th>', '<th></th>',$cadenaABuscar);
$cadenaABuscar = str_replace('<th>Tiempo/Diferencia</th>', '<th>Diferencia</th>',$cadenaABuscar);
$cadenaABuscar = str_replace('<td class="alignright">+', '<td class="alignright">',$cadenaABuscar);
