...
<title>Nascar en Atlanta | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('nascar-fecha2-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineNASCARf2.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("nascar-fecha2-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("nascar-fecha2-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("nascar-fecha2-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineNASCARf2.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_vCjwrhtBYEEaILDAMfwkzED1D9nATCAFrtEYEZCIKkz"><a href="http://www.tutiempo.net">El Tiempo</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vCjwrhtBYEEaILDAMfwkzED1D9nATCAFrtEYEZCIKkz"></script></td>
  </tr>
</table>
              ...
              <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/5AAagPtRTY8" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('nascar-fecha2-videos.php');
echo $cadena;
?>
                  ...
                  <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="/2015/nascar-fecha2-carrera.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="/2015/nascar-fecha2-carrera.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="/2015/nascar-fecha2-carrera.php">Las fotos de la última en Atlanta </a></td>
                        </tr>
                      </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Danica Patrick (Previa) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="patrick.jpg" width="120" height="156" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Soy optimista. Siento que (el jefe de equipo Billy Scott y yo) ambos estén listos para el desafío<br />
                                    No sé de qué se trata Atlanta. Creo que me siento como que tienden a hacer realidad bien en las pistas más desafiantes, único que yo en un montón de otros.<br />
                                    Cuando venga a su Atlanta o de sus Martinsvilles o algo así, me parece que hacer bastante bien. Creo que una de las cosas que ambos toman es un poco de disciplina y tomar el coche al límite, pero no ir demasiado lejos a veces, pero también ser capaz de encontrar ese límite.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
              ...
              <table width="265" height="211" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"><a href="rallyargentino-fecha1.php"><img src="boton fecha rally argentino.png" width="187" height="34" border="0" /></a><br />
