...
.tabla_tiempos tr td:nth-child(11n+2){
text-align:center;
width:25px;
}
.tabla_tiempos tr td:nth-child(11n+3){
font-weight:bold;
}
.tabla_tiempos tr td:nth-child(11n+4){
text-align:center;
width:80px;
}
.tabla_tiempos tr td:nth-child(11n+5){
display:none;
}
.tabla_tiempos tr td:nth-child(11n+6){
text-align:center;
}
.tabla_tiempos tr td:nth-child(11n+7){
text-align:center;
}
.tabla_tiempos tr td:nth-child(11n+8){
text-align:center;
}
.tabla_tiempos thead th:nth-child(11n+5), .tabla_tiempos thead th:nth-child(11n+8), .tabla_tiempos thead th:nth-child(11n+9), .tabla_tiempos thead th:nth-child(11n+10), .tabla_tiempos thead th:nth-child(11n+11), .tabla_tiempos tr td:nth-child(11n+5), .tabla_tiempos tr td:nth-child(11n+8), .tabla_tiempos tr td:nth-child(11n+9), .tabla_tiempos tr td:nth-child(11n+10), .tabla_tiempos tr td:nth-child(11n+11){
display:none;
}
...
$twit = file_get_contents('http://www.nascar.com/en_us/sprint-cup-series/standings/results/2016/crown-royal-presents-the-combat-wounded-coalition-400-at-the-brickyard.html');
...
$cadenaABuscar = str_replace('Car #', 'Nº',$cadenaABuscar);
$cadenaABuscar = str_replace('<th scope="col">Driver', '<th scope="col">Piloto',$cadenaABuscar);
$cadenaABuscar = str_replace('<th scope="col">Laps Led', '<th scope="col">Lideró',$cadenaABuscar);
$cadenaABuscar = str_replace('<th scope="col">Laps', '<th scope="col">Vueltas',$cadenaABuscar);
