...
<title>NASCAR Indianapolis | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('nascar-fecha20-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineNASCARf20.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("nascar-fecha20-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("nascar-fecha20-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("nascar-fecha20-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineNASCARf20.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_tBngbBtBYSScSMpKMAwlm23lmtnKLMQlrtkYEciIqED">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_tBngbBtBYSScSMpKMAwlm23lmtnKLMQlrtkYEciIqED"></script></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/KS57vraSZJ0" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('nascar-fecha20-videos.php');
echo $cadena;
?>
                            </div>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="nascar-fecha20-domingo.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="nascar-fecha20-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="nascar-fecha20-domingo.php">Actividad del domingo </a></td>
                        </tr>
                    </table></td>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="nascar-fecha20-sabado.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="nascar-fecha20-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="nascar-fecha20-sabado.php">Actividad del viernes y sábado </a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Kyle Busch (Ganador) </span></td>
                                    ...
                                    <table width="49" height="23" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="49"><table width="46" height="19" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFF00">
                                            <tr>
                                              <td><div align="center" class="Estilo126">18</div></td>
                                            </tr>
                                        </table></td>
                                      </tr>
                                    </table>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="kyle busch1.jpg" width="120" height="161" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Este Toyota fue impresionante hoy. Fue tan rápido y capaz de salir delante y permanecer en el frente. No puedo reprocharle nada a ninguno de los chicos del equipo. Adam Stevens (jefe de equipo) y estos chicos son un grupo fenomenal, y estoy orgulloso de estar con ellos. Es divertido  venir aquí y tener un auto tan dominante en Indy. No es algo de todos los días, así que sólo esperaba  no meter la pata.  Creo que entrego más en la pista de lo que entregan otros pilotos porque tengo la chance de correr en la Xfninity (categoría telonera). Te ayuda para la carrera del domingo, y eso es lo que hace que valga la pena correr los sábado.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
