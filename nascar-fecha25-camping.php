...
<title>NASCAR: SE DIERON CON TODO... ARRIBA Y ABAJO DEL AUTO  | TC La Revista</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">NASCAR<br />
    </div>
    </td>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">SE DIERON CON TODO... ARRIBA Y ABAJO DEL AUTO </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">5 de Septiembre de 2016 |</span> <span style="color:#DD0005; font-weight:bold">NASCAR</span> </td>
              <td width="35%"><div align="right" class="Estilo15"></div></td>
            </tr>
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/5x96AuE-zbE?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="134" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/nascar-fecha25-camping.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">John Nemechek y Cole Custer se jugaban la victoria en la &uacute;ltima vuelta en el circuito canadiense de Bowmanville para la divisi&oacute;n de camionetas de Nascar (Camping World Truck Series). Custer ven&iacute;a punteando la carrera hasta que en la &uacute;ltima curva recibi&oacute; dos impactos desde atr&aacute;s por parte de Nemechek, quien como si fuera poco lo arrastr&oacute; contra el muro para poder pasarlo y recibir la bandera acuadros primero en un final bastante excitante pero sucio a la vez.</span></p>
          <p><span class="Estilo11">Una vez terminada la carrera el pol&eacute;mico ganador Nemechek fue a buscar la bandera a cuadros para hacer el cl&aacute;sico festejo, cuando de pronto un enardecido Custer le hizo un tacle propio de Los Pumas para derribarlo e iniciar una ri&ntilde;a que gracias a la intervenci&oacute;n de los mec&aacute;nicos solo dur&oacute; 3 segundos.</span></p>
          <p><span class="Estilo11">A pesar de todo Nemechek no fue sancionado por su juego sucio en pista y finalmente se lo consider&oacute; ganador oficial de la carrera. </span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/nascar-fecha25-camping.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
                  ...
                  <tr>
                    ...
                    <td width="71%" valign="top"><a href="nascar-fecha25.php"><img src="volver.png" width="168" height="58" border="0" />
                          <table width="120" class="pedido">
                            <tr>
                              <td align="right">VOLVER A NASCAR</td>
                            </tr>
                          </table>
                    </a></td>
                  </tr>
