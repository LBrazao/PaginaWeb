...
<title>Nascar en Chicagoland | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Chicagoland   <br />
    </div>
        <div class="subtitle">FECHA 27 | NASCAR </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><div align="center"><img src="circuito chicago.png" width="238" height="108" border="0" /></div></td>
        </tr>
        <tr>
...
$cadena=file_get_contents('nascar-fecha27-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineNASCARf27.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("nascar-fecha27-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("nascar-fecha27-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("nascar-fecha27-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineNASCARf27.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_RBjwLhYxYEdaIT6A1Ar2IF52I9uATCh2bYkYEZCIaEz"><a href="http://www.tutiempo.net/tiempo/Joliet_Park_District/KJOT.htm">El Tiempo en Joliet Park District</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RBjwLhYxYEdaIT6A1Ar2IF52I9uATCh2bYkYEZCIaEz"></script></td>
  </tr>
</table>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Kyle Busch (Previa) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="kyle busch.jpg" width="120" height="138" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;De hecho, me siento más o menos igual (que el año pasado cuando arrancó el Chase). Siento que más o menos nos encontramos en el mismo lugar que el año pasado, más o menos haciendo las mismas cosas, pero hay otros muchachos que están mejores que nosotros, así que tendremos que averiguar cómo superarlos cuando lo necesitemos&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
