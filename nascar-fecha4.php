...
<title>Nascar en Phoenix | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('nascar-fecha4-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineNASCARf4.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("nascar-fecha4-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("nascar-fecha4-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("nascar-fecha4-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineNASCARf4.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_RhngrBtxtSl9SMvKLArED1jEztlK1M4lbYkYkZC5aEz"><a href="http://www.tutiempo.net/tiempo/Las_Vegas_Nexrad/KESX.htm">Las Vegas Nexrad</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RhngrBtxtSl9SMvKLArED1jEztlK1M4lbYkYkZC5aEz"></script></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/FmxhIp7KPmI" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('nascar-fecha4-videos.php');
echo $cadena;
?>
                          </div>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="nascar-fecha4-domingo.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="nascar-fecha4-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="nascar-fecha4-domingo.php">Actividad del domingo </a></td>
                        </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Kevin Harvick (Ganador) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="harvick1.jpg" width="120" height="168" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Sabía que Edwards me podía ganar por el lado interno y trataba de defenderme especialmente en las curvas 3 y 4 a pesar de todo el neumático que se me había gastado. Podría haberme mantenido bien a la defensiva en el final pero subí demasiado al lado externo y Edwards se me metió por el costado pero pude salir bien de la última curva y rozarlo en la puerta antes de cruzar la meta&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
              ...
              <table width="265" height="211" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"><a href="toprace-fecha1.php"><img src="boton fecha top race.png" width="187" height="34" border="0" /></a><br />
