...
<title>Nascar en Texas | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('nascar-fecha7-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineNASCARf7.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("nascar-fecha7-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("nascar-fecha7-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("nascar-fecha7-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineNASCARf7.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_thnALhdBdMKBM1pKLfwlm23lGtaKMnSFLtkdEZyIaEz"><a href="http://www.tutiempo.net">Tutiempo.net</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_thnALhdBdMKBM1pKLfwlm23lGtaKMnSFLtkdEZyIaEz"></script></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/rCr1TM0_6uo" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('nascar-fecha7-videos.php');
echo $cadena;
?>
                          </div>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="nascar-fecha7-sabado.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="nascar-fecha7-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="nascar-fecha7-sabado.php">Las fotos de la carrera </a></td>
                        </tr>
                    </table></td>
