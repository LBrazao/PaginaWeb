...
$cadena=file_get_contents('nascar-fecha8-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineNASCARf8.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("nascar-fecha8-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("nascar-fecha8-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("nascar-fecha8-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineNASCARf8.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_tBngLxdxdpMatLvKMfwlmF3l3tuKTMplLt1tkZiIqkz"><a href="http://www.tutiempo.net/tiempo/Bristol_Johnson_Kingsport_Tri-City_Regional_Airport/KTRI.htm">Pronóstico meteorológico para Bristol / Johnson / Kingsport, Tri-City Regional Airport</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_tBngLxdxdpMatLvKMfwlmF3l3tuKTMplLt1tkZiIqkz"></script></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/sj2F9u3l46A" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('nascar-fecha8-videos.php');
echo $cadena;
?>
                          </div>
