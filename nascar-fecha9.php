...
<title>Nascar Richmond | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Richmond  <br />
        ...
        <div class="subtitle">FECHA 9 | NASCAR </div></td>
...
$cadena=file_get_contents('nascar-fecha9-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineNASCARf9.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("nascar-fecha9-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("nascar-fecha9-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("nascar-fecha9-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineNASCARf9.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_thjALxtxt1jBjL6ALfrFm2323tlATCC2rd1dkZC5K1j"><a href="http://www.tutiempo.net/tiempo/Richmond_Richmond_International_Airport/KRIC.htm">Richmond, Richmond International Airport</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_thjALxtxt1jBjL6ALfrFm2323tlATCC2rd1dkZC5K1j"></script></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/t1YdNgPMBsQ" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('nascar-fecha9-videos.php');
echo $cadena;
?>
                          </div>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Carl Edwards (Ganador) </span></td>
                                    ...
                                    <table width="49" height="23" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="49"><table width="46" height="19" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFF00">
                                            <tr>
                                              <td><div align="center" class="Estilo126">19</div></td>
                                            </tr>
                                        </table></td>
                                      </tr>
                                    </table>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="edwards.jpg" width="120" height="139" /></td>
                                    </tr>
                                  </table>
                                  <span class="Verdanachico">&quot;Kyle (Busch) es un compañero increíble, y es como si se pusiera lento en la última curva. Algo pasó la última vuelta. Era como que sus neumáticos traseros se apagaron o algo así. Se fue hasta el lado interno en la curva 1, lo alcancé a y pensé, 'Hombre, tengo algo'.<br />
                                  En las últimas dos curvas bajó al lado interno  y yo ya había decidido ir por ese sector, así que pensé, 'Hombre, voy a darle un pequeño empujón'. Creo que los dos ganamos, estamos corriendo por el afán de conseguir estos trofeos. Fue  un día increíble.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
