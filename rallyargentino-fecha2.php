...
<title>Rally de Neuquén | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
         ...
         <table width="671" height="405" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
           <tr>
             <td valign="bottom"><div id="resultados">
               <?php
$cadena=file_get_contents('rallyargentino-fecha2-resultados.php');
echo $cadena;
?>
             </div></td>
           </tr>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineRARGf2.php");
        }, 100000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("rallyargentino-fecha2-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("rallyargentino-fecha2-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("rallyargentino-fecha2-noticias.php");
        }, 60000);
    });
</script> 

<div id="actualizacion" class="news_wrc"><?php
$cadena=file_get_contents('onlineRARGf2.php');
echo $cadena;
?>
          </div>
...
<div id="TT_thtgLhYxdaYaW1DU1fwEjEDEztlULYDlrtEdEZCIqEj"><a href="http://www.tutiempo.net">Tu tiempo</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_thtgLhYxdaYaW1DU1fwEjEDEztlULYDlrtEdEZCIqEj"></script></td>
           </tr>
         </table></td>
   </tr>
 </table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/KTPktrrV4J8" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <div id="actualizacion_videos">
                        <?php
$cadena=file_get_contents('rallyargentino-fecha2-videos.php');
echo $cadena;
?>
                      </div>
                    ...
                    <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="/2015/rallyargentino-fecha2-domingo.jpg" width="233" height="136" border="0"/><br />
                                    <div class="playfoto"><a href="/2015/rallyargentino-fecha2-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                            </div></td>
                          </tr>
                          <tr>
                            <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="/2015/rallyargentino-fecha2-domingo.php">Las fotos de la última en Neuquén </a></td>
                          </tr>
                        </table></td>
              ...
              <tr>
                <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                    <tr>
                      <td width="222" height="27"><span class="Estilo125">Alejandro Cancio  (Previa) </span></td>
                    ...
                    <tr>
                      <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                          <tr>
                            <td><img src="cancio1.jpg" width="120" height="161" /></td>
                          </tr>
                        </table>
                          <span class="Verdanachico">&quot;Para nosotros es una fiesta. Son días con mucho trabajo, aunque por suerte mi viejo (Letín) se ocupa bastante de todo. Hay que ser buenos anfitriones, por eso tal vez la previa no es tan tranquila sino con mucho trabajo. Tengo muchas expectativas. El año pasado veníamos bien al ubicarnos segundos con el Peugeot 207 MR, pero una pinchadura nos retrasó y terminamos en el quinto lugar. Hace bastante ya que gané acá, así que sería muy bueno para todos poder lograrlo nuevamente y darles una alegría a todos los que me siguen y apoyan. Ganar de local significaría un golpe anímico muy grande y nos permitiría prendernos bien arriba en el campeonato&quot;</span><span class="Verdanachico"></span></td>
                    </tr>
                  </table>
                  <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                    <tr>
			...
			<table width="265" height="211" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <div style="padding:4px"> <a href="tc-fecha3.php"><img src="boton fecha tc.png" width="187" height="34" border="0" /></a><br />
                    ...
                    <a href="tc2000-fecha2.php"><img src="boton fecha tc2000.png" width="187" height="34" border="0" /></a></div></td>
              </tr>
            </table>
