...
<title>Rally de Entre Ríos | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Entre Ríos <br />
    </div>
    <div class="subtitle">FECHA 9 | RALLY ARGENTINO </div></td>
         ...
         <table width="671" height="405" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
           <tr>
             <td valign="bottom"><div id="resultados">
               <?php
$cadena=file_get_contents('rallyargentino-fecha9-resultados.php');
echo $cadena;
?>
             </div></td>
           </tr>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineRARGf9.php");
        }, 100000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("rallyargentino-fecha9-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("rallyargentino-fecha9-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("rallyargentino-fecha9-noticias.php");
        }, 60000);
    });
</script> 

<div id="actualizacion" class="news_wrc"><?php
$cadena=file_get_contents('onlineRARGf9.php');
echo $cadena;
?>
          </div>
...
<div id="TT_tBnAbxYBtMMcMTvKMAwFYFdFt9lKM4tlrY1d1ZCoakj">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_tBnAbxYBtMMcMTvKMAwFYFdFt9lKM4tlrY1d1ZCoakj"></script></td>
           </tr>
         </table></td>
   </tr>
 </table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/KgREEr7x8ew" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <div id="actualizacion_videos">
                        <?php
$cadena=file_get_contents('rallyargentino-fecha9-videos.php');
echo $cadena;
?>
                      </div>
