...
<title>Fórmula Renault en San Juan | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">San Juan <br />
        ...
        <div class="subtitle">FECHA 10 | FÓRMULA RENAULT </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">RÉCORD:</span> J. Santero (1'13&quot;600) <br />
...
$cadena=file_get_contents('renault-fecha10-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineFRf10.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("renault-fecha10-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("renault-fecha10-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("renault-fecha10-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineFRf10.php');
echo $cadena;
?>
          </div></div>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="/renault-fecha8-carrera1.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="/renault-fecha8-carrera2.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="/renault-fecha8-carrera2.php">La última carrera en San Juan  </a></td>
                        </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Rudi Bundziak  (Previa) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    ...
                                    <span class="Verdanachico">&quot;No conocemos el trazado, por eso trabajamos en el simulador y estamos confiados en funcionar bien. Vamos a tratar de poner mucha garra y hacer lo mejor posible para que el auto funcione de la mejor manera. Hay poca diferencia de puntos y es importante sumar bien y no abandonar. Quiero hacer un buen entrenamiento y dejar todo a punto para la clasificación. Como es un trazado donde hay pocos lugares de sobrepaso, es importante clasificar adelante.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"> <a href="f1-fecha18.php"><img src="boton fecha f1.png" width="187" height="34" border="0" /></a><br />
                                <a href="stc2000-fecha10.php"><img src="boton fecha stc2000.png" width="187" height="34" border="0" /></a><br />
