...
<title>Fórmula Renault en Mendoza | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">San Martín  <br />
    </div>
        <div class="subtitle">FECHA 2 | FÓRMULA RENAULT </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><img src="circuito san martin.png" width="238" height="108" border="0" /></td>
        </tr>
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">RÉCORD:</span> B. Etman (1'20&quot;611) <br />
...
$cadena=file_get_contents('renault-fecha2-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineFRf2.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("renault-fecha2-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("renault-fecha2-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("renault-fecha2-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineFRf2.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_vhjwLhYhdAdadTpA1Ar2mlmlmtuAMEd2rt1tEsCoKkD"><a href="http://www.tutiempo.net">El tiempo por Tutiempo.net</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vhjwLhYhdAdadTpA1Ar2mlmlmtuAMEd2rt1tEsCoKkD"></script></td>
        </tr>
      </table></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/iwFMF8nWmAo" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('renault-fecha2-videos.php');
echo $cadena;
?>
                          </div>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Hugo Bini<br /> 
                                (nuevos motores) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="bini.jpg" width="120" height="168" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;El F4R E 412 entregará alrededor de 13 caballos de fuerza más que el anterior. La potencia total ahora es de 163 HP, a 6000 rpm.<br />
                                    Principalmente el torque de este motor de 2000 cc es 208,3 nm a 4000 rpm. Además, la curva de potencia es mayor, su antecesor la alcanzaba a 5700 rpm, mientras que este nuevo impulsor llega a 6000. Entre otras diferencias, el F4R E 412 cuenta con otra admisión y otras levas. Es un motor de nueva generación, de una concepción diferente. En cuanto al mantenimiento será el igual al anterior. Cada fin de semana los motores realizan dos entrenamientos, la clasificación y dos carreras. La exigencia es muy alta.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"> <a href="stc2000-fecha3.php"><img src="boton fecha stc2000.png" width="187" height="34" border="0" /></a><br />
                                ...
                                <a href="nascar-fecha11.php"><img src="boton fecha nascar.png" width="187" height="34" border="0" /></a><br />
                                <br />
                            </div></td>
                      </tr>
                    </table>
