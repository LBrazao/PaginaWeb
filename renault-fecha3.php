...
<title>Fórmula Renault en Córdoba | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('renault-fecha3-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineFRf3.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("renault-fecha3-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("renault-fecha3-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("renault-fecha3-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineFRf3.php');
echo $cadena;
?>
          </div></div>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/8L9DjJaJoZA" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Baltazar Leguizamón (Previa) </span></td>
                                    ...
                                    <table width="49" height="23" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="49"><table width="46" height="19" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFF00">
                                          <tr>
                                            <td><div align="center" class="Estilo126">45</div></td>
                                          </tr>
                                        </table></td>
                                      </tr>
                                    </table>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="leguizamon.jpg" width="120" height="170" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Decidimos con mi equipo de trabajo bajarnos de la Fórmula 4 Sudamericana porque las cosas no estaban saliendo como tenían que salir. Estando en la punta del campeonato el auto no tenía el rendimiento acorde y sufrimos varias fallas que nos impidieron seguir luchando en las últimas dos fechas. Preferimos parar. Por suerte pudimos cerrar con el Werner Competición y continuar en actividad esta misma temporada&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
