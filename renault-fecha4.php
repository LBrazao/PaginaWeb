...
<title>Fórmula Renault en Concordia | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('renault-fecha4-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineFRf4.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("renault-fecha4-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("renault-fecha4-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("renault-fecha4-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineFRf4.php');
echo $cadena;
?>
          </div></div>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/4f_60y94WSo" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('renault-fecha4-videos.php');
echo $cadena;
?>
                          </div>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Gregorio Conta (Previa) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="gconta.jpg" width="120" height="158" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Estoy con muchas ganas y entusiasmado por correr nuevamente. Venimos de hacerlo en Alta Gracia el pasado fin de semana y ahora afrontamos Concordia. Será un trazado nuevo para todos nosotros, por lo que la clave sin dudas estará en adaptarse rápido al mismo y así poder ser rápido. Venimos trabajando muy bien con el Litoral Group. Es una pena que en Alta Gracia no haya podido terminar, porque tengo un gran auto. Ahora tengo que redondear un buen trabajo y así poder estar en el top ten.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
