...
<title>Fórmula Renault en Termas de Río Hondo | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('renault-fecha5-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineFRf5.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("renault-fecha5-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("renault-fecha5-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("renault-fecha5-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineFRf5.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_vhngrhYxY4SanMDKLfwkx1BEhtnKT4nlLtkd1cyIK1D"><a href="http://www.tutiempo.net">Tutiempo.net</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vhngrhYxY4SanMDKLfwkx1BEhtnKT4nlLtkd1cyIK1D"></script></td>
        </tr>
      </table></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><div class="newsfecha">
                    <?php
$cadena=file_get_contents('FR.php');
echo $cadena;
?>
                  </div>
                    <table style="margin-top:4px; margin-right:8px" width="151" border="0" align="right" cellpadding="0" cellspacing="0">
                      <tr>
                        <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasnoticias" href="renault-noticias.php">MAS NOTICIAS</a></li></td>
                      </tr>
                  </table></td>
              </tr>
            </table>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="/2015/renault-fecha4-domingo.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="/2015/renault-fecha4-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="/2015/renault-fecha4-domingo.php">La última carrera en Termas </a></td>
                        </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Gastón Cabrera (Previa) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="cabrera.jpg" width="120" height="119" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;El año pasado en Termas hicimos la pole para las dos carreras, gané la primera y en la segunda me fui afuera porque agarré un manchón de aceite del motor que se le había roto a Santi Mallo. Sabemos que es un circuito que nos trató muy bien así que vamos con las mejores expectativas para el fin de semana. La idea es sumar y sumar fuerte. Hay que sumar bien en las dos carreras. Sí se puede ganar por supuesto sería lo mejor pero hay que pensar en sumar fuerte y tratar de volvernos con la punta del Campeonato, pero no lo conseguimos el objetivo es seguir ahí prendidos entre los punteros y presionando por avanzar&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"> <a href="stc2000-fecha5.php"><img src="boton fecha stc2000.png" width="187" height="34" border="0" /></a><br />
                                ...
                                <a href="desafioruta40.html"><img src="boton fecha ruta40.png" width="187" height="34" border="0" /></a><br />
                                <br />
                          </div></td>
                      </tr>
                    </table>
