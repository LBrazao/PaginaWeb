...
<title>UNA C&Aacute;MARA DE SEGURIDAD CAPT&Oacute; EL ACCIDENTE DE LUIS SALOM | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">UNA C&Aacute;MARA DE SEGURIDAD CAPT&Oacute; EL ACCIDENTE DE LUIS SALOM  </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">3 de Junio de 2016 |</span> <span style="color:#DD0005; font-weight:bold">MOTO2</span> </td>
              <td width="35%"><div align="right" class="Estilo15"></div></td>
            </tr>
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/1j0etSTiCxk?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="134" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/salom-accidente.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Hoy por la ma&ntilde;ana argentina y tarde espa&ntilde;ola, Luis Salom perdi&oacute; la vida en un accidente durante los entrenamientos del Gran Premio de Catalunya del mundial de Moto2. Si bien la televisi&oacute;n oficial no logr&oacute; captar el momento del accidente, a trav&eacute;s de una c&aacute;mara de seguridad se pudo ver el suceso.</span></p>
          <p><span class="Estilo11">En la misma se puede observar c&oacute;mo primero la moto y luego el piloto impactan contra la contenci&oacute;n sin siquiera tener la posibilidad de intentar doblar hacia la derecha. Ese sector del circuito no ten&iacute;a camas de leca, por lo que no hubo nada que frene ni al piloto ni a la moto antes del impacto. Aparentemente la Kalex del espa&ntilde;ol habr&iacute;a sufrido una aver&iacute;a, algo que hizo que se dirigiera directo contra la contenci&oacute;n. Sobre una de las torres de banderilleros se puede observar claramente como al segundo del incidente se mostraba la bandera roja. </span></p>
          <p><span class="Estilo11">Desde ma&ntilde;ana en ese sector (curva 12)  la MotoGP, Moto2 y Moto3 utilizar&aacute;n la variante que utiliza la F&oacute;rmula 1 por motivos de seguridad. Esta variante es m&aacute;s lenta ya que es una chicana que va por el sector interno.</span></p>
          <p><span class="Estilo11"><span class="Estilo16">EN <span class="Estilo17">ROJO</span> EL CIRCUITO ANTIGUO, EN <span class="Estilo18">NEGRO</span> EL NUEVO Y EL QUE UTILIZA LA F&Oacute;RMULA 1 </span><br />
            <img src="salom-accidente.jpg" width="437" height="352" />. </span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/salom-accidente.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
