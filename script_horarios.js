...
function GetLocalTimeZoneInHours() {
    var d = new Date();
    var localOffset = new Number(d.getTimezoneOffset());
    return ((localOffset * -1) / 60);
}
...
function convertHorario(date) {
    try {
        ...
        var gmtlocal = GetLocalTimeZoneInHours();
        var rome = check24(((gmt + gmtlocal) > 24) ? ((gmt + gmtlocal) - 24) : (gmt + gmtlocal));
        //var ending = ":" + IfZero(dt.getMinutes()) + ":" +  IfZero(dt.getSeconds());
        var ending = ":" + IfZero(dt.getMinutes());
        return IfZero(rome) + ending;
    } catch (err) {
        return "--.--";
    }

    // Formato : "2011-04-08 10:00:00 GMT+0800"
}
// -------------------------------------------------------ARCHIVO NÚMERO DOS---------------------------------------------------------------------------------
