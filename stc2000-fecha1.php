...
<title>Súper TC2000 en Trelew | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('stc2000-fecha1-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineSTC2000f1.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("stc2000-fecha1-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("stc2000-fecha1-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("stc2000-fecha1-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineSTC2000f1.php');
echo $cadena;
?>
          </div></div>
            ...
            <table width="309" height="37" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="151" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:4px">
                  <tr>
                    <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasnoticias" href="stc2000-posiciones.php">CAMPEONATO</a></li></td>
                  </tr>
                </table></td>
                <td><table width="151" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:4px">
                  <tr>
                    <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasnoticias" href="stc2000-calendario.php">CARRERAS</a></li></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
...
<div id="TT_txtwLxtxdzDa816ULArkjkzEz9aUMY82LYkdkZCIqEz"><a href="http://www.tutiempo.net/trelew.html">Trelew</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_txtwLxtxdzDa816ULArkjkzEz9aUMY82LYkdkZCIqEz"></script></td>
  </tr>
</table>
        ...
        <td width="508" valign="top"><li class="cabezanoticias"><span class="textoenvivo" >VIDEOS</span></li>
              ...
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/XlJCa51tx7w" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td></td>
                              ...
                              <?php
$cadena=file_get_contents('stc2000-fecha1-videos.php');
echo $cadena;
?>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="stc2000-fecha1-domingo.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="stc2000-fecha1-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="stc2000-fecha1-domingo.php">Actividad del domingo </a></td>
                      </tr>
                    </table></td>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="stc2000-fecha1-sabado.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="stc2000-fecha1-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="stc2000-fecha1-sabado.php">Actividad del sábado </a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Emiliano Spataro (Ganador) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="spataro7.jpg" width="120" height="172" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Salió redondo y no fue facil porque me tocó dos veces largar por afuera y las dos veces pude largar bien aunque en la final fue la mejor. Pude largar mejor que Javi (Merlo) y llegar a la curva 1 con casi todo el auto delante de él y a partir de ahí pensé que podía mantener un buen ritmo pero en la segunda vuelta había mucha tierra, me tomé cierta precaución porque los banderilleros y el lisso señalaban que había poca adherencia pero igual me pasé en la curva 1 y 2 y nos pusimos con Norberto (Fontana) y Javier (Merlo) en una misma línea, llegamos al frenaje de la curva 3 y pude mantener la punta de casualidad. Me preocupé, cuando vi que quedé adelante intenté acelerar un par de vueltas para hacer una diferencia y en las últimas me cuidé porque vi que Fontana no tenía tanto para correrme.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"> <a href="motogp-fecha1.php"><img src="boton fecha motogp.png" width="187" height="34" border="0" /></a><br />
                                ...
                                <a href="crosscountry-fecha1.php"><img src="boton fecha cross country.png" width="187" height="34" border="0" /></a><br />
                                <a href="nascar-fecha5.php"><img src="boton fecha nascar.png" width="187" height="34" border="0" /></a><br />
                            </div></td>
                      </tr>
                    </table>
