...
<title>C&Aacute;MARAS A BORDO: FINESCHI RECARGADO POR EL TOQUE A PERN&Iacute;A, GANA URCERA | TC La Revista</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Alta Gracia <br />
        ...
        <div class="subtitle">FECHA 4 | S&Uacute;PER TC2000 </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">R&Eacute;CORD:</span> A. Canapino (1'29&quot;588) <br />
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">C&Aacute;MARAS A BORDO: FINESCHI RECARGADO POR EL TOQUE A PERN&Iacute;A, GANA URCERA  </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">29 de Mayo de 2016 |</span> <span style="color:#DD0005; font-weight:bold">S&Uacute;PER TC2000</span> </td>
              <td width="35%"><div align="right" class="Estilo15"></div></td>
            </tr>
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/pdfoXIe_rdM?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="514" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="190"><a href="stc2000-fecha4.php" class="buttons_propierties"> <img src="boton noticias.png" border="0" width="190" height="38" />
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/stc2000-fecha4-onboard.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Luego de una eterna resistencia ante Leonel Pern&iacute;a, Dami&aacute;n Fineschi hab&iacute;a podido lograr la victoria a bordo del Peugeot 408. Sin embargo por dejar sin pista al Fluence del 'Tanito' en la vuelta 24 en la zona de la chicana, el j&oacute;ven de 28 a&ntilde;os fue recargado al cuarto puesto.</span></p>
          <p><span class="Estilo11">En la parte superior te mostramos la c&aacute;mara a bordo de Leonel Pern&iacute;a, mientras que abajo te dejamos la c&aacute;mara de Fineschi para que puedas sacar tus propias conclusiones.</span></p>
          <p><span class="Estilo11">
            <iframe src="http://www.youtube.com/embed/4j0YqcbdJyU" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
            .   </span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/stc2000-fecha4-onboard.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
          ...
          <tr>
            <td height="622" valign="top" bgcolor="#F4F4F4"><div align="center">
                <table width="100%" height="66" border="0" cellpadding="4" cellspacing="0">
                  <tr>
                    <td width="29%">&nbsp;</td>
                    <td width="71%" valign="top"><a href="stc2000-fecha4.php"><img src="volver.png" width="168" height="58" border="0" />
