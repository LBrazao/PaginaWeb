...
<title>Súper TC2000 en Córdoba | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Alta Gracia <br />
        ...
        <div class="subtitle">FECHA 4 | SÚPER TC2000 </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">RÉCORD:</span> A. Canapino (1'29&quot;588) <br />
...
$cadena=file_get_contents('stc2000-fecha4-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineSTC2000f4.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("stc2000-fecha4-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("stc2000-fecha4-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("stc2000-fecha4-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineSTC2000f4.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_RhnAbxYxdrSBMLDKLfr1jEj1j9uK14rlLt1tkZioq1z"><a href="http://www.tutiempo.net/alta-gracia.html">Pronóstico meteorológico para Alta Gracia</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RhnAbxYxdrSBMLDKLfr1jEj1j9uK14rlLt1tkZioq1z"></script></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/dO8-RYoAIuQ" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="/2015/stc2000-fecha11-sabado.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="/2015/stc2000-fecha11-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="/2015/stc2000-fecha11-sabado.php">La última carrera en Córdoba</a></td>
                        </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Leonel Pernía (Pole) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="pernia2.jpg" width="120" height="173" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;El auto cayo tremendamente bien desde la primera vuelta. Se mostró contundente en todo momento, con esa performance tenía la obligación de llevarlo a la Pole. Ganar la clasificación acá para el equipo es ganar en casa. Es muy importante haber logrado esta Pole. Con el auto como el que tengo vamos a tratar de ir para adelante, a pesar de las penalizaciones&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
