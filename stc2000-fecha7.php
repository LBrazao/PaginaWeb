...
<title>200 kilómetros de Buenos Aires | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('stc2000-fecha7-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
<div style="margin-left:5px;">
      ...
      <table width="314" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><div id="noticias" class="nota_fecha">
                      <?php
$cadena=file_get_contents('stc2000-fecha7-noticias.php');
echo $cadena;
?>
                    </div>
                  </td>
...
<div id="TT_RBtwLhYBY88BWL6UMAwED1D1DtaULYc2LY1Y1cC5akD">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RBtwLhYBY88BWL6UMAwED1D1DtaULYc2LY1Y1cC5akD"></script></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/oW0mz1ob_vQ" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('stc2000-fecha7-videos.php');
echo $cadena;
?>
              ...
              <td valign="top"><div id="mas_fotos" class="fotos">
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="stc2000-fecha7-domingo.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="stc2000-fecha7-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="stc2000-fecha7-domingo.php">Actividad del domingo </a></td>
                        </tr>
                    </table></td>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="stc2000-fecha7-sabado.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="stc2000-fecha7-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="stc2000-fecha7-sabado.php">Actividad del sábado </a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="stc2000-fecha7-viernes.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="stc2000-fecha7-viernes.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="stc2000-fecha7-viernes.php">Actividad del viernes </a></td>
                      </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Agustín Canapino (Ganador) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="canapino7.jpg" width="120" height="185" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Necesitaba muchísimo esta victoria porque era algo que se nos venía negando, veníamos en un buen año pero no lográbamos la victoria y ya sentía hasta impotencia, me daba bronca y esto es un gran desahogo, quedé afónico, me descargué una tonelada de encima, necesitaba ganar y hacerlo en los 200 kilómetros con Guille (Ortelli) es como ponerle el moño a este gran sueño.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
              ...
              <table width="265" height="211" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"> <a href="renault-fecha7.php"><img src="boton fecha renault.png" width="187" height="34" border="0" /></a><br />
