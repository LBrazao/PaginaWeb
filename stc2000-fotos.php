...
<title>S&uacute;per TC2000 | Fotos</title>
  ...
  <tr>
    <td valign="top"><div style="padding:8px;">
      <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
        <tr>
          <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="../stc2000-fecha12-carrera.jpg" width="233" height="136" border="0"/><br />
                  <div class="playfoto"><a href="../stc2000-fecha12-domingo.php" onmouseover="changefoto1(), MM_swapImage('camara1','','camara.png',1)"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" onmouseout="changefotosalir()"/></a></div>
          </div></td>
          <td width="348"><div style="padding:4px;"><a href="../stc2000-fecha12-domingo.php" class="titulofotos">Domingo en Potrero de los Funes - Girolami campe&oacute;n </a><br />
              <a href="../stc2000-fecha12-domingo.php" class="subtitulofotos">VER FOTOS &gt;&gt;</a></div></td>
        </tr>
      </table>
      <br />
      <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
        <tr>
          <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="../stc2000-fecha12-jueves.jpg" width="233" height="136" border="0"/><br />
                  <div class="playfoto"><a href="../stc2000-fecha12-jueves.php" onmouseover="changefoto1(), MM_swapImage('camara1','','camara.png',1)"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" onmouseout="changefotosalir()"/></a></div>
          </div></td>
          <td width="348"><div style="padding:4px;"><a href="../stc2000-fecha12-jueves.php" class="titulofotos">Jueves en Potrero de los Funes - Clasificaci&oacute;n </a><br />
              <a href="../stc2000-fecha12-jueves.php" class="subtitulofotos">VER FOTOS &gt;&gt;</a></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
