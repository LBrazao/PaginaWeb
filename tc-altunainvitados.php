...
<title>ALTUNA CREE QUE LOS PILOTOS DEL TC PISTA Y TC MOURAS VAN A RESALTAR EN LOS 500 KIL&Oacute;METROS DE OLAVARR&Iacute;A  | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">ALTUNA CREE QUE LOS PILOTOS DEL TC PISTA Y TC MOURAS VAN A RESALTAR EN LOS 500 KIL&Oacute;METROS DE OLAVARR&Iacute;A </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td height="19"><span style="color:#666666">1 de Marzo de 2016 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              </tr>
            <tr>
              <td><iframe src="http://www.youtube.com/embed/PzUMU-w9LhI?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
                <br />
			  <div class="fb-like" data-href="http://www.tclarevista.com.ar/2015/tc-altunainvitados.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
            </tr>
          </table>
          <p><span class="Estilo11">
            La carrera de los 500 kil&oacute;metros de Olavarr&iacute;a ser&aacute; con pilotos invitados como ya es de p&uacute;blico conocimiento. La ACTC se ha encargado de promover invitaciones a pilotos de la misma asociaci&oacute;n, es decir, pilotos que compitan en TC Pista, TC Mouras y TC Pista Mouras. Sin embargo muchos opinan que a&uacute;n no est&aacute;n del todo acondicionados para pilotar un Turismo Carretera en una carrera de larga duraci&oacute;n y afirman que ser&iacute;a mejor invitar a pilotos experimentas aunque nunca hayan estado a bordo de un coche de este tipo.</span></p>
          <p><span class="Estilo11">Mariano Altuna opina lo contrario, y es que cree que los pilotos de las inferiores del TC, no solamente se adaptar&aacute;n r&aacute;pido sino que resaltar&aacute;n m&aacute;s que incluso otros pilotos experimentados externos a la ACTC. MIR&Aacute; EL VIDEO... </span></p>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2015/tc-altunainvitados.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
<p>&nbsp;</p>
    </div></td>
  </tr>
</table>
