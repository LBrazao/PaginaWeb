...
<title>DIAGN&Oacute;STICO FINAL: 11 MOTORES ROTOS TRAS LA PRIMERA CARRERA DEL A&Ntilde;O | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">DIAGN&Oacute;STICO FINAL: 11 MOTORES ROTOS TRAS LA PRIMERA CARRERA DEL A&Ntilde;O </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">21 de Febrero de 2015 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              <td width="35%"><div align="right" class="Estilo15">Por Lucas Barraza </div></td>
            </tr>
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-fecha1-motoresdomingo.jpg" width="754" height="425" /></span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha1-motoresdomingo.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Realmente no ha sido para nada el comienzo de temporada esperado para los motores multiv&aacute;lvulas. Finalizada la primer carrera del a&ntilde;o ya han sido 11 los impulsores que colapsaron obligando a pilotos y equipos a moverse de un lado al otro para intentar conseguir uno de repuesto que no siempre se encontraba.</span></p>
          <p><span class="Estilo11">A continuaci&oacute;n la lista de los motores rotos en lo poco que va de la temporada y en qu&eacute; momentos sufrieron sus problemas:</span></p>
          <table cellpadding="0" cellspacing="0" class="excel122" id="tiempos">
            ...
            <tr height="20" style="height:15.0pt;">
              <td height="20" class="excel124" width="100" style="height:15.0pt;width:75pt;"></td>
              <td class="excel125" width="143" style="width:107pt;">Motor 1</td>
              <td class="excel125" width="120" style="width:90pt;">Motor 2</td>
              <td class="excel125" width="122" style="width:92pt;">Motor 3</td>
            </tr>
            <tr height="20" style="height:15.0pt;">
              <td height="20" class="excel124" style="height:15.0pt;">LAMBIRIS</td>
              <td class="excel123">Mi&eacute;rcoles (Olavarr&iacute;a)</td>
              <td class="excel123">2&ordm; Clasificaci&oacute;n</td>
              <td class="excel123">Final</td>
            </tr>
            <tr height="20" style="height:15.0pt;">
              <td height="20" class="excel124" style="height:15.0pt;">WERNER</td>
              <td class="excel123">1&ordm; Entrenamiento</td>
              <td class="excel123">2&ordm; Entrenamiento</td>
              <td class="excel123">Serie</td>
            </tr>
            <tr height="20" style="height:15.0pt;">
              <td height="20" class="excel124" style="height:15.0pt;">ECHEVARRIA</td>
              <td class="excel123">2&ordm; Entrenamiento</td>
              <td class="excel123">Final</td>
              <td class="excel123"></td>
            </tr>
            <tr height="20" style="height:15.0pt;">
              <td height="20" class="excel124" style="height:15.0pt;">URCERA</td>
              <td class="excel123"> Serie</td>
              <td class="excel123"></td>
              <td class="excel123"></td>
            </tr>
            <tr height="20" style="height:15.0pt;">
              <td height="20" class="excel124" style="height:15.0pt;">ARDUSSO</td>
              <td class="excel123">Final</td>
              <td class="excel123"></td>
              <td class="excel123"></td>
            </tr>
            <tr height="20" style="height:15.0pt;">
              <td height="20" class="excel124" style="height:15.0pt;">ORTELLI</td>
              <td class="excel123">Final</td>
              <td class="excel123"></td>
              <td class="excel123"></td>
            </tr>
          </table>
          <p><span class="Estilo11">Pilotos como <strong>Ebarl&iacute;n, Castellano y Savino</strong> pareci&oacute; tambi&eacute;n verlos como v&iacute;ctima de la rotura de su impulsor, sin embargo luego se comprob&oacute; que los problemas eran la correa del alternador (Ebarl&iacute;n), mal funcionamiento del motor pero no de roturas (Castellano) y el diferencial (Savino).</span></p>
          <p><span class="Estilo11">Uno de los asuntos m&aacute;s preocupantes fue la ausencia de motores de repuesto luego de casi un a&ntilde;o de haber iniciado el proyecto multiv&aacute;lvulas y dos meses de receso sin carreras. Esto desemboc&oacute; en que Urcera y Werner no pudieran correr la final y adem&aacute;s que el piloto entrerriano tuviera que pedir un motor prestado a Rody Agut para poder correr el domingo.</span></p>
          <p><span class="Estilo11">&iquest;Cu&aacute;l es el problema? &iquest;Falta de inversi&oacute;n? &iquest;Falta de trabajo?  </span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha1-motoresdomingo.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
