...
<title>ROSSI: &quot;EL COCHE ES IND&Oacute;CIL Y CANSA M&Aacute;S PARA MANEJAR&quot; | TC La Revista</title>
  ...
  <tr>
    ...
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">R&Eacute;CORD:</span> M. Rossi (1'43&quot;803) <br />
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">ROSSI: &quot;EL COCHE ES IND&Oacute;CIL Y CANSA M&Aacute;S PARA MANEJAR&quot;  </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td height="19"><span style="color:#666666">20 de Marzo de 2015 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              </tr>
            <tr>
              <td><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-fecha1-rossiviernes.jpg" width="754" height="425" /></span></td>
            </tr>
            <tr>
              <td><table width="380" height="44" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><a href="tc-fecha1.php" class="buttons_propierties">
				<img src="boton noticias.png" border="0" width="190" height="38" />
				<div class="buttons_align">RESULTADOS</div>
            </a></td>
            <td><a href="tc-posiciones.php" class="buttons_propierties">
				<img src="boton noticias.png" border="0" width="190" height="38" />
				<div class="buttons_align">CAMPEONATO</div>
            </a></td>
            </tr>
        </table><div class="fb-like" data-href="http://www.tclarevista.com.ar/2015/tc-fecha1-rossiviernes.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
            </tr>
          </table>
          <p><span class="Estilo11">&quot;Fue buena la practica y la clasificaci&oacute;n tambi&eacute;n fue bastante buena. Estamos tratando de entender el comportamiento del coche, haber completado todas las vueltas es muy importante. No anda bien el coche por la falta de cargas: hay mucho por evolucionar todav&iacute;a pero ser el m&aacute;s r&aacute;pido en mi grupo y completar todas las vueltas es importante. </span></p>
          <p><span class="Estilo11">&quot;Es muy grata la sencaci&oacute;n del motor con m&aacute;s potencia. Pens&aacute;bamos que &iacute;bamos a perder m&aacute;s carga delantera pero no fue as&iacute;. El objetivo de la carrera es completarla porque la combinaci&oacute;n del chasis hace que sea todo muy completo, igualmente fue excelente el segundo puesto de hoy. El coche es muy ind&oacute;cil, cansa m&aacute;s para manejar y todas las zonas de aceleraci&oacute;n son dif&iacute;ciles por la falta de carga y el aumento de potencia, adem&aacute;s es dif&iacute;cil se preciso en las maniobras. Lo m&aacute;s complicado fueron las partes lentas para acelerar y frenar porque el coche genera mucha potencia de golpe y patina mucho. Todo apunta a que los coches se van a caer m&aacute;s durante la carrera y que la reducci&oacute;n de carga aerodin&aacute;mica delantera ayudar&aacute; a que los coches puedan doblar m&aacute;s pegado y sea m&aacute;s f&aacute;cil intentar un sobrepaso&quot; </span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2015/tc-fecha1-rossiviernes.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
