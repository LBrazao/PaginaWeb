...
<title>AVANZA EL PROYECTO NASCAR DE MAT&Iacute;AS ROSSI Y LAUREANO CAMPANERA  | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">AVANZA EL PROYECTO NASCAR DE MAT&Iacute;AS ROSSI Y LAUREANO CAMPANERA  </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td height="19"><span style="color:#666666">26 de Septiembre de 2015 |</span> <span style="color:#DD0005; font-weight:bold">NASCAR</span> </td>
              </tr>
            <tr>
              <td><iframe src="http://www.youtube.com/embed/pz-RL67Liio?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
                <br />
			  <div class="fb-like" data-href="http://www.tclarevista.com.ar/2015/tc-fecha10-rossinascar.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
            </tr>
          </table>
          <p><span class="Estilo11">
            El proyecto Nascar de Laureano Campanera parece ir tomando cada vez m&aacute;s forma. El piloto de Don Torcuato contin&uacute;a con las negociaciones para hacer ingresar a Mat&iacute;as Rossi dentro de la m&aacute;xima competici&oacute;n de Am&eacute;rica y una de las m&aacute;s importantes y competitivas del mundo.</span></p>
          <p><span class="Estilo11">El 'Laucha' comenta los movimientos realizados los &uacute;ltimos meses, las relaciones con pilotos y propietarios y la posibilidad de una futura prueba para el campe&oacute;n de TC y tetracampe&oacute;n de S&uacute;per TC2000. </span><span class="Estilo11"></span></p>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2015/tc-fecha10-rossinascar.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
<p>&nbsp;</p>
    </div></td>
  </tr>
</table>
