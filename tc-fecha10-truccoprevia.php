...
<title>TRUCCO: &quot;VEREMOS SI EL A&Ntilde;O QUE VIENE LA ACTC PIENSA UN POCO M&Aacute;S EN LOS DODGE&quot; | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">TRUCCO: &quot;VEREMOS SI EL A&Ntilde;O QUE VIENE LA ACTC PIENSA UN POCO M&Aacute;S EN LOS DODGE&quot; </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/YLhOUJlfJgQ?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="514" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2015/tc-fecha11-truccoprevia.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Tras el cambio reglamentario las opiniones han vuelto a disparar para todos los bandos. En este caso uno de los usuarios de Dodge se ha visto sorprendido por la medida t&eacute;cnica que ha tomado la ACTC en los Chevrolet para el resto del campeonato y la Copa de Oro.</span></p>
          <p><span class="Estilo11">Adem&aacute;s el an&aacute;lisis de c&oacute;mo influye este cambio para la inmediata carrera de este fin de semana en Rafaela y su visi&oacute;n de performance en la previa en una pista tan r&aacute;pida. </span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2015/tc-fecha11-truccoprevia.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
