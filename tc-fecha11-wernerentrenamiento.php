...
<title>WERNER ENTIENDE MEJOR LAS GOMAS NUEVAS Y CONTROLA LA IDA DE COLA ANTES DE CLASIFICAR | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">WERNER MEJORA LA IDA DE COLA LUEGO DE PERDERSE LA PRIMERA PARTE DEL ENTRENAMIENTO </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><span class="Estilo11">
                <iframe src="http://www.youtube.com/embed/D5qWnlTnrpU?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
                </span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha11-wernerentrenamiento.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">&quot;Hicimos un cambio de &uacute;ltimo momento, necesit&aacute;bamos chequear las alturas del auto y los pesos por rueda as&iacute; que decidimos priorizar eso para que el cambio sea bien probado. Hay cosas que han mejorad y cosas que por ah&iacute; nos faltan un poco, vamos a ver los datos y a analizarlo. La tendencia de cola que tuvimos ayer con las gomas nuevas hoy la mejoramos, invertimos un poco las gomas y a priori sentimos una mejora. Creo que se van a arrimar los tiempos a la pole pero no s&eacute; si vamos a llegar a lo de Ardusso</span><span class="Estilo11">&quot;</span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha11-wernerentrenamiento.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
