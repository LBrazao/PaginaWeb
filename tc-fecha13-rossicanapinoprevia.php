...
<title>MA&Ntilde;ANA ROSSI VS CANAPINO OTRA VEZ: REVIV&Iacute; SUS ENFRENTAMIENTOS DE ESTE A&Ntilde;O  | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">MA&Ntilde;ANA ROSSI VS CANAPINO OTRA VEZ: REVIV&Iacute; SUS ENFRENTAMIENTOS DE ESTE A&Ntilde;O </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-fecha13-rossicanapinoprevia.jpg" width="754" height="425" /></span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha13-rossicanapinoprevia.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Ma&ntilde;ana por la ma&ntilde;ana viviremos el quinto enfrentamiento del a&ntilde;o entre Rossi y Canapino cuando se disputen mano a mano la primera serie. De los cuatro duelos que tuvieron este a&ntilde;o, <strong>en los 4 Rossi termin&oacute; adelante aunque algunos con incidentes de por medio.</strong></span></p>
          <p><span class="Estilo11">Para refrescar un poco la memoria te proponemos revivir esas cuatro peleas en pista que tuvieron este a&ntilde;o dos de los mejores pilotos de la Argentina.</span></p>
          <p><span class="Estilo11 Estilo16">1. VIEDMA (3&ordm; Serie): <br />
            <iframe src="http://www.youtube.com/embed/9RK-LRHys2k?start=68&end=100" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
            <br />
            <iframe src="http://www.youtube.com/embed/JGJ7P0TsgVU" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
            . </span></p>
          <p><span class="Estilo11 Estilo16">2. CONCORDIA (1&ordm; Serie): <br />
            <iframe src="http://www.youtube.com/embed/mDl9rM3kP0w" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
</span></p>
          <p><span class="Estilo11 Estilo16">3. POSADAS (2&ordm; Serie - Canapino sancionado): <br />
            <iframe src="http://www.youtube.com/embed/fzkAD1wa3vw" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
</span></p>
          <p><span class="Estilo11 Estilo16">4. CONCEPCI&Oacute;N DEL URUGUAY (Final): <br />
            <iframe src="http://www.youtube.com/embed/csEGJCStgks" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
          </span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha13-rossicanapinoprevia.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
