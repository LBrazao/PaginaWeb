...
<title>1&ordm; ENTRENAMIENTO: WERNER NO CIERRA VUELTA Y QUEDA 19&ordm; | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">1&ordm; ENTRENAMIENTO: WERNER NO CIERRA VUELTA Y QUEDA 19&ordm;</span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/PBshBki8API?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha14-wernerentrenamiento.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Las alarmas se encendieron cuando corr&iacute;an los minutos del entrenamiento y Werner ca&iacute;a en el clasificador sin mejorar su crono registrado en el inicio de la tanda. Mariano explica su m&eacute;todo de trabajo en el entrenamiento, el cual no incluy&oacute; cerrar vuelta sino parcializar, con lo cual no se muestra preocupado para clasificar. </span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha14-wernerentrenamiento.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
