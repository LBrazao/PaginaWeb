...
<title>TC en Trelew | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="334"><table width="238" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">RÉCORD:</span> M. Rodríguez (1'17&quot;894) 
        <br />
...
$cadena=file_get_contents('tc-fecha14-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTCf14.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tc-fecha14-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tc-fecha14-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tc-fecha14-noticias.php");
        }, 60000);
    });
</script> 
                  ...
                  <tr>
                    <td valign="top"><a href="javascript:;"><img src="up_noticias_transparente.jpg" width="314" height="22" border="0" id="up" onmouseover="MM_swapImage('up','','up_noticias.jpg',1)" onmouseout="MM_swapImgRestore()" /></a>
                        <div id="noticias" class="nota_fecha">
                          <?php
$cadena=file_get_contents('tc-fecha14-noticias.php');
echo $cadena;
?>
                        </div>
...
<div id="TT_thjgLBdhtfj9dTvA1frlm23FmtnALEd2rdEd1ZC5aEz">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_thjgLBdhtfj9dTvA1frlm23FmtnALEd2rdEd1ZC5aEz"></script></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/rVO4tosMtDk" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('tc-fecha14-videos.php');
echo $cadena;
?>
                          </div>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tc-fecha14-domingo.php">Actividad del domingo </a></td>
                        </tr>
                    </table></td>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="publico-trelew.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="publico-trelew.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="publico-trelew.php">Los fanáticos en Trelew </a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tc-fecha14-sabado.php">Actividad del viernes y sábado </a></td>
                      </tr>
                    </table></td>
...
?>
                        ...
                        <div align="center" id="div3" class="tv2-change"></div></td>
                  </tr>
                </table>
                <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                  <tr>
              ...
              <tr>
                <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <div style="padding:4px"> 
                      ...
                      <a href="f1-fecha20.php"><img src="boton fecha f1.png" width="187" height="34" border="0" /></a><br />
                      <a href="motogp-fecha18.php"><img src="boton fecha motogp.png" width="187" height="34" border="0" /></a><br />
                      <a href="/2017/fe-fecha2.php"><img src="boton fecha fe.png" width="187" height="34" border="0" /></a><br />
                      <a href="nascar-fecha35.php"><img src="boton fecha nascar.png" width="187" height="34" border="0" /></a><br /></div></td>
              </tr>
            </table>
			<table width="314" height="8" border="0" cellpadding="0" cellspacing="0" background="pie relatos.png">
              <tr>
