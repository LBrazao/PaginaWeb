...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">GIALLOMBARDO TEME POR LA FALTA DE VISIBILIDAD EN EL ENTRENAMIENTO DE ESTA TARDE </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-fecha15-giallombardoprevia.jpg" width="754" height="425" /></span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2015/tc-fecha15-giallombardoprevia.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">El primer entrenamiento del fin de semana se ha planeado para las 18:20 y el mismo finalizar&aacute; a las 19:55 en caso de no haber banderas rojas que retrasen la actividad. Uno de los pilotos que se ha mostrado preocupado ha sido Mauro Giallombardo, quien es de p&uacute;blico conocimiento que tiene dificultades en la visi&oacute;n, por lo que debe utilizar lentes para pilotar.</span></p>
          <p><span class="Estilo11"><span class="Estilo16">&quot;Si veo que se pone muy oscuro me meto a boxes&quot;</span>, dijo algo en broma y algo en serio Giallombardo. <span class="Estilo16">&quot;Yo tengo que usar lentes y entre lo nublado que est&aacute; el clima y lo tarde que vamos a terminar no se si se me va a complicar&quot;</span>.</span></p>
          <p><span class="Estilo11">Cabe recordar que en esta &eacute;poca del a&ntilde;o la puesta del sol en Comodoro Rivadavia est&aacute; estipulada para las 20:46 debido a su posici&oacute;n geogr&aacute;fica tan austral, sin embargo las nubes pueden colaborar para que anochezca antes. por otro lado la probabilidad de banderas rojas en las pistas del sur siemrpe han sido altas por la falta de adherencia del asfalto, por lo cual tambi&eacute;n podr&iacute;a ser una dificultad especialmente para los pilotos del grupo B que cerrar&aacute;n el d&iacute;a. </span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2015/tc-fecha15-giallombardoprevia.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
