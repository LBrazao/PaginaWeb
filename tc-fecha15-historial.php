...
<title>REVIV&Iacute; LAS 7 CORONAS DEL HEPTACAMPE&Oacute;N DE TC | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">REVIV&Iacute; LAS 7 CORONAS DEL HEPTACAMPE&Oacute;N DE TC </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-fecha15-historial.jpg" width="753" height="447" /></span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha15-historial.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><div align="center" class="epigrafe Estilo19"><strong>1998
              </strong></div>
                <iframe src="http://www.youtube.com/embed/RRPuGM2JlSo" name="contenedor" width="375" height="210" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
              <td><div align="center" class="epigrafe Estilo19"><strong>2000 </strong></div>
                <iframe src="http://www.youtube.com/embed/tmPWm1JQSSU" name="contenedor" width="375" height="210" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
          </table>
          <br />
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><div align="center" class="epigrafe Estilo19"><strong>2001 </strong></div>
                  <iframe src="http://www.youtube.com/embed/h9e1OwPupuY" name="contenedor" width="375" height="210" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
              <td><div align="center" class="epigrafe Estilo19"><strong>2002 </strong></div>
                  <iframe src="http://www.youtube.com/embed/COXvP1lqH4Y" name="contenedor" width="375" height="210" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
          </table>
          <br />
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><div align="center" class="epigrafe Estilo19"><strong>2008 </strong></div>
                  <iframe src="http://www.youtube.com/embed/vWmXShIKrds?start=116&end=137" name="contenedor" width="375" height="210" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
              <td><div align="center" class="epigrafe Estilo19"><strong>2011 </strong></div>
                  <iframe src="http://www.youtube.com/embed/jfQbNV2ra_Y" name="contenedor" width="375" height="210" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
          </table>
          <br />
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="50%"><div align="center" class="epigrafe Estilo19"><strong>2016 </strong></div>
                  <iframe src="http://www.youtube.com/embed/F998R2EHiLo" name="contenedor" width="375" height="210" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
              <td width="50%">&nbsp;</td>
            </tr>
          </table>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha15-historial.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
