...
$cadena=file_get_contents('tc-fecha15-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTCf15.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tc-fecha15-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tc-fecha15-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tc-fecha15-noticias.php");
        }, 60000);
    });
</script> 
                  ...
                  <tr>
                    <td valign="top"><a href="javascript:;"><img src="up_noticias_transparente.jpg" width="314" height="22" border="0" id="up" onmouseover="MM_swapImage('up','','up_noticias.jpg',1)" onmouseout="MM_swapImgRestore()" /></a>
                        <div id="noticias" class="nota_fecha">
                          <?php
$cadena=file_get_contents('tc-fecha15-noticias.php');
echo $cadena;
?>
                        </div>
...
<div id="TT_thjArBYxt2jBd1DALArl323239nALEAlbd1d1cCIakD">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_thjArBYxt2jBd1DALArl323239nALEAlbd1d1cCIakD"></script></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/F998R2EHiLo" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('tc-fecha15-videos.php');
echo $cadena;
?>
                          </div>
                  ...
                  <tr>
                    <td valign="top"><div id="div" class="tv1-change">
                        <div id="actualizacion" class="news-tc">
                          <?php
$cadena=file_get_contents('onlineTCf15.php');
echo $cadena;
?>
                        </div>
                    </div>
              ...
              <tr>
                <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <div style="padding:4px"> 
                      ...
                      <a href="aptp-fecha11.php"><img src="boton fecha aptp.png" width="187" height="34" border="0" /></a><br /></div></td>
              </tr>
            </table>
			<table width="314" height="8" border="0" cellpadding="0" cellspacing="0" background="pie relatos.png">
              <tr>
