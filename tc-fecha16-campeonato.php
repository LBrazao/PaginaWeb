...
<script type="text/javascript">
  ...
  success: function() {
   ...
   $("#contenido").load("tc-campeonato.html");
};
function resultados() {
	...
	function fotos() {
			...
			$('#noticias').removeClass('boton_activo');
			$('#campeonato').removeClass('boton_activo');
            $("#contenido").load("tc-fecha16-fotos.html");
	};
	function videos() {
			$('#resultados').removeClass('boton_activo');
			$('#fotos').removeClass('boton_activo');
			...
			$('#noticias').removeClass('boton_activo');
			$('#campeonato').removeClass('boton_activo');
            $("#contenido").load("tc-fecha16-videos.html");
	};
	function noticias() {
			$('#resultados').removeClass('boton_activo');
			$('#fotos').removeClass('boton_activo');
			...
			$('#campeonato').removeClass('boton_activo');
            $("#contenido").load("tc-fecha16-noticias.html");
	};
	function campeonato() {
			$('#resultados').removeClass('boton_activo');
			$('#fotos').removeClass('boton_activo');
	  ...
	  <table id="encabezado_monitoreo" width="100%" border="0" cellspacing="0" cellpadding="5">
        <tr>
          ...
          <td id="campeonato" class="boton_activo" onclick="campeonato()" width="20%" align="center">CAMPEONATO</td>
        </tr>
      </table></td>
    </tr>
  </table>
  <table class="centro_de_monitoreo" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td>
