...
<body>
<span class="Estilo1">Clasificación General - <span class="Estilo6"> <u>FINALIZADO      </u></span> </span><br />
<table><tr><td><?php

$twit = file_get_contents('http://actc.org.ar/v3/carrera-on-line-resultados.ajax.php?intIDCarrera=460&intIDTanda=4');
...
$cadenaABuscar = str_replace('					115', '<img src="ppcev_fontana.png">',$cadenaABuscar);
...
$cadenaABuscar = str_replace('					95', '<img src="ppcev_alonso.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					91', '<img src="ppcev_campanera.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					88', '<img src="ppcev_echevarria.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					86', '<img src="ppcev_canapino.png">',$cadenaABuscar);
...
$cadenaABuscar = str_replace('					55', '<img src="ppcev_mangoni.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					45', '<img src="ppcev_dose.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					38', '<img src="ppcev_serrano.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					37', '<img src="ppcev_mazzacane.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					35', '<img src="ppcev_nolesi.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					31', '<img src="ppcev_gianini.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					29', '<img src="ppcev_nbonelli.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					27', '<img src="ppcev_altuna.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					24', '<img src="ppcev_spataro.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					23', '<img src="ppcev_ponte.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					20', '<img src="ppcev_okulovich.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					19', '<img src="ppcev_rodriguez.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					18', '<img src="ppcev_dipalma.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					15', '<img src="ppcev_moriatis.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					14', '<img src="ppcev_trosset.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					12', '<img src="ppcev_ponce.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					11', '<img src="ppcev_pernia.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					10', '<img src="ppcev_angelini.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					9', '<img src="ppcev_werner.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					8', '<img src="ppcev_trucco.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					7', '<img src="ppcev_martinez.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					6', '<img src="ppcev_ortelli.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					5', '<img src="ppcev_castellano.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					3', '<img src="ppcev_ardusso.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					2', '<img src="ppcev_ledesma.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('					1', '<img src="ppcev_rossi.png">',$cadenaABuscar);
$cadenaABuscar = str_replace('<th>N&uacute;mero</th>', '<th></th>',$cadenaABuscar);
$cadenaABuscar = str_replace('', '<br>',$cadenaABuscar);
