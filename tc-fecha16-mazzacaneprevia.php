...
<title>MAZZACANE SOBRE LAS CARRERAS ESPECIALES, REGLAMENTO ABIERTO Y M&Aacute;S | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">MAZZACANE SOBRE LAS CARRERAS ESPECIALES, REGLAMENTO ABIERTO Y M&Aacute;S </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">16 de Febrero de 2017 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA </span> </td>
              <td width="35%"><div align="right" class="Estilo15"></div></td>
            </tr>
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/LZSw1W4iMm4?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="134" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha16-mazzacaneprevia.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">El presidente de la ACTC y principal dirigente del Turismo Carretera, dio algunos datos previos horas antes de arrancar la temporada 2017. Entre ellos inform&oacute; las cuatro carreras especiales (Carrera del Mill&oacute;n, Cambio de neum&aacute;ticos en Olavarr&iacute;a, Largada por sorteo en Termas de R&iacute;o Hondo y 1000 kil&oacute;metros de Buenos Aires) sumado a la intenci&oacute;n de correr el s&aacute;bado por la noche en Villa Mercedes, San Luis.</span></p>
          <p><span class="Estilo11">Por otro lado destac&oacute; su postura de querer cerrar el reglamento aunque es consciente de que en caso de que alguna marca saliera perjudicada podr&iacute;an pagar un costo alto. Tambi&eacute;n habl&oacute; del cambio a seis neum&aacute;ticos nuevos por fin de semana y del cambio de horarios que va a tener la categor&iacute;a el d&iacute;a viernes. MIR&Aacute; EL VIDEO... </span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha16-mazzacaneprevia.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
