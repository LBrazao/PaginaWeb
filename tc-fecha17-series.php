...
<title>QUIR&Uacute;RJICO TRIPLETE DE LOS TORINO EN LAS SERIES, SANTERO LOGRA LA POLE CON UN ANDAR CASI PERFECTO | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">QUIR&Uacute;RJICO TRIPLETE DE LOS TORINO EN LAS SERIES, SANTERO LOGRA LA POLE CON UN ANDAR CASI PERFECTO </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/4nSMPaml2t0?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="514" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha17-series.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Los protagonistas luego de las series: Nicol&aacute;s Gonz&aacute;lez (ganador de la 1&ordm; serie), Juan Jos&eacute; Ebarl&iacute;n (ganador en pista de la 2&ordm; serie pero recargado con 4 puestos), Facundo Ardusso (ganador en la 2&ordm; serie tras la falsa largada de Ebarl&iacute;n) y Juli&aacute;n Santero (ganador de la 3&ordm; serie). </span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha17-series.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
