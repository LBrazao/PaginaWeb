...
<title>TROTTA: &quot;NOS VAMOS CON LAS MANOS VAC&Iacute;AS&quot; | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">TROTTA: &quot;NOS VAMOS CON LAS MANOS VAC&Iacute;AS&quot; </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><span class="Estilo11"><iframe src="http://www.youtube.com/embed/B0VgOs8fKXY?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="514" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha17-trottadomingo.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">&quot;A veces se equivoca uno, a veces otros. Raro que le haya pasado esto a Facundo, seguramente no le va a volver a pasar, es uno de los mejores pilotos. No me amarga que se haya equivocado sino que faltaba muy poco y trabajamos much&iacute;simo para terminar los coches y nos vamos con las manos vac&iacute;as. Creo que el auto de Facundo funcion&oacute; mejor que el de Emiliano y Facu se adapt&oacute; m&aacute;s r&aacute;pido a lo que es un Torino pero creeme que un auto funcionaba m&aacute;s r&aacute;pido que el otro, en este caso el de Facundo. Se trabajar&aacute; un poquito para ver d&oacute;nde es que estuvo y con la capacidad que tiene Emiliano no tengo dudas de que la carrera que viene o la otra va a estar peleando por la punta. Las tendencias de los dos autos eran parecidas, Emiliano no tuvo una buena clasificaci&oacute;n, eso lo condicion&oacute; y habr&aacute; que trabajar un poquito para enderezar las chapas e ir a Neuqu&eacute;n como lo hacemos siempre.</span></p>
          <p><span class="Estilo11"> Viedma es un circuito medio at&iacute;pico, de velocidades finales bajas, lo vi bien en general al Torino, igual hubo otras marcas que se acercaron mucho el fin de semana, como Ebarl&iacute;n que tuvo el adelantamiento de la serie, sino estaba para ganar. Los &uacute;ltimos tres a&ntilde;os que yo me acuerdo, Viedma es el circuito donde mejor funcionaron los Torino, no deber&iacute;a ser la excepci&oacute;n esta. Hay que esperar a circuitos m&aacute;s veloces y creo que ah&iacute; vamos a penalizar un poco.&quot;
          </span></p>
          <p><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-fecha17-trottadomingo.jpg" width="754" height="425" /></span></p>
          <div id="fb-root"></div>
