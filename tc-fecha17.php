...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="334"><table width="238" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">RÉCORD:</span> M. Rossi (1'30&quot;000) 
        <br />
...
$cadena=file_get_contents('tc-fecha17-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTCf17.php");
        }, 60000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tc-fecha17-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tc-fecha17-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tc-fecha17-noticias.php");
        }, 60000);
    });
</script> 
                  ...
                  <tr>
                    <td valign="top"><a href="javascript:;"><img src="up_noticias_transparente.jpg" width="314" height="22" border="0" id="up" onmouseover="MM_swapImage('up','','up_noticias.jpg',1)" onmouseout="MM_swapImgRestore()" /></a>
                        <div id="noticias" class="nota_fecha">
                          <?php
$cadena=file_get_contents('tc-fecha17-noticias.php');
echo $cadena;
?>
                        </div>
...
<div id="TT_RxtgrxdxtD1981DU1Ar1zkjED9lUTYYFLYEtksy5q1z">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RxtgrxdxtD1981DU1Ar1zkjED9lUTYYFLYEtksy5q1z"></script></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/P1I55-6dxJI" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('tc-fecha17-videos.php');
echo $cadena;
?>
                          </div>
              ...
              <td valign="top"><div id="mas_fotos" class="fotos">
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tc-fecha17-domingo.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="tc-fecha17-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tc-fecha17-domingo.php">Actividad del domingo </a></td>
                      </tr>
                    </table></td>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tc-fecha17-publico.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="tc-fecha17-publico.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tc-fecha17-publico.php">Las fotos del público </a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tc-fecha17-sabado.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="tc-fecha17-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tc-fecha17-sabado.php">Actividad del viernes y sábado </a></td>
                      </tr>
                    </table></td>
                  ...
                  <tr>
                    <td valign="top"><div id="div" class="tv1-change">
                        <div id="actualizacion" class="news-tc">
                          <?php
$cadena=file_get_contents('onlineTCf17.php');
echo $cadena;
?>
                        </div>
                    </div>
