...
<title>GR&Aacute;FICO COMPARATIVO DE PARCIALES: VIERNES  | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">GR&Aacute;FICO COMPARATIVO DE PARCIALES: VIERNES </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-fecha2-parcialesviernes.jpg" width="753" height="513" /></span></td>
            </tr>
            <tr>
          ...
          <p><span class="Estilo11">Luego de la primera clasificaci&oacute;n realizamos el cuadro comparativo con el rendimiento de cada piloto en los parciales. Las referencias son las siguientes:</span></p>
          <p><span class="Estilo11"><strong><span class="Estilo16">MAT&Iacute;AS ROSSI (ROJO)</span> <br />
                <span class="Estilo17">AGUST&Iacute;N CANAPINO (AZUL) </span><br />
  FACUNDO ARDUSSO (BLANCO) <br />
  <span class="Estilo19">NICOL&Aacute;S BONELLI (VERDE) </span><br />
  <span class="Estilo20">GUILLERMO ORTELLI (AMARILLO)</span></strong><span class="Estilo20">: </span></span></p>
          <p><span class="Estilo11">Para tener una peque&ntilde;a idea de c&oacute;mo es cada sector, a continuaci&oacute;n detallamos el mapa del circuito con la divisi&oacute;n de los parciales </span></p>
          <p><span class="Estilo11"><img src="circuito neuquen interactivo1.jpg" width="700" height="580" />&quot;</span><span class="Estilo11"></span></p>
          <p><span class="Estilo9">CONCLUSIONES</span></p>
          <p><span class="Estilo11"> Hay un punto en el cual todos coinciden, exceptuando por Agust&iacute;n Canapino, y es que les cuesta mucho en las rectas por un conjunto de factores relacionados con la carga aerodin&aacute;mica y la configuraci&oacute;n del motor.</span></p>
          <p><span class="Estilo11"><strong>Agust&iacute;n Canapino pr&aacute;cticamente no tiene puntos d&eacute;biles</strong>, sino m&aacute;s bien ha logrado encontrar un equilibrio muy bueno a lo largo de toda la vuelta, algo muy dif&iacute;cil de lograr en el Turismo Carretera. Esto le da una buena oportunidad para buscar la pole el d&iacute;a s&aacute;bado</span>.</p>
          <p><span class="Estilo11"><strong>Facundo Ardusso tiene un punto d&eacute;bil muy marcado</strong> en la segunda parte de la pista (&uacute;ltimos dos parciales). Puede ser un dato preocupante teniendo en cuenta a la carrera del domingo, debido a que <strong>casi la &uacute;nica zona de sobrepasos que tiene la pista, el 'Flaco' tiene una performance bastante mala</strong>, por lo que hoy en d&iacute;a (m&aacute;s all&aacute; del ritmo del auto) le costar&aacute; bastante . </span></p>
          <div id="fb-root"></div>
