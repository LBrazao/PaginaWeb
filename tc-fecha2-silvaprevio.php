...
<title>EL 'PATO' SILVA PREOCUPADO DE CARA A NEUQU&Eacute;N POR LA FALTA DE RENDIMIENTO LOS D&Iacute;AS S&Aacute;BADOS  | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">EL 'PATO' SILVA PREOCUPADO DE CARA A NEUQU&Eacute;N POR LA FALTA DE RENDIMIENTO LOS D&Iacute;AS S&Aacute;BADOS </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td><iframe src="http://www.youtube.com/embed/wV7HFQ4d0yk?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
                <br />
			  <div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha2-silvaprevio.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
            </tr>
          </table>
          <p><span class="Estilo11">
            Tanto en la &uacute;ltima carrera de Viedma como en las &uacute;ltimas carreras del 2015, el 'Pato' Silva no ha mostrado una especial contundencia en las clasificaciones, aspecto fundamental en el Turismo Carretera de hoy en d&iacute;a en donde los adelantamientos en carrera no son nada f&aacute;ciles. A&uacute;n m&aacute;s se le puede complicar al 'Pato' si el Catal&aacute;n Magni Motorsport no logra solucionar este inconveniente para la carrera de este fin de semana en Neuqu&eacute;n, ya que la suciedad de la pista hace que los sobrepasos sean casi imposibles por la baja adherencia fuera de la trayectoria ideal a causa de la tierra y el viento de esta zona geogr&aacute;fica. MIR&Aacute; EL VIDEO CON LA OPINION DEL PATO... </span></p>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha2-silvaprevio.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
<p>&nbsp;</p>
    </div></td>
  </tr>
</table>
