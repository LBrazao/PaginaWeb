...
<title>ANGELINI: &quot;MA&Ntilde;ANA DEPENDEREMOS MUCHO DE LA SUERTE DEL VIENTO&quot;  | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">ANGELINI: &quot;MA&Ntilde;ANA DEPENDEREMOS MUCHO DE LA SUERTE DEL VIENTO&quot; </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-fecha3-angeliniviernes.jpg" width="754" height="425" /></span></td>
            </tr>
            <tr>
              <td colspan="2"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2015/noticia-fecha.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false">
                <table width="535" height="44" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="155"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2015/tc-fecha3-angeliniviernes.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                  </tr>
                </table>
              </div></td>
            </tr>
          </table>
          <p><span class="Estilo11">&quot;Dimos un salto importante del entrenamiento y clasificacion. En todas las tandas a diferencia de otros circuitos a medida quedamos m&aacute;s vueltas mejoran los tiempos, y eso es porque la pista se va limpiando de la tierra y se va formando la huella. Se nota que el desgaste de los neum&aacute;ticos es menor, vamos a esperar a ma&ntilde;ana porque dependemos mucho de la suerte del viento en cada momento y de c&oacute;mo se va ensuciando la pista en cada grupo.&quot;</span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2015/tc-fecha3-angeliniviernes.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
