...
<title>LOS PILOTOS VIAJAN PARA CORRER EN LA PAMPA | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">LOS PILOTOS VIAJAN PARA CORRER EN LA PAMPA </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">24 de Marzo de 2016 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              <td width="35%"><div align="right" class="Estilo15">Por Lucas Barraza </div></td>
            </tr>
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-fecha2-dipalmaviernes.jpg" width="754" height="425" /></span></td>
            </tr>
            <tr>
          ...
          <p><span class="Estilo11">Solo quedan horas para que arranque un nuevo fin de semana de Turismo Carretera, en esta oportunidad en La Pampa. Muchos argentinos y extranjeros ya han llegado al circuito y otros est&aacute;n viajando para disfrutar del fin de semana.</span></p>
          <p><span class="Estilo11">Quienes tambi&eacute;n viajan por v&iacute;a terrestre son los pilotos. Ac&aacute; te traemos c&oacute;mo est&aacute;n viajando algunos de ellos para correr el fin de semana:</span></p>
          <p><span class="Estilo11"><img src="viaje_pernia.jpg" width="425" height="425" /><br />
          Leo Pern&iacute;a viaja con su jefe de prensa Rodolfo Speroni </span></p>
          <p><span class="Estilo11"><img src="viaje_giallombardo.jpg" width="756" height="425" /><br />
          Mauro Giallombardo junto a su padre y su novia en viaje a La Pampa </span></p>
          <p><span class="Estilo11"><img src="viaje_echevarria.jpg" width="375" height="500" /><br />
          Camilo Echevarr&iacute;a rumbo a La Pampa todav&iacute;a transitando la ciudad </span></p>
          <p><span class="Estilo11"><img src="viaje_dipalma.jpg" width="756" height="425" /><br />
          Josito Di Palma como es costumbre manejando el semirremolque </span></p>
          <p><span class="Estilo11"><img src="viaje_urcera.jpg" width="425" height="425" /><br />
          Con un poco pasados de brillo, Manu Urcera viaja junto a Ricardo Gliemmo y amigos </span></p>
          <p><span class="Estilo11"><img src="viaje_rossi.jpg" width="425" height="425" /><br />
          Por su lado Rossi entrena antes de ir a correr el fin de semana </span></p>
          <p><span class="Estilo11"><img src="viaje_canapino.jpg" width="413" height="550" /><br />
          Canapino se despide de Buenos Aires en un asado con el Jet Racing</span></p>
          <p><img src="viaje_santero.jpg" width="756" height="425" /><br />
            <span class="Estilo11">Mientras que Juli&aacute;n Santero se despide de Mendoza comiendo con  amigos  </span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
