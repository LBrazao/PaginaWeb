...
<body>
<span class="Estilo1">2º Prueba comunitaria - <SPAN style="color:#FF0000; text-decoration:underline">FINALIZADO  </SPAN>                       </span><br />
<table><tr><td><?php

$twit = file_get_contents('http://actc.org.ar/v3/carrera-on-line-resultados.ajax.php?intIDCarrera=509&intIDTanda=41');
...
$cadenaABuscar = str_replace('					25', '<img src="ppcev_moriatis.png">',$cadenaABuscar);
