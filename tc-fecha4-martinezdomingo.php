...
<title>OMAR MART&Iacute;NEZ EXCLU&Iacute;DO POR VERIFICACI&Oacute;N T&Eacute;CNICA | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">OMAR MART&Iacute;NEZ EXCLU&Iacute;DO POR VERIFICACI&Oacute;N T&Eacute;CNICA </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="DSC02729.jpg" width="754" height="425" /></span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha4-martinezdomingo.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Luego de la final ganada por Mat&iacute;as Rossi en Concordia, se comenz&oacute; a realizar la tan nombrada verificaci&oacute;n t&eacute;cnica posterior a la carrera. All&iacute; se encerraron los coches de Gianini (Ford), Nicol&aacute;s y Pr&oacute;spero Bonelli (Ford), Rossi (Chevrolet), Ortelli (Chevrolet), Trucco (Dodge), Silva (Ford), Fontana (Torino) y Mart&iacute;nez (Ford). Este &uacute;ltimo fue revisado a fondo al igual que el resto, sin embargo all&iacute; encontraron que la cilindrada no era la permitida, sino que estaba excedida en 100cc (la m&aacute;xima es de 3200cc y estaba en 3300cc)</span></p>
          <p><span class="Estilo11">Lamentablemente a partir de esta noticia volver&aacute;n las especulaciones &iquest;Desde qu&eacute; carrera Mart&iacute;nez corre con el motor fuera de reglamento?.</span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha4-martinezdomingo.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
