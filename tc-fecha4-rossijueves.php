...
<title>ROSSI (1&ordm;): &quot;VOLVIMOS A TENER EL MOTOR DE LAS PRIMERAS CARRERAS&quot;  | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">ROSSI (1&ordm;): &quot;VOLVIMOS A TENER EL MOTOR DE LAS PRIMERAS CARRERAS&quot; </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/oXCIhrnBupU?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha4-rossijueves.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">&quot;Probamos muchas cosas gruesas del auto, ma&ntilde;ana iremos a lo finito pero hoyu pudimos sacar provecho y zafamos que el clima aguant&oacute; muy bien.</span> <span class="Estilo11">Mejor&oacute; el auto, se not&oacute; y por eso hemos andado bien. Venimos de una carrera en donde anduvimos muy bien si tenemos en cuenta c&oacute;mo funcionaba el motor, en La Pampa no funcionaba bien porque ten&iacute;amos un problema de potencia y sin embargo clasificamos entre los 7. Hoy hemos vuelto a tener el motor de las primeras carreras y sumado a que hemos dado un salto de calidad vamos muy r&aacute;pido pero para ver el resultado definitivo hay que esperar al domingo.</span></p>
          <p><span class="Estilo11">Probamos cosas nuevas especialmente en el tren delantero. En mi caso estaba muy bien el auto con neum&aacute;ticos nuevos (en La Pampa) pero cuando perd&iacute;a el grip de la goma comenz&aacute;bamos a ir de trompa por eso hoy nos focalizamos en trabajar en eso y hemos avanzado un poco. Eso va a quedar en el auto y va a ser una mejora en todas las pistas .</span><span class="Estilo11">&quot;</span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha4-rossijueves.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
