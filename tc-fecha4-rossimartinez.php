...
<title>EXPLOT&Oacute; ROSSI LUEGO DEL DESCUBRIMIENTO EN EL MOTOR DE MART&Iacute;NEZ | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">EXPLOT&Oacute; ROSSI LUEGO DEL DESCUBRIMIENTO EN EL MOTOR DE MART&Iacute;NEZ </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-fecha4-rossimartinez.jpg" width="754" height="425" /></span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha4-rossimartinez.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">El 'Misil' de Del Viso se llev&oacute; la victoria este &uacute;ltimo fin de semana en Concordia con descompensaci&oacute;n inclu&iacute;da. Sin embargo su victoria pareci&oacute; quedar opacada por la grave falta que se descubri&oacute; en el motor de Omar Mart&iacute;nez durante la verificaci&oacute;n t&eacute;cnica posterior a la carrera.</span></p>
          <p><span class="Estilo11">Muchos se han visto desilucionados, otros muy enojados y nunca faltan aquellos que se ponen felices por estas noticias tan lamentables. Uno de los que pareciera haberse puesto muy furioso fue el mismo Mat&iacute;as quien al enterarse de esta noticia no escatim&oacute; con sus palabras como &eacute;s habitual en &eacute;l. </span></p>
          <p><span class="Estilo11"><span class="Estilo19">&quot;Considero que es una falta grav&iacute;sima y una tomada de pelo lo que hicieron. No es un detalle menor&quot;</span>, afirm&oacute; Rossi.<span class="Estilo19"> &quot;Espero se tomen medidas necesarias para educar y el que la quiera hacer la piense dos veces. Digo p&uacute;blicamente en una reuni&oacute;n donde estuvimos varios pilotos inclu&iacute;do el 'Gur&iacute;' y comisi&oacute;n directiva de la ACTC el d&iacute;a s&aacute;bado. Mano dura para tener un automovilismo m&aacute;s sano.&quot;</span></span></p>
          <p><span class="Estilo11">Por &uacute;ltimo trajo a colaci&oacute;n hechos de a&ntilde;os anteriores cuando el ex presidente Oscar Avent&iacute;n lo atac&oacute; por haber pedido lo mismo que hoy:  <span class="Estilo19">&quot;Ya lo ped&iacute; una vez por alguien que no est&aacute; m&aacute;s en la categor&iacute;a y me com&iacute; una carta documento, quiero un automovilismo donde ganen los mejores y sano&quot;</span>, concluy&oacute; el Misil. </span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha4-rossimartinez.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
