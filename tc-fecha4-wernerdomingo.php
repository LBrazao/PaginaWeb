...
<title>UNA PINCHADURA QUE ARRUIN&Oacute; EL FIN DE SEMANA DE WERNER | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">UNA PINCHADURA QUE ARRUIN&Oacute; EL FIN DE SEMANA DE WERNER </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/C_8uS6SLPCU?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
          ...
          <p><span class="Estilo11">&quot;Ven&iacute;amos muy bien en lo que fue la serie, presionando a Agust&iacute;n (Canapino) y se pinch&oacute; un neum&aacute;tico en la vuelta 2 o 3. La verdad que era dif&iacute;ci lsaber cu&aacute;nto pod&iacute;amos aguantar porque hab&iacute;amos pasado 2 o 3 autos nada m&aacute;s y si entr&aacute;bamos pod&iacute;amos perder directamente todas las posiciones, as&iacute; que lamentablemente con el correr de la vueltas se fue desinflando cada vez m&aacute;s y estaba en esa incomodidad. Quer&iacute;amos sumar la mayor cantidad de puntos y aguantar pero hicimos hasta donde pudimos.</span></p>
          <p><span class="Estilo11">&Iacute;bamos much&iacute;simo de cola, por supuesto que sumado al calor te hace trabajar m&aacute;s e hice lo que se pod&iacute;a, no pod&iacute;a hacer demasiado porque giraba entre 3 y 4 segundos m&aacute;s lento que la punta pero tambi&eacute;n al entrar a boxes &iacute;bamos a asumir un riesgo importante e &iacute;bamos a quedar en el pelot&oacute;n de atr&aacute;s es complicado por eso esper&aacute;bamos que no se desinfle tanto y aguantar algunas vueltas m&aacute;s.</span></p>
          <p><span class="Estilo11">Demostramos que el auto estaba competitivo como para ir para adelante, peleamos con Canapino en la serie, busqu&eacute; en dos ocasiones los sobrepasos y estuvimos muy cerca aunque no se dio pero est&aacute;bamos firmes.</span></p>
          <p><span class="Estilo11">Con las pruebas comunitarias del jueves creo que nos vamos conformes para lo que se viene aunque ahora tenemos que chequear y analizar todo m&aacute;s profundamente en los pr&oacute;ximos d&iacute;as. Por su puesto que cada circuito tiene una puesta a punto especial y trabajaremos para tener el mejor auto</span><span class="Estilo11">&quot;</span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
