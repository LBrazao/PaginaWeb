...
<title>Balance de Giallombardo tras recuperar 20 posiciones | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">BALANCE DE GIALLOMBARDO EN CONCEPCI&Oacute;N TRAS RECUPERAR 20 POSICIONES </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td height="19"><span style="color:#666666">2 de Junio de 2015 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              </tr>
            <tr>
              <td><iframe src="http://www.youtube.com/embed/-8JVV28ASXI" name="contenedor" width="750" height="422" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
          </table> 
      ...
      <tr>
        <td height="908" valign="top" bgcolor="#F4F4F4"><div align="center">
          <table width="100%" height="66" border="0" cellpadding="4" cellspacing="0">
            <tr>
              <td width="29%">&nbsp;</td>
              <td width="71%" valign="top"><a href="index.php"><img src="volver.png" width="168" height="58" border="0" /> </a>
                  <table width="120" class="pedido">
                    <tr>
                      <td align="right"><a style="color:#FFFFFF" href="index.php">VOLVER A LA FECHA</a></td>
                    </tr>
                </table></td>
            </tr>
          </table>
