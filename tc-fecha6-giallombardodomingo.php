...
<title>EL MOMENTO EN EL QUE GIALLOMBARDO SUFRE LOS PROBLEMAS DE LA CAJA DE VELOCIDADES  | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">EL MOMENTO EN EL QUE GIALLOMBARDO SUFRE LOS PROBLEMAS DE LA CAJA DE VELOCIDADES </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">22 de Junio de 2015 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              <td width="35%"><div align="right" class="Estilo15">Por Lucas Barraza </div></td>
            </tr>
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/U929BqnUTSo" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2">
                <table width="535" height="44" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="155"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2015/tc-fecha6-giallombardodomingo.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                  </tr>
                </table>
              </td>
            </tr>
          </table>
          <p><span class="Estilo11">Giallombardo larg&oacute; desde la pole pero fue el &uacute;ltimo en recibir la bandera a cuadros luego de quedarse sin dos cambios en la caja de velocidades durante la primera vuelta. El piloto de Ford lleg&oacute; con un dolor muy fuerte en el brazo luego de correr 25 vueltas con estas dificultades. </span><span class="Estilo11"></span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2015/tc-fecha6-giallombardodomingo.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
