...
<title>VUELVEN LOS 1370 METROS DE RECTA: LETALES PARA ALGUNOS Y ALIVIO PARA OTROS | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">VUELVEN LOS 1370 METROS DE RECTA: LETALES PARA ALGUNOS Y  ALIVIO PARA OTROS </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-fecha6-recta.jpg" width="754" height="425" /></span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha6-recta.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Luego de tres a&ntilde;os vuelve al calendario del TC la segunda recta m&aacute;s larga que utiliza la categor&iacute;a en el presente. La &uacute;ltima oportunidad que el Turismo Carretera utiliz&oacute; este trazado fue en 2013 donde  Mauro Giallombardo obtuvo su &uacute;ltima victoria hasta el d&iacute;a de hoy a bordo del Ford n&uacute;mero 1 en aquel momento.</span></p>
          <p><span class="Estilo11">Si bien desde abajo del auto puede parecer un sector m&aacute;s de la pista, desde arriba muchos lo padecen y sufren vuelta tras vuelta debido a que es el lugar m&aacute;s claro de adelantamientos antes de llegar al fuerte frenaje de la horquilla. Los que m&aacute;s van a verse perjudicados en este circuito (que se transitar&aacute; en la carrera del domingo) ser&aacute;n los Torino, los cuales siempre han sufrido la falta de velocidad final por su forma aerodin&aacute;mica, la cual hace que pasados los 240 km/h el coche pierda mucho avance y sea fundamental tomar una succi&oacute;n para lograr una ventaja y e intentar un adelantamiento o defenderse del rival.</span></p>
          <p><span class="Estilo11">Tanto viernes como s&aacute;bado la mayor&iacute;a de los pilotos optar&aacute;n por una carga aerodin&aacute;mica mayor a la del domingo debido a que se utilizar&aacute; la zona mixta que se utiliza en las carreras habituales.</span></p>
          <p><span class="Estilo11">A continuaci&oacute;n te mostramos el top 3 de las rectas m&aacute;s largas que utiliza el Turismo Carretera en la actualidad .</span></p>
          <p><span class="Estilo11"><strong>LA PAMPA: </strong>1540 metros<br />
              <strong>TERMAS DE R&Iacute;O HONDO:</strong> 1370 metros.<br />
            <strong>RAFAELA (CON CHICANAS): </strong>1150 metros
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha6-recta.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
