...
<title>ORTELLI: &quot;HOY SOMOS LOS M&Aacute;S REGULARES PERO TENEMOS QUE GANAR&quot; | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">ORTELLI: &quot;HOY SOMOS LOS M&Aacute;S REGULARES PERO TENEMOS QUE GANAR&quot; </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/9RnDn0kkVGE?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha7-ortelliprevia.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Parece ser de com&uacute;n opini&oacute;n que el puntero del campeonato Guillermo Ortelli hoy tiene el auto m&aacute;s regular, sin embargo &eacute;l afirma que todav&iacute;a no tienen la mejor performance del parque del TC. Este fin de semana el s&eacute;xtuple tendr&aacute; el desf&iacute;o de mantener la punta pero principalmente de comenzar a pensar en ganar, ya que todav&iacute;a no ha logrado la victoria que le da el boleto para pelear su s&eacute;ptimo t&iacute;tulo.</span></p>
          <p><span class="Estilo11">Tanto &eacute;l como el resto de los Chevrolet arrancar&aacute;n el fin de semana con una peque&ntilde;a brecha con respecto a los Ford, quienes tendr&aacute;n una leve ventaja al poder contar con una pista que les permite exprimir al m&aacute;ximo su tradicional aceleraci&oacute;n destacada. MIR&Aacute; EL VIDEO...</span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha7-ortelliprevia.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
