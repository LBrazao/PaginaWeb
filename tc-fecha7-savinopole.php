...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">EL HISTORIAL NO LO BENEFICIA: LAS &Uacute;LTIMAS DOS VECES QUE SAVINO LARG&Oacute; EN PRIMERA FILA </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/d7n3t-E2B8w?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
          ...
          <p><span class="Estilo11">Es la primera vez que Jos&eacute; Savino se lleva una pole position en el Turismo Carretera, sin embargo no es la primera vez que largar&aacute; en primera fila...</span></p>
          <p><span class="Estilo11">Promediando la temporada 2013 el Nacho tuvo un subid&oacute;n de rendimiento importante y fue as&iacute; como en la fecha 4 de Mendoza y la fecha 6 de Termas de R&iacute;o Hondo (carrera sin cargas aerodin&aacute;micas) el piloto de Ford larg&oacute; en primera fila de la 2&ordm; y 3&ordm; serie respectivamente. No le fue nada bien, ya que en ambas largaba con el campe&oacute;n vigente Mauro Giallombardo a la par y termin&oacute; relegado en el pelot&oacute;n por no tener buenas largadas.</span></p>
          <p><span class="Estilo11">Han pasado 3 a&ntilde;os, en su momento Savino demostr&oacute; no poder controlar al 100% los nervios de una largada &iquest;Lo podr&aacute; hacer bien esta vez?</span></p>
          <p>
            <iframe src="http://www.youtube.com/embed/cWfV372Ng1M" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
