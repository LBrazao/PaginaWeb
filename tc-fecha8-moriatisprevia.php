...
<title>MORIATIS: &quot;SI VA TODO BIEN SE PODR&Iacute;A HABLAR DE INCORPORARNOS EL A&Ntilde;O QUE VIENE AL EQUIPO DEL GUR&Iacute;&quot; | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">MORIATIS: &quot;SI VA TODO BIEN SE PODR&Iacute;A HABLAR DE INCORPORARNOS EL A&Ntilde;O QUE VIENE AL EQUIPO DEL GUR&Iacute;&quot; </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td height="19"><span style="color:#666666">7 de Junio de 2016 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              </tr>
            <tr>
              <td><iframe src="http://www.youtube.com/embed/dfIac0UvKEI?rel=0&autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
                <br />
			  <div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha6-moriatisprevia.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
            </tr>
          </table>
          <p><span class="Estilo11">
            &quot;Es un poco para trabajar en nuestro auto, pararlo y poder hacerle las cosas que haya que hacerle porque las &uacute;ltimas carreras anduvimos un poco mal. En Olavarr&iacute;a rompimos una parte de atr&aacute;s y rompi&oacute; mucho y en la &uacute;ltima carrera anduvimos mal entonces hay que revisarlo todo, hacerlo todo nuevo y estaba la posibilidad de subirse al auto del 'Gur&iacute;' y a su vez nos sirve para comparar el auto de &eacute;l andando bien contra el nuestro a ver d&oacute;nde est&aacute; la diferencia&quot;.</span></p>
          <p><span class="Estilo11"> &quot;No me genera ninguna sensaci&oacute;n, es otro auto para compararlo con el nuestro para ver si perdemos traccionando, en velocidad de curva o acelerando. Es una buena oportunidad para ver que le falta a nuestro auto. Hoy en d&iacute;a est&aacute; todo tan parejo que no s&eacute; si hay plus o no en Posadas para Ford pero es un circuito que a la marca le ha ido bien as&iacute; que esperemos andar bien. Hay que evaluarlo (sumarse al equipo del Gur&iacute; para 2017), estas dos carreras nos van a servir de mucho para ver c&oacute;mo me siento en el equipo y c&oacute;mo va el auto, y si va todo bien tranquilamente se podr&iacute;a hablar para el a&ntilde;o que viene.. </span></p>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha6-moriatisprevia.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
<p>&nbsp;</p>
    </div></td>
  </tr>
</table>
