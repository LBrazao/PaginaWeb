...
$cadena=file_get_contents('tc-fecha8-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTCf8.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tc-fecha8-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tc-fecha8-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tc-fecha8-noticias.php");
        }, 60000);
    });
</script> 
<div style="margin-left:5px;">
      ...
      <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
        ...
        <tr>
          <td valign="top"><div id="tv1" class="tv1">
              <div id="actualizacion" class="news-tc">
                <?php
$cadena=file_get_contents('onlineTCf8.php');
echo $cadena;
?>
              </div>
          </div>
              <div align="center" id="tv2" class="tv2">
		 <iframe width="307" height="200" src="http://www.youtube.com/embed/dIq4X45YMkc?rel=0&amp;autoplay=1" scrolling="no" frameborder="0" style="border: 0px none transparent;">    </iframe>
		      </div></td>
        </tr>
      </table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/zi4-t5wKVN8" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td></td>
                              ...
                              <?php
$cadena=file_get_contents('tc-fecha8-videos.php');
echo $cadena;
?>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tc-fecha8-sabado.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="tc-fecha8-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tc-fecha8-sabado.php">Actividad del sábado </a></td>
                      </tr>
                    </table></td>
          ...
          <td width="320" valign="top"><table width="314" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              <td><li class="cabezacronicas"><span class="textoenvivo">NOTICIAS</span></li>         
                <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                  <tr>
                    <td></td>
                  </tr>
                  ...
                  <tr>
                    <td valign="top"><a href="javascript:;"><img src="up_noticias_transparente.jpg" width="314" height="22" border="0" id="up" onmouseover="MM_swapImage('up','','up_noticias.jpg',1)" onmouseout="MM_swapImgRestore()" /></a>
                        <div id="noticias" class="nota_fecha">
                          <?php
$cadena=file_get_contents('tc-fecha8-noticias.php');
echo $cadena;
?>
                        </div>
			...
			<table width="314" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <div style="padding:4px"> <a href="tcpista-fecha8.php"><img src="boton fecha tc pista.png" width="187" height="34" border="0" /></a><br />
