...
<title>DOS MOTORES ROTOS EN DOS VUELTAS &iquest;QU&Eacute; PAS&Oacute;? | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">DOS MOTORES ROTOS EN TRES VUELTAS &iquest;QU&Eacute; PAS&Oacute;? </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">1 de Agosto de 2015 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              <td width="35%"><div align="right" class="Estilo15">Por Lucas Barraza </div></td>
            </tr>
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-fecha9-echevarriasabado.jpg" width="754" height="425" /></span></td>
            </tr>
            <tr>
              <td colspan="2">
                <table width="535" height="44" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="155"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2015/tc-fecha9-echevarriasabado.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                  </tr>
                </table>
              </td>
            </tr>
          </table>
          <p><span class="Estilo11">Camilo Echevarr&iacute;a ha tenido un lamentable debut con los motores de Pablo Satriano quien ha comenzado a atender sus motores a partir de este fin de semana. El neuquino rompi&oacute; el primero motor ayer en el entrenamiento sin haber podido cerrar una vuelta r&aacute;pida. Esto desemboc&oacute; en que no pudiera clasificar por la tarde.</span></p>
          <p><span class="Estilo11">Hoy por la ma&ntilde;ana el Dole Racing instal&oacute; el segundo motor en el Torino para salir al segundo entrenamiento, sin embargo Camilo solo pudo cerrar una vuelta lenta y al salir por segunda vez de los boxes el motor se volvi&oacute; a romper: <span class="Estilo16">&quot;No pudimos probar nada ni redondear ninguna vuelta en los entrenamientos. En los dos motores tuvimos problemas en la tapa de cilindros y eso es  un factor ajeno al motorista ya que no podemos tocar esa parte. Incluso el motor hab&iacute;a mejorado mucho para esta carrera pero no se pudo mostrar ya que no llegamos a cambiar el motor a tiempo para clasificar&quot;</span>, se&ntilde;al&oacute; Camilo.</span></p>
          <p><span class="Estilo11">A diferencia de que su compa&ntilde;ero de equipo y reci&eacute;n ascendido del TC Pista Mauricio Lambiris haya tenido un excelente debut en la categor&iacute;a, Echevarr&iacute;a pr&aacute;cticamente con el mismo coche y en el mismo equipo no ha podido lograr lo mismo: <span class="Estilo16">&quot;Hasta ahora tuvimos un solo resultado que fue un octavo puesto y despu&eacute;s tuvimos errores t&eacute;cnicos, mec&aacute;nicos y falta de potencia en el motor que nos jug&oacute; en contra todas las carreras&quot;</span>, conclu&iacute;a y decepcionado Echevarr&iacute;a que tendr&aacute; que largar la primera serie en &uacute;ltima posici&oacute;n. </span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2015/tc-fecha9-echevarriasabado.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
