  ...
  <tr>
    <td valign="top"><div style="padding:8px;">
      <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
          <tr>
            <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="../tc-fecha16-final.jpg" width="233" height="136" border="0"/><br />
                    <div class="playfoto"><a href="../tc-fecha16-final.php" onmouseover="changefoto1(), MM_swapImage('camara1','','camara.png',1)"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" onmouseout="changefotosalir()"/></a></div>
            </div></td>
            <td width="348"><div style="padding:4px;"><a href="../tc-fecha16-final.php" class="titulofotos">Final en Buenos Aires </a><br />
                <a href="../tc-fecha16-final.php" class="subtitulofotos">VER FOTOS &gt;&gt;</a></div></td>
          </tr>
        </table>
        <br />
        <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
          <tr>
            <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="../tc-fecha16-series.jpg" width="233" height="136" border="0"/><br />
                    <div class="playfoto"><a href="../tc-fecha16-series.php" onmouseover="changefoto1(), MM_swapImage('camara1','','camara.png',1)"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" onmouseout="changefotosalir()"/></a></div>
            </div></td>
            <td width="348"><div style="padding:4px;"><a href="../tc-fecha16-series.php" class="titulofotos">Series en Buenos Aires </a><br />
                <a href="../tc-fecha16-series.php" class="subtitulofotos">VER FOTOS &gt;&gt;</a></div></td>
          </tr>
        </table>
        <br />
        <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
          <tr>
            <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="../tc-fecha16-sabado.jpg" width="233" height="136" border="0"/><br />
                    <div class="playfoto"><a href="../tc-fecha16-sabado.php" onmouseover="changefoto1(), MM_swapImage('camara1','','camara.png',1)"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" onmouseout="changefotosalir()"/></a></div>
            </div></td>
            <td width="348"><div style="padding:4px;"><a href="../tc-fecha16-sabado.php" class="titulofotos">S&aacute;bado en Buenos Aires </a><br />
                <a href="../tc-fecha16-sabado.php" class="subtitulofotos">VER FOTOS &gt;&gt;</a></div></td>
          </tr>
        </table>
        <br />
        <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
          <tr>
            <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="../tc-fecha16-viernes.jpg" width="233" height="136" border="0"/><br />
                    <div class="playfoto"><a href="../tc-fecha16-viernes.php" onmouseover="changefoto1(), MM_swapImage('camara1','','camara.png',1)"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" onmouseout="changefotosalir()"/></a></div>
            </div></td>
            <td width="348"><div style="padding:4px;"><a href="../tc-fecha16-viernes.php" class="titulofotos">Viernes en Buenos Aires </a><br />
                <a href="../tc-fecha16-viernes.php" class="subtitulofotos">VER FOTOS &gt;&gt;</a></div></td>
          </tr>
        </table>
    </div></td>
  </tr>
