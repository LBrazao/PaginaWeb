          ...
          <tr>
            <td valign="top"><table width="571" height="180" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
				  ...
				  <ul class="menuenvivo">
						  <li><a href="tc-fecha15.php">Resultados</a></li>
						  <li><a class="alternativo1" href="tc-fecha15.php#fotos">Fotos</a></li>
						  <li><a class="alternativo2" href="tc-fecha15.php#videos">Videos</a></li>
						  <li><a class="alternativo3" href="tc-posiciones.php">Campeonato</a></li>
						  <li><a class="alternativo4" style="border-right:1px solid #999999;" href="tc-fecha15.php">Más</a></li>
				    </ul>	</td>
                </tr>
            </table></td>
          </tr>
    ...
    <td width="777" valign="top"><table width="777" border="0" cellspacing="0" cellpadding="0">
      <tr>
                  ...
                  <td valign="top" style="padding:5px;"><table width="498" height="402" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="249" height="161" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tc-fecha14-domingo.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="tc-fecha14-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tc-fecha14-domingo.php">Trelew - Domingo </a></td>
                        </tr>
                      </table>
                      </td>
                      <td width="249" height="161" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tc-fecha14-sabado.jpg" width="233" height="136" border="0"/><br />
                                    <div class="playfoto"><a href="tc-fecha14-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                            </div></td>
                          </tr>
                          <tr>
                            <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tc-fecha14-sabado.php">Trelew - Viernes y Sábado </a></td>
                          </tr>
                        </table></td>
                    </tr>
                      <tr>
                        <td height="161" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tc-fecha13-domingo.jpg" width="233" height="136" border="0"/><br />
                                      <div class="playfoto"><a href="tc-fecha13-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                              </div></td>
                            </tr>
                            <tr>
                              <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tc-fecha13-domingo.php">La Pampa - Domingo </a></td>
                            </tr>
                          </table></td>
                        <td height="161" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tc-fecha13-sabado.jpg" width="233" height="136" border="0"/><br />
                                    <div class="playfoto"><a href="tc-fecha13-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                            </div></td>
                          </tr>
                          <tr>
                            <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tc-fecha13-sabado.php">La Pampa - Viernes y Sábado </a></td>
                          </tr>
                        </table></td>
                      </tr>
                    </table>
        ...
        <td width="269" valign="top"><table width="265" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            <td><li class="cabezafechas"><a class="textoenvivovinculos" href="tc-posiciones.php">COPA DE ORO  </a></li>
                        ...
                        <td valign="top"><table width="265" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="257" height="45" border="0" align="center" cellpadding="0" cellspacing="0" class="tablacalendario">
                              <tr>
                                ...
                                <td width="61%" height="15"><img src="banderita argentina.JPG" width="20" height="13" /> Guillermo Ortelli </td>
                                <td width="26%" height="15"><div align="center">212.5</div></td>
                              </tr>
                              <tr>
                                <td height="15">2.</td>
                                <td height="15"><img src="banderita argentina.JPG" width="20" height="13" /> Matías Rossi </td>
                                <td height="15"><div align="center">210.5</div></td>
                              </tr>
                              <tr>
                                <td height="15">3.</td>
                                <td height="15"><img src="banderita argentina.JPG" width="20" height="13" /> Mariano Werner </td>
                        ...
                        <td valign="top"><table width="265" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="257" height="270" class="tablafechas" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <td width="71%" height="18"><a class="Estilo8" href="tc-fecha1.php">VIEDMA</a></td>
                                <td width="13%" height="18"><div align="center" class="Estilo4"><a href="tc-fecha1.php"><img src="play.png" width="18" height="18" border="0" /></a></div></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td height="18"><a class="Estilo8" href="tc-fecha5.php">OLAVARRÍA</a></td>
                                <td height="18"><div align="center" class="Estilo4"><a href="tc-fecha5.php"><img src="play.png" width="18" height="18" border="0" /></a></div></td>
                              </tr>
                              <tr>
                                <td height="18"><div align="center"><span class="Estilo4">22.5</span></div></td>
                                <td height="18"><a class="Estilo8" href="tc-fecha6.php">TERMAS DE RÍO HONDO </a></td>
                                <td height="18"><div align="center" class="Estilo4"><a href="tc-fecha6.php"><img src="play.png" width="18" height="18" border="0" /></a></div></td>
                              </tr>
                              <tr>
                                <td height="18"><div align="center"><span class="Estilo4">12.6</span></div></td>
                                <td height="18"><a class="Estilo8" href="tc-fecha7.php">POSADAS</a></td>
                                <td height="18"><div align="center" class="Estilo4"><a href="tc-fecha7.php"><img src="play.png" width="18" height="18" border="0" /></a></div></td>
                              </tr>
                              <tr>
                                <td height="18"><div align="center"><span class="Estilo4">26.6</span></div></td>
                                <td height="18"><a class="Estilo8" href="tc-fecha8.php">CONCEPCIÓN DEL URUGUAY </a></td>
                                <td height="18"><div align="center" class="Estilo4"><a href="tc-fecha8.php"><img src="play.png" width="18" height="18" border="0" /></a></div></td>
                              </tr>
                              <tr>
                                <td height="18"><div align="center"><span class="Estilo4">14.8</span></div></td>
                                <td height="18"><a class="Estilo8" href="tc-fecha9.php">RAFAELA</a></td>
                                <td height="18"><div align="center" class="Estilo4"><a href="tc-fecha9.php"><img src="play.png" width="18" height="18" border="0" /></a></div></td>
                              </tr>
                              <tr>
                                <td height="18"><div align="center"><span class="Estilo4">28.8</span></div></td>
                                <td height="18"><a class="Estilo8" href="tc-fecha10.php">PARANÁ</a></td>
                                <td height="18"><div align="center" class="Estilo4"><a href="tc-fecha10.php"><img src="play.png" width="18" height="18" border="0" /></a></div></td>
                              </tr>
                              <tr>
                                <td height="18"><div align="center"><span class="Estilo4">11.9</span></div></td>
                                <td height="18"><a class="Estilo8" href="tc-fecha11.php">SAN LUIS </a></td>
                                <td height="18"><div align="center" class="Estilo4"><a href="tc-fecha11.php"><img src="play.png" width="18" height="18" border="0" /></a></div></td>
                              </tr>
                              <tr>
                                <td height="18"><div align="center"><span class="Estilo4">02.10</span></div></td>
                                <td height="18"><a class="Estilo8" href="tc-fecha12.php">CONCEPCIÓN DEL URUGUAY </a></td>
                                <td height="18"><div align="center" class="Estilo4"><a href="tc-fecha12.php"><img src="play.png" width="18" height="18" border="0" /></a></div></td>
                              </tr>
                              <tr>
                                <td height="18"><div align="center"><span class="Estilo4">30.10</span></div></td>
                                <td height="18"><a class="Estilo8" href="tc-fecha13.php">LA PAMPA </a></td>
                                <td height="18"><div align="center" class="Estilo4"><a href="tc-fecha13.php"><img src="play.png" width="18" height="18" border="0" /></a></div></td>
                              </tr>
                              <tr>
                                <td height="18"><div align="center"><span class="Estilo4">13.11</span></div></td>
                                <td height="18"><a class="Estilo8" href="tc-fecha14.php">TRELEW</a></td>
                                <td height="18"><div align="center" class="Estilo4"><a href="tc-fecha14.php"><img src="play.png" width="18" height="18" border="0" /></a></div></td>
                              </tr>
                              <tr>
                                <td height="18"><div align="center"><span class="Estilo4">04.12</span></div></td>
                                <td height="18"><a class="Estilo8" href="tc-fecha15.php">LA PLATA </a></td>
                                <td height="18"><div align="center" class="Estilo4"><a href="tc-fecha15.php"><img src="play.png" width="18" height="18" border="0" /></a></div></td>
                              </tr>
                          </table></td>
                      </tr>
                  </table>
                ...
                <table width="775" height="322" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                  <tr>
                    <td style="padding:10px;" width="520" align="center" valign="top"><table width="508" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><iframe src="http://www.youtube.com/embed/LHfgL2P8tNw" name="contenedor" width="520" height="292" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                        </tr>
                        <tr>
                          <td></td>
                        </tr>
                    ...
                    <td width="242"><div style="height:292px; overflow:auto; margin-top:10px">
                      <table height="150" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top"><div align="center"><img src="https://i1.ytimg.com/vi/yil4Oi31YGg/mqdefault.jpg" width="194" height="109" border="0" class="imagenvideo" /></div>
                              <div class="playvideo"><a target="contenedor" onclick="ponervideo3()" href="http://www.youtube.com/embed/yil4Oi31YGg?rel=0&amp;autoplay=1"><img src="playvideos.png" name="botonvideo3" width="194" height="109" border="0" id="botonvideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" /></a></div>
                            <a target="contenedor" id="textovideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" class="imagenvideo_btn" href="http://www.youtube.com/embed/yil4Oi31YGg?rel=0&amp;autoplay=1">Hugo Cuervo sobre el Gurí </a></td>
                        </tr>
                      </table>
                      <table height="150" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top"><div align="center"><img src="https://i1.ytimg.com/vi/YyVngJYn9yE/mqdefault.jpg" width="194" height="109" border="0" class="imagenvideo" /></div>
                              <div class="playvideo"><a target="contenedor" onclick="ponervideo3()" href="http://www.youtube.com/embed/YyVngJYn9yE?rel=0&amp;autoplay=1"><img src="playvideos.png" name="botonvideo3" width="194" height="109" border="0" id="botonvideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" /></a></div>
                            <a target="contenedor" id="textovideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" class="imagenvideo_btn" href="http://www.youtube.com/embed/YyVngJYn9yE?rel=0&amp;autoplay=1">¿Quién es más probable? </a></td>
                        </tr>
                      </table>
                      <table height="150" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top"><div align="center"><img src="https://i1.ytimg.com/vi/0lTXGQtHJto/mqdefault.jpg" width="194" height="109" border="0" class="imagenvideo" /></div>
                              <div class="playvideo"><a target="contenedor" onclick="ponervideo3()" href="http://www.youtube.com/embed/0lTXGQtHJto?rel=0&amp;autoplay=1"><img src="playvideos.png" name="botonvideo3" width="194" height="109" border="0" id="botonvideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" /></a></div>
                            <a target="contenedor" id="textovideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" class="imagenvideo_btn" href="http://www.youtube.com/embed/0lTXGQtHJto?rel=0&amp;autoplay=1">Mazzacane sobre el 'Gurí' </a></td>
                        </tr>
                      </table>
                      <table height="150" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top"><div align="center"><img src="https://i1.ytimg.com/vi/LHfgL2P8tNw/mqdefault.jpg" width="194" height="109" border="0" class="imagenvideo" /></div>
                              <div class="playvideo"><a target="contenedor" onclick="ponervideo3()" href="http://www.youtube.com/embed/LHfgL2P8tNw?rel=0&amp;autoplay=1"><img src="playvideos.png" name="botonvideo3" width="194" height="109" border="0" id="botonvideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" /></a></div>
                            <a target="contenedor" id="textovideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" class="imagenvideo_btn" href="http://www.youtube.com/embed/LHfgL2P8tNw?rel=0&amp;autoplay=1">¿Quién es más probable? </a></td>
                        </tr>
                      </table>
                      <table height="150" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top"><div align="center"><img src="https://i1.ytimg.com/vi/0VlvdF4ZvgU/mqdefault.jpg" width="194" height="109" border="0" class="imagenvideo" /></div>
                              <div class="playvideo"><a target="contenedor" onclick="ponervideo3()" href="http://www.youtube.com/embed/0VlvdF4ZvgU?rel=0&amp;autoplay=1"><img src="playvideos.png" name="botonvideo3" width="194" height="109" border="0" id="botonvideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" /></a></div>
                            <a target="contenedor" id="textovideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" class="imagenvideo_btn" href="http://www.youtube.com/embed/0VlvdF4ZvgU?rel=0&amp;autoplay=1">Di Palma sobre el 'Gurí' </a></td>
                        </tr>
                      </table>
                      <table height="150" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top"><div align="center"><img src="https://i1.ytimg.com/vi/soZ68KUoGgA/mqdefault.jpg" width="194" height="109" border="0" class="imagenvideo" /></div>
                              <div class="playvideo"><a target="contenedor" onclick="ponervideo3()" href="http://www.youtube.com/embed/soZ68KUoGgA?rel=0&amp;autoplay=1"><img src="playvideos.png" name="botonvideo3" width="194" height="109" border="0" id="botonvideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" /></a></div>
                            <a target="contenedor" id="textovideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" class="imagenvideo_btn" href="http://www.youtube.com/embed/soZ68KUoGgA?rel=0&amp;autoplay=1">Final del TC en Concordia </a></td>
                        </tr>
                      </table>
                      <table height="150" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top"><div align="center"><img src="https://i1.ytimg.com/vi/wcA0OknQySI/mqdefault.jpg" width="194" height="109" border="0" class="imagenvideo" /></div>
                              <div class="playvideo"><a target="contenedor" onclick="ponervideo3()" href="http://www.youtube.com/embed/wcA0OknQySI?rel=0&amp;autoplay=1"><img src="playvideos.png" name="botonvideo3" width="194" height="109" border="0" id="botonvideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" /></a></div>
                            <a target="contenedor" id="textovideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" class="imagenvideo_btn" href="http://www.youtube.com/embed/wcA0OknQySI?rel=0&amp;autoplay=1">Rossi tras descompensarse </a></td>
                        </tr>
                      </table>
                      <table height="150" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top"><div align="center"><img src="https://i1.ytimg.com/vi/AiNmw8CMgn4/mqdefault.jpg" width="194" height="109" border="0" class="imagenvideo" /></div>
                              <div class="playvideo"><a target="contenedor" onclick="ponervideo3()" href="http://www.youtube.com/embed/AiNmw8CMgn4?rel=0&amp;autoplay=1"><img src="playvideos.png" name="botonvideo3" width="194" height="109" border="0" id="botonvideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" /></a></div>
                            <a target="contenedor" id="textovideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" class="imagenvideo_btn" href="http://www.youtube.com/embed/oXCIhrnBupU?rel=0&amp;autoplay=1">Ortelli otra vez segundo </a></td>
                        </tr>
                      </table>
                      <table height="150" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top"><div align="center"><img src="https://i1.ytimg.com/vi/51wYZXvG7HA/mqdefault.jpg" width="194" height="109" border="0" class="imagenvideo" /></div>
                              <div class="playvideo"><a target="contenedor" onclick="ponervideo3()" href="http://www.youtube.com/embed/51wYZXvG7HA?rel=0&amp;autoplay=1"><img src="playvideos.png" name="botonvideo3" width="194" height="109" border="0" id="botonvideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" /></a></div>
                            <a target="contenedor" id="textovideo3" onmouseover="changeview3()" onmouseout="changeviewsalir()" class="imagenvideo_btn" href="http://www.youtube.com/embed/51wYZXvG7HA?rel=0&amp;autoplay=1">Trucco vuelve al podio </a></td>
                        </tr>
                      </table>
                      <table height="150" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
