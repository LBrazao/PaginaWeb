...
<title>TC: EL GOBIERNO URUGUAYO DIO EL 'OK' PARA COLABORAR CON EL CALLEJERO DE MONTEVIDEO | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">EL GOBIERNO URUGUAYO DIO EL 'OK' PARA COLABORAR CON EL CALLEJERO DE MONTEVIDEO </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td height="19"><span style="color:#666666">27 de Enero de 2016 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              </tr>
            <tr>
              <td><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-lambiris-callejero1.jpg" width="754" height="425" /></span><br />
			  <div class="fb-like" data-href="http://www.tclarevista.com.ar/2015/tc-lambiris-callejero.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
            </tr>
          </table>
          <p><span class="Estilo11">
            Las negociaciones y avances para realizar el Callejero de Montevideo con el Turismo Carretera son cada vez m&aacute;s concretas. En las &uacute;ltimas horas Mauricio Lambiris confirm&oacute; en TC La Revista por AM 890 que el Gobierno Uruguayo ha decidido aprobar el proyecto, las obras y aportar el dinero que corresponda para la  realizaci&oacute;n de dicho evento.</span></p>
          <p><span class="Estilo11">Para que le mismo se pueda concretar, se planean romper algunos sectores de bulevares y veredas con otros trabajos de reasfaltado y chicana m&oacute;vil. Esta es la gran inc&oacute;gnita, ya que la carrera se estableci&oacute; para el mes de mayo, sin embargo cinco meses parece ser poco tiempo para preparar todo este evento y realizar las modificaciones correspondientes, por lo que la fecha podr&iacute;a moverse para m&aacute;s adelante. </span></p>
          <span class="Estilo11"><img style="border:#999999 1px solid" src="tc-lambiris-callejero2.jpg" width="754" height="425" /><br />
          <span class="Estilo14"><strong>Sector de largada (Avenida Juan Cach&oacute;n) </strong></span></span>
          <p><span class="Estilo11">ESCUCH&Aacute; LA NOTA CON MAURICIO LAMBIRIS:<br /><iframe id='audio_10219736' frameborder='0' allowfullscreen='' scrolling='no' height='200' style='border:1px solid #EEE; box-sizing:border-box; width:100%;' src="https://www.ivoox.com/player_ej_10219736_4_1.html?c1=ff6600"></iframe>
</span></p>
          <span class="Estilo11">DATE UNA VUELTA AL CALLEJERO DE MONTEVIDEO:  </span>
          <iframe src="http://www.youtube.com/embed/hh8FPHNl7PY" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2015/tc-lambiris-callejero.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
<p>&nbsp;</p>
    </div></td>
  </tr>
</table>
