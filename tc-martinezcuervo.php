...
<title>HUGO CUERVO DISPAR&Oacute; SOBRE LA FALTA T&Eacute;CNICA | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">HUGO CUERVO SOBRE LA FALTA DEL GUR&Iacute;: &quot;ES EL CASO M&Aacute;S GRAVE QUE SE CONOCE EN LA HISTORIA DEL TC&quot; </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td height="19"><span style="color:#666666">25 de Abril de 2016 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              </tr>
            <tr>
              <td><iframe src="http://www.youtube.com/embed/yil4Oi31YGg?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
                <br />
			  <div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-martinezcuervo.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
            </tr>
          </table>
          <p><span class="Estilo11">La mayor&iacute;a de pilotos ha emitido su opini&oacute;n acerca del caso Omar Mart&iacute;nez, sin embargo ahora se sum&oacute; el escribano Hugo Cuervo, propietario del Lincoln Sport group (actualmente en Top Race).</span></p>
          <p><span class="Estilo11">Cuervo afirm&oacute; que se trata del hecho m&aacute;s grave  que se conoce en la historia del TC y explica por qu&eacute; no tiene ninguna duda de que fue algo premeditado. Adem&aacute;s se extra&ntilde;&oacute; de que la ACTC no haya emitido siquiera una sanci&oacute;n provisoria y pronostica que en caso de no dar una sanci&oacute;n ejemplar, ellos se ver&aacute;n m&aacute;s manchados de lo que lo est&aacute;n hoy en d&iacute;a. MIR&Aacute; EL VIDEO... </span></p>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-martinezcuervo.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
<p>&nbsp;</p>
    </div></td>
  </tr>
</table>
