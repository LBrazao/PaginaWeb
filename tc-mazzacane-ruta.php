...
<title>Mazzacane ve peligroso volver a correr en las rutas | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">MAZZACANE: &quot;SI A ALGUIEN LE PASA ALGO EN UNA CARRERA EN RUTA,  DEJO DE SER EL PRESIDENTE Y LA ACTC PUEDE QUEBRAR&quot; </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td height="19"><span style="color:#666666">15 de Marzo de 2016 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA </span> </td>
              </tr>
            <tr>
              <td><iframe src="http://www.youtube.com/embed/Zcg3EwE8K7w?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
                <br />
			  <div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-mazzacane-ruta.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
            </tr>
          </table>
          <p><span class="Estilo11">
            Uno de los pedidos m&aacute;s requeridos por parte del p&uacute;blico en los &uacute;ltimos a&ntilde;os ha sido tener al menos una carrera al a&ntilde;o en las rutas de la Rep&uacute;blica Argentina. Para poder realizar este tipo de evento con la m&aacute;xima seguridad tanto para pilotos como para espectadores, se deben hacer inversiones millonarias, algo que la ACTC hoy en d&iacute;a no puede hacer.</span></p>
          <p><span class="Estilo11">Sin embargo muchos no han tenido en cuenta esta medida y han pretendido que a&uacute;n as&iacute; el Turismo Carretera vuelva a correr en las rutas aunque no tenga las medidas de seguridad necesarias para evitar los accidentes que pueden llegar a producirse hoy en d&iacute;a.</span></p>
          <p><span class="Estilo11">A todo esto se conoci&oacute; un pensamiento m&aacute;s &iacute;ntimo del presidente de la ACTC Hugo Mazzacane,  quien ya hab&iacute;a hecho un breve comentario al respecto de este tema, pero que ahora parece haber hablado 'sin casette'.<span class="Estilo12"> &quot;Si a alguien le pasa algo en una carrera de ruta, dejo de ser el presidente y la ACTC puede quebrar&quot;</span>, le dijo Mazzacane a Ricardo G&aacute;lvez, hijo de Juan G&aacute;lvez luego de tener una charla &iacute;ntima sobre algunos temas. MIR&Aacute; EL VIDEO... </span></p>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-mazzacane-ruta.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
<p>&nbsp;</p>
    </div></td>
  </tr>
</table>
