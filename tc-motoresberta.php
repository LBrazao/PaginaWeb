...
<title>ORESTE BERTA CONFESANDO ALGUNOS ERRORES DE FABRICACI&Oacute;N Y CONFIRMANDO QUE ALGUNAS ROTURAS PUEDEN HABER SIDO POR BUSCAR EL L&Iacute;MITE DE LOS MOTORES | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">ORESTE BERTA CONFIESA  ERRORES DE FABRICACI&Oacute;N Y CONFIRMA QUE ALGUNAS ROTURAS PUEDEN DEBERSE A EXCESOS DE LOS MOTORISTAS </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">16 de Marzo de 2016 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              <td width="35%"><div align="right" class="Estilo15">Por Lucas Barraza </div></td>
            </tr>
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/bHvv5qIET0s?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="134" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-motoresberta.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Oreste Berta ya no es m&aacute;s el encargado de hacer el 'service' a cada uno de los motores del Turismo Carretera luego de haber recibido esta decisi&oacute;n por parte de la ACTC. Sin embargo a&uacute;n contin&uacute;a entregando distintos elementos a la categor&iacute;a y que directamente los motoristas sean los mismos que hagan el mantenimiento de cada uno de sus motores.</span></p>
          <p><span class="Estilo11">El arranque de la temporada ha tra&iacute;do una observaci&oacute;n bastante importante luego de la rotura de los 12 motores en la primera fecha y cuatro en la segunda. Si bien se hizo un progreso y esfuerzo bastante importante desde Viedma hasta Neuqu&eacute;n, a&uacute;n quedan varios puntos por solucionar.</span></p>
          <p><span class="Estilo11">Al respecto, Oreste Berta confes&oacute; que los proveedores de resortes de v&aacute;lvulas que tiene la ACTC no los fabricaron correctamente a partir de la segunda partida de elementos que enviaron el a&ntilde;o pasado y por eso tuvieron tantas roturas por este elemento. Adem&aacute;s reafirm&oacute; con total seguridad que algunos de los motores rotos podr&iacute;an haber colapsado debido a que los motoristas se pasaron de la tolerancia que soportan los elementos, a pesar de que algunos lo nieguen:<span class="Estilo16"> &quot;Puede pasar porque son las reglas del juego&quot;</span>, dijo Berta. MIR&Aacute; LA ENTREVISTA... </span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-motoresberta.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
