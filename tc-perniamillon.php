...
<title>PERN&Iacute;A ARREMETI&Oacute; CONTRA LOS PILOTOS QUE ESPECULAN | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">PERN&Iacute;A: &quot;LOS QUE DICEN QUE SALEN A TODO O NADA EN EL MILL&Oacute;N, AHORA NO EST&Aacute;N DEJANDO TODO&quot;  </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td height="19"><span style="color:#666666">9 de Marzo de 2016 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              </tr>
            <tr>
              <td><iframe src="http://www.youtube.com/embed/OHB-6cHIFKU?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
                <br />
			  <div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-perniamillon.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
            </tr>
          </table>
          <p><span class="Estilo11">
            Una de las carreras m&aacute;s comentadas ha sido la carrera del mill&oacute;n a disputarse en Rafaela, en donde el ganador de la carrera ser&aacute; acreedor de un mill&oacute;n de pesos. Sin dudas este premio lo ha implementado la ACTC con el objetivo de que la lucha por la punta sea m&aacute;s aguerrida que nunca.</span></p>
          <p><span class="Estilo11">Sin embargo Leonel Pern&iacute;a sali&oacute; a la arremetida contra algunos pilotos que afirmaron que en esta carrera saldr&aacute;n a buscar la victoria cueste lo que cueste. El tandilense afirm&oacute; que esos pilotos no est&aacute;n dejando todo en las carreras actuales. </span></p>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-perniamillon.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
<p>&nbsp;</p>
    </div></td>
  </tr>
</table>
