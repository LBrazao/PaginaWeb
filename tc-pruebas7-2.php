...
<title>TC: LA PRETEMPORADA VA TOMANDO TEMPERATURA | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">LA PRETEMPORADA VA TOMANDO TEMPERATURA </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td height="19"><span style="color:#666666">7 de Febrero de 2017 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO CARRETERA</span> </td>
              </tr>
            <tr>
              <td><span class="Estilo11"><img style="border:#999999 1px solid" src="tc-pruebas7-2.jpg" width="754" height="425" /></span><br />
			  <div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/noticia.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
            </tr>
          </table>
          <p><span class="Estilo11">
            La cuenta regresiva para el arranque del campeonato est&aacute; cada vez m&aacute;s cerca del cero. Por eso los equipos no pierden el tiempo para intentar desarrollar a la m&aacute;xima capacidad los coches y as&iacute;  tener un correcto funcionamiento y el mejor rendimiento posible a la hora de la primer puesta en pista. </span></p>
          <p><span class="Estilo11">La pasada semana Jonatan Castellano inaugur&oacute; la sesi&oacute;n dando varias vueltas en el trazado de Olavarr&iacute;a. El d&iacute;a de hoy se encuentran <strong>Facundo Ardusso (Torino-Renault) y Agust&iacute;n Canapino (Chevrolet) </strong>para comenzar a ponerse a punto. Por el lado del piloto de Las Parejas ser&aacute; el encargado de sacar a rugir por primera vez el Torino del Equipo Renault, mientras que el de Arrecifes continuar&aacute; con el mismo Chevrolet que el a&ntilde;o pasado le entreg&oacute; el puesto 6 del 2016. </span></p>
          <span class="Estilo11"><img style="border:#999999 1px solid" src="tc-pruebas7-2a.jpg" width="754" height="512" /></span>
