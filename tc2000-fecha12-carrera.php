...
$twit = file_get_contents('http://www.tc2000.com.ar/carreras.php?accion=tiempos&id=236');

$inicio = strpos($twit, 'Carrera Final&nbsp;</h5>');

$final = strpos($twit, '&nbsp;<a href="tiempos_y_datos_items.php?id_evento=1530&id_carrera=236" class="celeste">- Ver tiempos</a><br />');
$cadenaABuscar = substr($twit, $inicio, ($final - $inicio));
$cadenaABuscar = str_replace('Carrera Final&nbsp;</h5>', '',$cadenaABuscar);
...
$cadenaABuscar = str_replace('<td>Fiat&nbsp;Línea</td>', '<td><img height="35" title="Fiat&nbsp;Linea" src="/2016/logos/fiat.png" border="0"></td>',$cadenaABuscar);
...
$cadenaABuscar = str_replace('<td>Honda&nbsp;Civic</td>', '<td><img height="35" title="Honda&nbsp;Civic" src="/2016/logos/honda.png" border="0"></td>',$cadenaABuscar);
