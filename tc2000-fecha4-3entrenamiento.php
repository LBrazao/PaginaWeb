...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="532"><span style="font-family:Arial, Helvetica, sans-serif" class="Estilo9 Estilo1 Estilo7"><strong><i>3º Entrenamiento  </i>           </strong></span><span class="Estilo6"> - <u>FINALIZADO</u></span></td>
  </tr>
</table> 
...
$twit = file_get_contents('http://tc2000.com.ar/tiempos_y_datos_items.php?id_evento=1375&id_carrera=216');
...
$cadenaABuscar = str_replace('<td width="91">Vueltas', '<td width="60">Vueltas',$cadenaABuscar);
...
$twit = file_get_contents('http://tc2000.com.ar/tiempos_y_datos_items.php?id_evento=1360&id_carrera=215');
