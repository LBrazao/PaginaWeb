...
<title>VIDEO: EL ESCALOFRIANTE MOMENTO QUE SEBASTI&Aacute;N REYNOSO SE PRENDE FUEGO Y LOGRA SALIR DEL AUTO  | TC La Revista</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">La Plata <br />
        ...
        <div class="subtitle">FECHA 2 | TC MOURAS </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">EXTENSI&Oacute;N:</span> 4265 metros </div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">EL ESCALOFRIANTE MOMENTO QUE SEBASTI&Aacute;N REYNOSO SE PRENDE FUEGO Y LOGRA SALIR DEL AUTO </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">28 de Febrero de 2015 |</span> <span style="color:#DD0005; font-weight:bold">TC MOURAS</span> </td>
              <td width="35%"><div align="right" class="Estilo15"></div></td>
            </tr>
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/YG9BmWM71Ko?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="134" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tcm-fecha2-reynoso.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Una vez m&aacute;s el fuego fue protagonista de un escalofriante accidente en las carreras. En esta oportunidad el Ford de Sebasti&aacute;n Reynoso en la segunda fecha del TC Mouras en La Plata, parecer&iacute;a haber tenido una fuga de combustible dentro del habit&aacute;culo de la cual deriv&oacute; una enorme llama que cubri&oacute; todo el interior del coche y al mismo piloto.</span></p>
          <p><span class="Estilo11">Como sucedi&oacute; en el incidente de Mauro Giallombardo en diciembre, el piloto pudo salir r&aacute;pidamente del coche, pero a diferencia de aquella ocasi&oacute;n sali&oacute; ileso por tener el 100% de su indumentaria in&iacute;fuga en perfecto estado y casi nueva. </span><span class="Estilo11"></span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tcm-fecha2-reynoso.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
