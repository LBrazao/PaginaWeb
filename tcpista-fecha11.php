...
<title>TC Pista en San Luis | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
  ...
  <tr>
    ...
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">RÉCORD:</span> J. Urcera (1'31&quot;390) <br />
...
$cadena=file_get_contents('tcpista-fecha11-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTCPf11.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tcpista-fecha11-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tcpista-fecha11-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tcpista-fecha11-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTCPf11.php');
echo $cadena;
?>
          </div></div>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/cVZ31fJ143E" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td></td>
                              ...
                              <?php
$cadena=file_get_contents('tcpista-fecha11-videos.php');
echo $cadena;
?>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="/2015/tcpista-fecha12-viernes.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="/2015/tcpista-fecha12-viernes.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="/2015/tcpista-fecha12-viernes.php">La última carrera en San Luis </a></td>
                        </tr>
                    </table></td>
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    ...
                                    <span class="Verdanachico">&quot;Nuestro auto viene funcionando bien en las últimas carreras y  San Luis es un circuito que en particular me gusta mucho y donde ya hemos ganado, por lo cual intentaremos apoyarnos en toda esta inercia de resultados positivos que traemos y que siempre ayunan anímicamente, y así aprovechar el momento en el que venimos. Llegamos pulidos y preparados para hacerle frente a una instancia que comienza a ser decisiva con un buen control en el auto y una mejora en el motor que nos deja confiados para tener un gran fin de semana, y así iniciar con todo la Copa de Plata&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
