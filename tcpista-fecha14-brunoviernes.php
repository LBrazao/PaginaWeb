...
<title>1&ordm; ENTRENAMIENTO: LAS REFLEXIONES DE JUAN MART&Iacute;N BRUNO (1&ordm;) LUEGO DE UN ENTRENAMIENTO CON PISTA COMPLICADA | TC La Revista</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="654"><div class="titlecategoria">Trelew <br />
    </div>
    ...
    <td width="336"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">R&Eacute;CORD:</span> J. Urcera (1'20&quot;064) <br />
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">1&ordm; ENTRENAMIENTO: LAS REFLEXIONES DE JUAN MART&Iacute;N BRUNO (1&ordm;) LUEGO DE UN ENTRENAMIENTO CON PISTA COMPLICADA </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">11 de Noviembre de 2016 |</span> <span style="color:#DD0005; font-weight:bold">TC PISTA </span> </td>
              <td width="35%"><div align="right" class="Estilo15"></div></td>
            </tr>
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/LWJEITk-f9A?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="514" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="190"><a href="tcpista-fecha14.php" class="buttons_propierties"> <img src="boton noticias.png" border="0" width="190" height="38" />
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tcpista-fecha14-brunoviernes.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tcpista-fecha14-brunoviernes.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
