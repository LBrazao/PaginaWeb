...
<title>TC Pista en Trelew | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="654"><div class="titlecategoria">La Plata <br />
    </div>
    ...
    <td width="336"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">RÉCORD:</span> C. Echevarría (1'27&quot;097)  <br />
...
$cadena=file_get_contents('tcpista-fecha15-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTCPf15.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tcpista-fecha15-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tcpista-fecha15-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tcpista-fecha15-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTCPf15.php');
echo $cadena;
?>
          </div></div>
		  <div align="center" id="tv2" class="tv2">
		  <iframe width="314" height="200" src="http://www.youtube.com/embed/ckuxQkM59U4?rel=0&amp;autoplay=1" scrolling="no" frameborder="0" style="border: 0px none transparent;">    </iframe>
		  </div>
	  ...
	  <table width="314" height="120" border="0" cellpadding="0" cellspacing="0" background="fondo clima.jpg" style="margin-left:5px">
        <tr>
          <td><!-- www.TuTiempo.net - Ancho:312px - Alto:120px -->
              <div id="TT_vxngbxYhYQtBnMvKLfwEzkjED9uKL4K2LtEY1ZCIqkj">Pronóstico de Tutiempo.net</div>
            <script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vxngbxYhYQtBnMvKLfwEzkjED9uKL4K2LtEY1ZCIqkj"></script></td>
        </tr>
      </table></td>
  </tr>
</table>
			...
			<table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/JgO9KS96yDU" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('tcpista-fecha15-videos.php');
echo $cadena;
?>
                          </div>
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    ...
                                    <span class="Verdanachico">&quot;Llegamos a La Plata bien perfilados porque venimos teniendo un gran funcionamiento del auto, si bien no se pudo terminar de plasmar en las últimas carreras por distintas situaciones. Para esta fecha vamos a ir con algunos cambios importantes en el setup buscando ser rápidos en clasificación y teniendo un auto mas cargado. Trataremos de iniciar el fin de semana con el pie derecho. Sabemos que las chances matemáticas dan y las posibilidades pueden estar con un poco de suerte. Iremos por un gran resultado, y el campeonato lo vamos a pelear hasta último momento&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"> <a href="tc-fecha15.php"><img src="boton fecha tc.png" width="187" height="34" border="0" /></a><br />
                                ...
                                <a href="aptp-fecha11.php"><img src="boton fecha aptp.png" width="187" height="34" border="0" /></a><br />
                          </div></td>
                      </tr>
                  </table>
