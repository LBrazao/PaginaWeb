...
<title>TC Pista en Neuquén | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
  ...
  <tr>
    ...
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">VUELTAS:</span> N. Dianda (1'30&quot;464) <br />
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/pjpIINsthAA" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                ...
                <td valign="top" style="padding:5px;"><table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="/2015/tcpista-fecha3-series.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="/2015/tcpista-fecha3-final.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="/2015/tcpista-fecha3-final.php">Las fotos de la última en Neuquén </a></td>
                        </tr>
                      </table></td>
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    ...
                                    <span class="Verdanachico">&quot;Neuquén es un circuito un poco mas rápido en relación a Viedma, pero tendríamos que ser protagonistas nuevamente y funcionar bien. No se hicieron mayores modificaciones en el auto que se mostró competitivo en la fecha pasada, y vamos en búsqueda de otro buen resultado, sabiendo que hemos tenido ya parciales positivos allí. Tenemos la confianza de saber que tanto el auto como el motor están funcionando bien, por lo cual vamos por buenos puntos nuevamente&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
