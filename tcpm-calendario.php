...
<title>TC Pista Mouras | Calendario</title>
...
body {
	...
	background-image: url(fondotcpm.jpg);
...
?>
<?php
$carga=file_get_contents('cabezatcpm.html');
echo $carga;
?>
    ...
    <td valign="top"><div style="padding:8px;">
      <table class="tablacalendar" width="636" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="184"><span class="titulodepie">7 de Febrero </span></td>
          <td width="310"><a href="tcpm-fecha1.php"><span class="titulodepie Estilo3"><strong>Mar de Aj&oacute; </strong></span></a></td>
          <td width="78"><div align="center"><a href="tcpm-fecha1.php"><img src="play calendario.png" width="35" height="35" border="0" /></a></div></td>
        </tr>
        <tr>
          <td><div align="center" class="titulodepie"><span class="Estilo2">2.</span></div></td>
          <td><span class="titulodepie">28 de Febrero </span></td>
        ...
        <tr>
          ...
          <td><span class="titulodepie">20 de Marzo </span></td>
          <td><span class="titulodepie"><strong>A confirmar </strong></span></td>
          <td><div align="center"><img src="play calendario inactivo.png" alt="a" width="35" height="35" /></div></td>
        </tr>
        <tr>
