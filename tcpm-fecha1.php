...
<title>TC Pista Mouras en Mar de Ajó | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Mar de Ajó <br />
    </div>
        <div class="subtitle">FECHA 1 | TC PISTA MOURAS </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">RÉCORD:</span> M. Vivot (1'41&quot;141) <br />
                    <span style="font-weight:bold">EXTENSI&Oacute;N:</span> 4695 metros </div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
$cadena=file_get_contents('tcpm-fecha15-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTCPMf15.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tcpm-fecha15-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tcpm-fecha15-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tcpm-fecha15-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTCPMf15.php');
echo $cadena;
?>
          </div></div>
	  ...
	  <table width="314" height="120" border="0" cellpadding="0" cellspacing="0" background="fondo clima.jpg" style="margin-left:5px">
        <tr>
          <td><!-- www.TuTiempo.net - Ancho:312px - Alto:120px -->
              <div id="TT_vBnArhYhYQKcn16KLfwEzEz1z9aKM4nlrYEdEcyIqkj"><a href="http://www.tutiempo.net">Tu tiempo</a></div>
            <script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vBnArhYhYQKcn16KLfwEzEz1z9aKM4nlrYEdEcyIqkj"></script></td>
        </tr>
      </table></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/zS_QN3J5W0I" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                    ...
                    <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tcm-fecha1-carrera.jpg" width="233" height="136" border="0"/><br />
                                      <div class="playfoto"><a href="tcm-fecha1-carrera.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                              </div></td>
                            </tr>
                            <tr>
                              <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tcm-fecha1-carrera.php">Las fotos de la última en Mar de Ajó </a></td>
                            </tr>
                        </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Agustín De Brabandere (Previo) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="debrabandere.jpg" width="120" height="155" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Decidimos continuar en la categoría un año más porque creemos que es lo más lógico, principalmente por un tema presupuestario y segundo porque si bien tuvimos un buen año, creo que uno más nos va a venir bien tanto a mí en lo personal como al equipo. Me veo confiado esperando el arranque de la actividad. Mar de Ajo es un circuito que ya conozco y que no me va a llevar tiempo adaptarme. Esperemos que el auto funcione bien desde el principio y así poder trabajar firme en la puesta a punto.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
              ...
              <table width="265" height="211" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div style="padding:4px"> <a href="tcm-fecha15.php"><img src="boton fecha tcm.png" width="187" height="34" border="0" /></a><br />
                            <a href="/2016/fe-fecha14.php"><img src="boton fecha fe.png" width="187" height="34" border="0" /></a> </div></td>
                      </tr>
                  </table>
