...
<title>TC Mouras en La Plata | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('tcpm-fecha2-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
      ...
      <table width="314" height="38" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
        <tr>
          <td><table width="305" height="31" border="1" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="150" class="tv-coments" onclick="putcoments()" bordercolor="#FFFFFF" background="boton resultados.jpg"><div class="botonresultados" align="center">VER COMENTARIOS </div></td>
              <td>&nbsp;</td>
              <td width="150" class="tv-coments" onclick="puttv()" bordercolor="#FFFFFF" background="boton resultados.jpg"><div class="botonresultados" align="center">VER TV </div></td>
            </tr>
          </table></td>
        </tr>
      </table>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTCPMf2.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tcpm-fecha2-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tcpm-fecha2-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tcpm-fecha2-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTCPMf2.php');
echo $cadena;
?>
          </div></div>
            ...
            <table width="309" height="37" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="151" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:4px">
                  <tr>
                    <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasnoticias" href="tcpm-posiciones.php">CAMPEONATO</a></li></td>
                  </tr>
                </table></td>
                <td><table width="151" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:4px">
                  <tr>
                    <td background="boton mas videos.jpg"><li class="masvideos"><a class="textomasnoticias" href="tcpm-calendario.php">CARRERAS</a></li></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
...
<div id="TT_RitgrhtxdaD98MDULfwlo2I2otuUTYUFbd1tkcioakj"><a href="http://www.tutiempo.net">El tiempo 15 días</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RitgrhtxdaD98MDULfwlo2I2otuUTYUFbd1tkcioakj"></script></td>
  </tr>
</table>
              ...
              <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/A4Lj6-G9XBU" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('tcpm-fecha2-videos.php');
echo $cadena;
?>
                            </div>
                  ...
                  <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tcpm-fecha2-carrera.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="tcpm-fecha2-carrera.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tcpm-fecha2-carrera.php">TC Pista Mouras - Final </a></td>
                        </tr>
                      </table></td>
                      <td height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tcpm-fecha2-sabado.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="tcpm-fecha2-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tcpm-fecha2-sabado.php">TC Pista Mouras - Sábado</a></td>
                        </tr>
                      </table></td>
                    </tr>
                  </table>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Juan Carlos Bava </span></td>
                                    ...
                                    <table width="49" height="23" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="49"><table width="46" height="19" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFF00">
                                            <tr>
                                              <td><div align="center" class="Estilo126">114</div></td>
                                            </tr>
                                        </table></td>
                                      </tr>
                                    </table>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="bava.jpg" width="120" height="140" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Es un circuito que se complica para los sobrepasos y eso nos benefició pero igualmente tuvimos un coche y un conjunto muy bueno.<br />
                                    Por un lado asusta arrancar el año de esta manera pero es muy alentador. Vamos a apostar a ganar la etapa regular más allá de que a partir de ahora se va a complicar por los kilos que tendremos que agregar al Chevrolet.<br />
                                    Venía con una tendencia de trompa muy grande y eso me obligó a exigir mucho el coche: había hecho una diferencia grande y cuando entró el pace car comencé a insultar dentro del coche pero en el relanzamiento me pude despegar rápido de Maxi (Vivot) y no darle lugar a tomar la succión&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
              ...
              <table width="265" height="211" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
							...
							<a href="tcm-fecha2.php"><img src="boton fecha tcm.png" width="187" height="34" border="0" /></a><br />
							...
							<a href="crosscountry1-fecha1.php"><img src="boton fecha cross country mundial.png" width="187" height="34" border="0" /></a>
                            </div></td>
                      </tr>
                    </table>
