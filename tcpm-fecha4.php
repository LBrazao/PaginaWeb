...
<title>TC Mouras en Concepción del Uruguay | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('tcpm-fecha4-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTCPMf4.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tcpm-fecha4-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tcpm-fecha4-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tcpm-fecha4-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTCPMf4.php');
echo $cadena;
?>
          </div></div>
	  ...
	  <table width="314" height="120" border="0" cellpadding="0" cellspacing="0" background="fondo clima.jpg" style="margin-left:5px">
        <tr>
          <td><!-- www.TuTiempo.net - Ancho:312px - Alto:120px -->
              <div id="TT_RCjwrBdxdCCaCLvALAwF52o2ItuA1Ej2rdkY1cyoq1z"><a href="http://www.tutiempo.net">El tiempo 15 días</a></div>
            <script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RCjwrBdxdCCaCLvALAwF52o2ItuA1Ej2rdkY1cyoq1z"></script></td>
        </tr>
      </table></td>
  </tr>
</table>
        ...
        <td width="508" valign="top"><li class="cabezanoticias"><span class="textoenvivo" >VIDEOS</span></li>
              ...
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/CiJ4-yDSQII" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td></td>
                              ...
                              <?php
$cadena=file_get_contents('tcpm-fecha4-videos.php');
echo $cadena;
?>
                  ...
                  <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tcpm-fecha4-final.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="tcpm-fecha4-final.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tcpm-fecha4-final.php">Final - Domingo </a></td>
                        </tr>
                      </table></td>
                      <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tcpm-fecha4-sabado.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="tcpm-fecha4-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tcpm-fecha4-sabado.php">Clasificación - Sábado </a></td>
                        </tr>
                      </table></td>
                    </tr>
                  </table>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Juan Bava (Previa) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    ...
                                    <span class="Verdanachico">&quot;Perdimos la punta del campeonato en la última fecha pero lo importante es que seguimos sumando. En este tipo de campeonato hay que ser muy regular ya que con esta escala de puntos un abandono te relega mucho. En la última fecha nos complicaron los 30 kilos de lastre por las victorias para clasificar, pero el ritmo del auto se mostró competitivo en carrera, así que eso nos da confianza&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
