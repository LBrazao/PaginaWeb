...
<body>
<span class="Estilo1">5º Entrenamiento                          </span><br />
<table><tr><td><?php

$twit = file_get_contents('http://actc.org.ar/v3/carrera-on-line-resultados.ajax.php?intIDCarrera=496&intIDTanda=26');
