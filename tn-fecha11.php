...
<title>Turismo Nacional en Posadas | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="535"><div class="titlecategoria">Posadas</div>
      <div class="subtitle">FECHA 11 | TURISMO NACIONAL </div></td>
    <td width="455"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">RÉCORD:</span> J. Di Palma (1'40&quot;956) <br />
...
$cadena=file_get_contents('tn-fecha11-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTNf11.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tn-fecha11-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tn-fecha11-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tn-fecha11-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTNf11.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_tBjArxthdIdad1pAMArEDkDkjtnA1EClbd1dEZyIKEj">El tiempo por Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_tBjArxthdIdad1pAMArEDkDkjtnA1EClbd1dEZyIKEj"></script></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/pZGCHgbnC8g" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
					...
					<div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('tn-fecha11-videos.php');
echo $cadena;
?>
                    ...
                    <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tn-fecha11-previa.jpg" width="233" height="136" border="0"/><br />
                                    <div class="playfoto"><a href="/2013/tn3-fecha9.php#fotos"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                            </div></td>
                          </tr>
                          <tr>
                            <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="/2013/tn3-fecha9.php#fotos">Las fotos de la última en Posadas </a></td>
                          </tr>
                        </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Fabián Yannantuoni (Previa) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="yannantuoni.jpg" width="120" height="172" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;El equipo tenía algunas cosas para probar de cara a la competencia de Posadas, porque en la carrera pasada de Alta Gracia nos quedaron algunas dudas acerca del funcionamiento del Peugeot 308. Por eso, con el motor que vamos a usar en Posadas, quisimos con el equipo establecer algunas conclusiones necesarias probando distintos elementos y logrando el salto de calidad buscado en esta prueba. Pensando en la competencia que viene, es clave tener un buen motor considerando las trepadas que tiene el circuito y una buena tracción en el auto sobre todo en las primeras curvas &quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
              ...
              <table width="265" height="211" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"> <a href="toprace-fecha11.php"><img src="boton fecha top race.png" width="187" height="34" border="0" /></a><br />
