...
<title>MARIANO AC&Eacute;BAL (COMISARIO DEPORTIVO) EXPLICA LA CANCELACI&Oacute;N DE LA CARRERA | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">MARIANO AC&Eacute;BAL (COMISARIO DEPORTIVO) EXPLICA LA CANCELACI&Oacute;N DE LA CARRERA </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">12 de Febrero de 2017 |</span> <span style="color:#DD0005; font-weight:bold">TURISMO NACIONAL </span> </td>
              <td width="35%"><div align="right" class="Estilo15"></div></td>
            </tr>
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/oh3XEn689sc?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="514" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="190"><a href="tn-fecha13.php" class="buttons_propierties"> <img src="boton noticias.png" border="0" width="190" height="38" />
                        <div class="buttons_align">RESULTADOS</div>
                  </a></td>
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tn-fecha13-cancelacion.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Las intensas en incesantes lluvias provocaron que los comisarios deportivos debieran cancelar la final de la Clase 3 en La Plata. Mariano Ac&eacute;bal, integrante del cuerpo de comisarios de la CDA, explic&oacute; paso a paso el procedimiento para la cancelaci&oacute;n y lo que podr&iacute;a pactarse en un futuro como fecha adicional. </span><span class="Estilo11"></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tn-fecha13-cancelacion.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
