...
<title>Turismo Nacional en Olavarría | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="535"><div class="titlecategoria">Olavarría</div>
      <div class="subtitle">FECHA 3 | TURISMO NACIONAL </div></td>
    <td width="455"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><img src="circuito olavarria 2.png" width="238" height="108" border="0" /></td>
        </tr>
        <tr>
...
$cadena=file_get_contents('tn-fecha3-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTNf3.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tn-fecha3-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tn-fecha3-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tn-fecha3-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTNf3.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_txtALBYhYUUa8LDULAwEzEjkDtlUMYW2LYkt1cCIakz"><a href="http://www.tutiempo.net">Tutiempo.net</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_txtALBYhYUUa8LDULAwEzEjkDtlUMYW2LYkt1cCIakz"></script></td>
        </tr>
      </table></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/hLS9i1GdILg" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('tn-fecha3-videos.php');
echo $cadena;
?>
                          </div>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="/tn3-fecha12-final.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="/tn3-fecha12-final.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="/tn3-fecha12-final.php">La última carrera en Olavarría </a></td>
                      </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Matías Rossi (Previa) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="rossi1.jpg" width="120" height="134" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Las expectativas son buenas en función de seguir evolucionando el auto. En San Jorge nos fue un poquito mejor que en La Plata y esperamos lo mismo, dar un pasito en calidad con respecto a la última carrera. Sobre todo, ser confiables y llegar en la zona de puntos hasta que estemos bien con el auto, como para ganar. Ese es el objetivo principal. La de Olavarría es una pista que nos cuesta. Cuando definimos, y ganamos, el campeonato no habíamos andado bien. Tenemos cierta alerta sobre la pista. Es un circuito de poco grip, similar a San Jorge, y a nosotros nos cuesta. Es más rápido pero en la adherencia es muy parecido&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
              ...
              <table width="265" height="211" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"> <a href="motogp-fecha2.php"><img src="boton fecha motogp.png" width="187" height="34" border="0" /></a><br />
