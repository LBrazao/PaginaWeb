...
<title>Turismo Nacional en San Luis | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="535"><div class="titlecategoria">San Luis </div>
...
$cadena=file_get_contents('tn-fecha4-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTNf4.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tn-fecha4-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tn-fecha4-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tn-fecha4-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTNf4.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_vBnALxtBYSMan1vKLfwl3F32m9aK14nlLtEtksCIaEz"><a href="http://www.tutiempo.net">El tiempo por Tutiempo.net</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vBnALxtBYSMan1vKLfwl3F32m9aK14nlLtEtksCIaEz"></script></td>
        </tr>
      </table></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/g5BWtJEZWIc" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('tn-fecha4-videos.php');
echo $cadena;
?>
                          </div>
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    ...
                                    <span class="Verdanachico">&quot;Las expectativas son buenas. El equipo probó con Juan Manuel Silva en Paraná; yo no pude girar porque por recomendación médica, por lo que me pasó el fin de semana, me tuve que quedar en Buenos Aires. Tratando de seguir de seguir con el desarrollo del auto para estar cada bien un poquito mejor. En San Luis siempre nos fue bien y además creo que es una pista que nos puede caer bien con el auto. Está bueno llegar sin kilos en función de la carrera para tratar de aprovechar esa condición y sumar una buena cantidad de puntos e ilusionarnos con una victoria&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div style="padding:4px"> <a href="motogp-fecha4.php"><img src="boton fecha motogp.png" width="187" height="34" border="0" /></a><br />
                                ...
                                <a href="topraceseries-fecha3.php"><img src="boton fecha tr series.png" width="187" height="34" border="0" /></a>
                              <br />
