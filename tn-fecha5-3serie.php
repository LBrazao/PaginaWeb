...
<title>ROSSI GANA UNA DE LAS MEJORES SERIES DE LA HISTORIA DEL TURISMO NACIONAL | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">ROSSI GANA UNA DE LAS MEJORES SERIES DE LA HISTORIA DEL TURISMO NACIONAL  </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><iframe src="http://www.youtube.com/embed/soX7ffAoZZw?rel=0&amp;autoplay=1" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
            </tr>
            <tr>
              <td colspan="2"><table width="704" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tn-fecha5-3serie.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
		  ...
		  <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
            <tr>
              <td width="235" height="100"><div align="center"><a href="tn-fecha5-3seriereacciones.php"><img style="border:#999999 solid 1px" src="tn-fecha5-3seriereacciones.jpg" width="233" height="136" border="0"/></a><br />
              </div></td>
              <td width="348"><div style="padding:4px;"><a href="tn-fecha5-3seriereacciones.php" class="titulofotos">VIDEO: las reacciones de los pilotos tras la encarnizada tercera serie</a></div></td>
            </tr>
          </table>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tn-fecha5-3serie.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
