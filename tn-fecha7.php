...
$cadena=file_get_contents('tn-fecha7-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTNf7.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("tn-fecha7-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("tn-fecha7-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("tn-fecha7-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTNf7.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_RxtArxtxtc898LvULfwFoFI2ItlUTYW2Ld1dkci5KEz">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RxtArxtxtc898LvULfwFoFI2ItlUTYW2Ld1dkci5KEz"></script></td>
        </tr>
      </table></td>
  </tr>
</table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/0qfF5Ap2oy0" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <div id="actualizacion_videos">
                        <?php
$cadena=file_get_contents('tn-fecha7-videos.php');
echo $cadena;
?>
                      </div>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="tn-fecha7-domingo.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="tn-fecha7-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="tn-fecha7-domingo.php">Selección del fin de semana </a></td>
                        </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Mauricio Lambiris (Ganador) </span></td>
                                    ...
                                    <table width="49" height="23" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="49"><table width="46" height="19" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFF00">
                                            <tr>
                                              <td><div align="center" class="Estilo126">82</div></td>
                                            </tr>
                                        </table></td>
                                      </tr>
                                    </table>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="lambiris1.jpg" width="120" height="170" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Hace rato que el equipo se merecía esta victoria y que el auto funciona muy bien y por una razón u otra no podíamos redondear un fin de semana. Ayer en clasificación no pudimos cerrar una buena vuelta y a partir de la serie el auto se empezó a mostrar muy rápido. En la final al principio cuando Castellano y yo logramos pasar a Pernía lo empecé a atacar al Pinchito pero no podía pasarlo por ningún lado y decidí apurarlo pero no quería gastar mi auto sabiendo que al final de la carrera iba a empeorar su ritmo y creo que así fue, yo entraba más rápido en el carrusel y podía intentarlo y arranqué la maniobra ahí y lo terminé pasando en la segunda curva plana.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
              ...
              <table width="265" height="211" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div style="padding:4px"> <a href="tc2000-fecha6.php"><img src="boton fecha tc2000.png" width="187" height="34" border="0" /></a><br />
