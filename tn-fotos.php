...
<title>Turismo Nacional | Fotos</title>
  ...
  <tr>
    <td valign="top"><div style="padding:8px;">
      <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
        <tr>
          <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="../tn3-fecha12-final.jpg" width="233" height="136" border="0"/><br />
                  <div class="playfoto"><a href="../tn3-fecha12-final.php" onmouseover="changefoto1(), MM_swapImage('camara1','','camara.png',1)"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" onmouseout="changefotosalir()"/></a></div>
          </div></td>
          <td width="348"><div style="padding:4px;"><a href="../tn3-fecha12-final.php" class="titulofotos">Final Clase 3 - Olavarr&iacute;a </a><br />
              <a href="../tn3-fecha12-final.php" class="subtitulofotos">VER FOTOS &gt;&gt;</a></div></td>
        </tr>
      </table>
      <br />
      <table width="583" height="136" border="0" cellpadding="0" cellspacing="0" background="fondo semitransparente.png">
        <tr>
          <td width="235" height="100"><div align="center"><img style="border:#999999 solid 1px" src="../tn2-fecha12-final.jpg" width="233" height="136" border="0"/><br />
                  <div class="playfoto"><a href="../tn2-fecha12-final.php" onmouseover="changefoto1(), MM_swapImage('camara1','','camara.png',1)"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" onmouseout="changefotosalir()"/></a></div>
          </div></td>
          <td width="348"><div style="padding:4px;"><a href="../tn2-fecha12-final.php" class="titulofotos">Final Clase 2 - Olavarr&iacute;a </a><br />
              <a href="../tn2-fecha12-final.php" class="subtitulofotos">VER FOTOS &gt;&gt;</a></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
