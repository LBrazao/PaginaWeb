...
<table width="341" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="535"><span style="font-family:Arial, Helvetica, sans-serif"><strong><i>3º Serie (Clase 2) </i>           </strong></span><span class="Estilo6"> </span></td>
  </tr>
</table> 

<?php

$twit = file_get_contents('http://www.apat.org.ar/tiemposlistar.php?id=11&idc=2&idcr=157');
