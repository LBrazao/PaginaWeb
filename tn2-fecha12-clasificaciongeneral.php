...
<body>
<b><span class="Estilo1">Clasificación General (Clase 2)  - <SPAN style="color:#FF0000; text-decoration:underline">FINALIZADO  </SPAN>                       </span></b><br />
<table border="0" cellpadding="0" cellspacing="0"><?php

$twit = file_get_contents('http://www.apat.org.ar/resultados/2/2017-12-03');

$inicio = strpos($twit, '<td colspan="7" class="TabResTitulo">GENERAL CLASIFICACI&Oacute;N <strong>C2</strong></td>');

$final = strpos($twit, '<td colspan="7" class="TabResTitulo">1&deg; ENTRENAMIENTO <strong>C2</strong></td>');
