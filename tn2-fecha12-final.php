...
<body>
<b><span class="Estilo1">Final (Clase 2)  - <SPAN style="color:#FF0000; text-decoration:underline">FINALIZADO  </SPAN>                       </span></b><br />
<table border="0" cellpadding="0" cellspacing="0"><?php

$twit = file_get_contents('http://www.apat.org.ar/resultados/2/2017-12-03');

$inicio = strpos($twit, '<td colspan="7" class="TabResTitulo">FINAL <strong>C2</strong></td>');

$final = strpos($twit, '<table border="0" cellspacing="0" cellpadding="2" class="table table-bordered">');
