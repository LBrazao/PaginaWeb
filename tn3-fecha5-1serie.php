...
<table width="341" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="535"><span style="font-family:Arial, Helvetica, sans-serif"><strong><i>1º Serie (Clase 3) </i>           </strong></span><span class="Estilo6"> </span></td>
  </tr>
</table> 

<?php

$twit = file_get_contents('http://www.apat.org.ar/tiemposlistar.php?id=12&idc=3&idcr=161');
