  ...
  <tr>
   ...
   <i> <span style="color:#FF0000">RONDA 2 (Q2)</span> </i></span></div></td>
    <td width="366"><table width="365" height="38" border="0" align="right" cellpadding="0" cellspacing="3">
      <tr>
        <td width="121" background="boton general.jpg"><div align="center"><a href="toprace-fecha10-q1.php" style="color:#FFFFFF; text-decoration:none; font-size:16px; font-weight:bold">Ronda 1 (Q1) </a></div></td>
        <td width="121" background="boton general.jpg"><div align="center"><a href="toprace-fecha10-q2.php" style="color:#FFFFFF; text-decoration:none; font-size:16px; font-weight:bold">Ronda 2 (Q2) </a></div></td>
        <td width="121" background="boton general.jpg"><div align="center"><a href="toprace-fecha10-q3.php" style="color:#FFFFFF; text-decoration:none; font-size:16px; font-weight:bold">Ronda 3 (Q3) </a></div></td>
      </tr>
    </table></td>
  </tr>
</table>
...
$twit = file_get_contents('http://toprace.com.ar/tr/carrera-on-line-resultados.ajax.php?intIDCarrera=11&intIDTanda=14');
