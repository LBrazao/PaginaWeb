...
<title>EL CASCO Y EL HABIT&Aacute;CULO DE MAURO GIALLOMBARDO LUEGO DEL INCENDIO | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9"> EL CASCO Y EL HABIT&Aacute;CULO DE MAURO GIALLOMBARDO LUEGO DEL INCENDIO </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="toprace-fecha12-giallombardo1.jpg" width="754" height="425" /></span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="514" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="190"><a href="toprace-fecha12.php" class="buttons_propierties"> <img src="boton noticias.png" border="0" width="190" height="38" />
                        <div class="buttons_align">RESULTADOS</div>
                  </a></td>
                  <td width="190"><a href="toprace-posiciones.php" class="buttons_propierties"> <img src="boton noticias.png" border="0" width="190" height="38" />
                        <div class="buttons_align">CAMPEONATO</div>
                  </a></td>
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2015/toprace-fecha12-giallombardo1.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">Mauro Giallombardo sufri&oacute; un incendio dentro de su habit&aacute;culo durante la final del Top Race. R&aacute;pidamente fue trasladado a un centro asistencial en donde se le hizo un diagn&oacute;stico. Se diagnosticaron quemaduras en la nariz (grado 2), mano (grado 1) y rodilla (grado 1) sin comprometer las v&iacute;as respiratorias. El piloto de Bernal permanecer&aacute; en terapia intensiva hasta ma&ntilde;ana para realizar las correspondientes curaciones.</span></p>
          <p><span class="Estilo11">En las fotos reproducidas por el fot&oacute;grafo Guillermo Cejas y el periodista Javier Delle Rose se puede observar c&oacute;mo qued&oacute; el interior del auto y el casco del piloto.</span></p>
          <p><span class="Estilo11"><img src="toprace-fecha12-giallombardo2.jpg" width="754" height="566" />.</span></p>
          <p><span class="Estilo11">
            AQU&Iacute; EL VIDEO DEL INCENDIO:
                <iframe src="http://www.youtube.com/embed/v8LfvRtPXxk" name="contenedor" width="754" height="425" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2015/toprace-fecha12-giallombardo1.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
