...
<title>Top Race en Nueve de Julio | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Nueve de Julio </div>
    ...
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">RÉCORD:</span> N. Fontana (1'30&quot;628) <br />
            <span style="font-weight:bold">EXTENSI&Oacute;N:</span> 4647 metros </div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
$cadena=file_get_contents('toprace-fecha2-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTRV6f2.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("toprace-fecha2-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("toprace-fecha2-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("toprace-fecha2-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTRV6f2.php');
echo $cadena;
?>
          </div></div>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/AlUkVq3pU_M" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('toprace-fecha2-videos.php');
echo $cadena;
?>
                          </div>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Facundo Regalía (Previa) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="regalia.jpg" width="120" height="178" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Estoy preparado y con muchísimas ganas de afrontar la segunda fecha del campeonato. Después del primer contacto en Paraná, ya voy con el conocimiento del auto y si bien la pista será nueva para mí, ya di el primer paso, entré en confianza con el equipo y ahora debo seguir con la adaptación. El objetivo es dar un paso adelante, poder sentirme mejor con el auto, seguir buscando los límites y tener más confianza. Todo lo que pasó en Paraná, tanto lo malo como lo bueno, todo me sirvió e intentaré sacar el máximo provecho este fin de semana en Nueve de Julio. Me preparé en el simulador y analizando distintas cámaras a bordo, así que espero adaptarme rápido al circuito. Llego muy bien preparado, sé que con paciencia y mucho sacrificio las cosas van a salir muy bien &quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
