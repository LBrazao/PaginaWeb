...
<title>Top Race en Concepción del Uruguay | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('toprace-fecha9-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTRV6f9.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("toprace-fecha9-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("toprace-fecha9-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("toprace-fecha9-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTRV6f9.php');
echo $cadena;
?>
          </div></div>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="toprace-fecha9-viernes.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="toprace-fecha9-viernes.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="toprace-fecha9-viernes.php">Actividad del viernes  </a></td>
                        </tr>
                    </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="207" height="27"><span class="Estilo125">Nicolás Trosset (Previa) </span></td>
                                    ...
                                    <table width="49" height="23" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="49"><table width="46" height="19" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFF00">
                                            <tr>
                                              <td><div align="center" class="Estilo126">214</div></td>
                                            </tr>
                                        </table></td>
                                      </tr>
                                    </table>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="trosset.jpg" width="120" height="126" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Llego con buenas expectativas, el año pasado nos trató bien Concepción con la salvedad de que corrimos con otro tipo de compuesto. En lo personal lo tomo como una carrera más, no me quiero poner demasiada presión porque eso no sirve, aspiro a tener una buena clasificación y dejar todo en la primera final para poder ganar&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
