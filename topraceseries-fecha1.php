...
<title>Top Race Series en Paraná | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
  ...
  <tr>
    ...
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">EXTENSI&Oacute;N:</span> 4100 metros </div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
$cadena=file_get_contents('topraceseries-fecha1-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTRSf1.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("topraceseries-fecha1-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("topraceseries-fecha1-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("topraceseries-fecha1-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTRSf1.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_vCngbhdhd4lanLDKLfwFoFIlI9lK14MlLY1tEsCIKkj"><a href="http://www.tutiempo.net/parana.html">El Tiempo en Paraná</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vCngbhdhd4lanLDKLfwFoFIlI9lK14MlLY1tEsCIKkj"></script></td>
  </tr>
</table>
              ...
              <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/EO-zTSph0DM" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('topraceseries-fecha1-videos.php');
echo $cadena;
?>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="topraceseries-fecha1-domingo.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="toprace-fecha1-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="toprace-fecha1-domingo.php">Top Race en Paraná - Domingo </a></td>
                      </tr>
                    </table></td>
                    <td height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="topraceseries-fecha1-sabado.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="toprace-fecha1-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="toprace-fecha1-sabado.php">Top Race en Paraná - Sábado</a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Violeta Pernice (Domingo) </span></td>
                                    ...
                                    <table width="49" height="23" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="49"><table width="46" height="19" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFF00">
                                            <tr>
                                              <td><div align="center" class="Estilo126">15</div></td>
                                            </tr>
                                        </table></td>
                                      </tr>
                                    </table>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="pernice.jpg" width="120" height="127" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Se hizo un excelentre trabajo todo el fin de semana. En la primer largada no llego a ver a Manuela (Vázquez) que largaba a la par mía porque venía con un ritmo muy lento y cuando llegamos a la curva 1 pude tomar la punta.<br />
                                    Me perjudicó el aceite en la carrera pero comenzar cuarta en el campeonato es realmente importante.&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
