...
<title>Top Race Series en Junín | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('topraceseries-fecha11-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTRSf11.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("topraceseries-fecha11-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("topraceseries-fecha11-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("topraceseries-fecha11-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTRSf11.php');
echo $cadena;
?>
          </div></div>
                  ...
                  <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="topraceseries-fecha11-domingo.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="topraceseries-fecha11-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="topraceseries-fecha11-domingo.php">Top Race Series en Junín </a></td>
                        </tr>
                      </table></td>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Nicolás Cazal (Previa) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="cazal.jpg" width="120" height="162" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Siento un orgullo muy grande por poder llegar a la categoría porque siempre me gustó, brinda espectáculo y son autos hechos para correr. Estar presente y en un equipo tan competitivo me pone muy contento, conozco al equipo de trabajo del Top Race NOA y es bueno, este año tuvimos un rendimiento muy aceptable en la divisional y eso puede ayudarme en la adaptación&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
