...
<title>Top Race Series en Salta | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="618"><div class="titlecategoria">Salta <br />
    </div>
    <div class="subtitle">FECHA 12 | TOP RACE SERIES </div></td>
...
$cadena=file_get_contents('topraceseries-fecha12-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTRSf12.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("topraceseries-fecha12-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("topraceseries-fecha12-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("topraceseries-fecha12-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTRSf12.php');
echo $cadena;
?>
          </div></div>
	  ...
	  <table width="314" height="120" border="0" cellpadding="0" cellspacing="0" background="fondo clima.jpg" style="margin-left:5px">
        <tr>
          <td><!-- www.TuTiempo.net - Ancho:312px - Alto:120px -->
              <div id="TT_txtgrxtxtzD9816UMfwl5lolo9lU1YWlbdkt1sCoaEz">Pronóstico de Tutiempo.net</div>
            <script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_txtgrxtxtzD9816UMfwl5lolo9lU1YWlbdkt1sCoaEz"></script></td>
        </tr>
      </table></td>
  </tr>
</table>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="topraceseries-fecha12-domingo.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="toprace-fecha12-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="toprace-fecha12-domingo.php">Actividad del domingo </a></td>
                      </tr>
                    </table>
                    </td>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="toprace-fecha12-sabado.php">Actividad del viernes y sábado</a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Lucas Valle (Campeón) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="valle.jpg" width="120" height="149" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Todavía no puedo creer que estemos festejando esto, mil veces lo soñé de chico y hoy es una realidad. Esto es en gran parte por el excelente equipo que tenemos, estamos muy lejos, viajamos todos juntos y se formó una gran familia que permite confiar al cien por ciento en todos. Agradezco a Fabricio (Persia) que es un gran profesional, tranquilamente podría haberme tirado afuera en la primera vuelta, pero prefirió correr de manera limpia y eso es para destacar. El año que viene todavía no sé qué vamos a hacer, ahora quiero festejar con el equipo, con mi familia y con mis amigos que hicieron más de 2.500 kilómetros para acompañarme&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
              ...
              <table width="265" height="211" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"> <a href="tn-fecha12.php"><img src="boton fecha tn.png" width="187" height="34" border="0" /></a><br />
                                <a href="toprace-fecha12.php"><img src="boton fecha top race.png" width="187" height="34" border="0" /></a><br />
