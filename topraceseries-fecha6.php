...
<title>Top Race Series en Termas de Río Hondo | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('topraceseries-fecha6-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTRSf6.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("topraceseries-fecha6-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("topraceseries-fecha6-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("topraceseries-fecha6-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTRSf6.php');
echo $cadena;
?>
          </div></div>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><iframe src="http://www.youtube.com/embed/31NhiUmvP7o" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                    </tr>
                    <tr>
                      <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div id="actualizacion_videos">
                            <?php
$cadena=file_get_contents('topraceseries-fecha6-videos.php');
echo $cadena;
?>
                          </div>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="topraceseries-fecha6-domingo.php">Actividad del domingo </a></td>
                      </tr>
                    </table></td>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="topraceseries-fecha6-sabado.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="topraceseries-fecha6-sabado.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="topraceseries-fecha6-sabado.php">Actividad del sábado </a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="222" height="27"><span class="Estilo125">Bruno Boccanera (Ganador) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="boccanera.jpg" width="120" height="164" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Estuvimos muy cera de bajarnos para esta carrera por problemas presupuestarios así que esta victoria es un incentivo. Estamos peleando bien arriba el campeonato y eso nos permite ilusionarnos. Cuando se desprendió el difusor tuve miedo de que pasara lo mismo que en Concordia y tuviéramos que abandonar. Imaginábamos estar competitivos pero no a este muy buen nivel como para sobrepasar a Peter (Olaz) en la largada. Queremos seguir así para poder pelear por el campeonato&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div style="padding:4px"> <a href="toprace-fecha6.php"><img src="boton fecha top race.png" width="187" height="34" border="0" /></a> <br />
                                <a href="f1-fecha10.php"><img src="boton fecha f1.png" width="187" height="34" border="0" /></a> <br />
                                <a href="nascar-fecha18.php"><img src="boton fecha nascar.png" width="187" height="34" border="0" /></a><br />
                            </div></td>
                      </tr>
                    </table>
