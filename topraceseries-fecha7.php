...
<title>Top Race Series en San Juan | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
$cadena=file_get_contents('topraceseries-fecha7-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineTRSf7.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("topraceseries-fecha7-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("topraceseries-fecha7-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("topraceseries-fecha7-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineTRSf7.php');
echo $cadena;
?>
          </div></div>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="topraceseries-fecha7-domingo.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="topraceseries-fecha7-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="topraceseries-fecha7-domingo.php">Actividad del domingo </a></td>
                        </tr>
                    </table></td>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                      ...
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="topraceseries-fecha7-sabado.php">Actividad del viernes y sábado</a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Fabricio Persia (Ganador) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    ...
                                    <span class="Verdanachico">&quot;Este fin de semana es inmejorable, hicimos la pole, ganamos la serie y hoy pudimos ser muy contundentes. Ganamos delante de toda nuestra gente en un autódromo repleto como hace tiempo merecía estar El Zonda. El objetivo no es el campeonato todavía, queremos seguir por este camino para ver si más adelante llegamos con chances, no me siento presionado, hoy no soy el candidato&quot;</span><span class="Verdanachico"></span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
