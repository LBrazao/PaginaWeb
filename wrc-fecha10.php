...
<title>WRC Francia | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
         ...
         <table width="671" height="405" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
           <tr>
             <td valign="bottom"><div id="resultados">
               <?php
$cadena=file_get_contents('wrc-fecha10-resultados.php');
echo $cadena;
?>
             </div></td>
           </tr>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineWRCf10.php");
        }, 100000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("wrc-fecha10-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("wrc-fecha10-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("wrc-fecha10-noticias.php");
        }, 60000);
    });
</script> 

<div id="actualizacion" class="news_wrc"><?php
$cadena=file_get_contents('onlineWRCf10.php');
echo $cadena;
?>
          </div>
...
<div id="TT_vxjwrxYBYIdBETvAMfr1jEjkD9uATdI2rd1dksy5K1z">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vxjwrxYBYIdBETvAMfr1jEjkD9uATdI2rd1dksy5K1z"></script></td>
           </tr>
         </table></td>
   </tr>
 </table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/tEYShoy2yQ8" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('wrc-fecha10-videos.php');
echo $cadena;
?>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="wrc-fecha11-domingo.jpg" width="233" height="136" border="0"/><br />
                                  <div class="playfoto"><a href="wrc-fecha11-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="wrc-fecha11-domingo.php">La última carrera en Francia</a></td>
                        </tr>
                    </table></td>
              ...
              <tr>
                <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                    <tr>
                      <td width="222" height="27"><span class="Estilo125">Sebastien Ogier (Previa) </span></td>
                    ...
                    <tr>
                      <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                          <tr>
                            <td><img src="ogier.jpg" width="120" height="151" /></td>
                          </tr>
                        </table>
                          <span class="Verdanachico">&quot;Córcega está lejos de ser un rallye fácil. ay una serie de tramos nuevos y muchas de las especiales han sido renovadas. Por ello será importante hacer unos reconocimientos precisos. Me gustan este tipo de cambios, ya que hace que el rallye sea un desafío completamente nuevo. Al igual que en Alemania, donde cuatro pilotos estuvimos peleando por la victoria hasta el final, espero que la cita en Córcega sea similar. Después de que Julien y yo no hayamos tenido las mejores actuaciones aquí en los últimos dos años, mi objetivo personal es volver a pilotar bien en el Rallye de Francia y luchar por la victoria.&quot;</span><span class="Verdanachico"></span></td>
                    </tr>
                  </table>
                  <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                    <tr>
