...
<table style="font-family:Arial, Helvetica, sans-serif" width="343" height="32" border="0" cellpadding="0">
  <tr>
    <td width="133">ESPECIAL 1: </td>
    <td width="98" background="boton general activo.jpg"><div align="center"><em>Especial</em></div></td>
    <td width="104" background="boton general.jpg"><div align="center"><a class="link" href="wrc-fecha11-parcial1.php">Parciales</a> </div></td>
  </tr>
</table>
<?php
$twit = file_get_contents('http://www.wrc.com/live-ticker/daten/2015/197/stage.197.1.html');
