...
<table style="font-family:Arial, Helvetica, sans-serif" width="444" height="32" border="0" cellpadding="0">
  <tr>
    ...
    <td width="104" background="boton general.jpg"><div align="center"><a class="link" href="wrc-fecha14-parcial17.php">Parciales</a> </div></td>
  </tr>
</table>
<?php
$twit = file_get_contents('http://www.wrc.com/live-ticker/daten/2017/216/stage.216.17.html');
