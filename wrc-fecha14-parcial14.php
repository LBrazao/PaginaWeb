...
<table style="font-family:Arial, Helvetica, sans-serif" width="437" height="32" border="0" cellpadding="0">
  <tr>
    ...
    <td width="101" background="boton general.jpg"><div align="center"><a class="link" href="wrc-fecha14-especial14.php">Especial</a></div></td>
...
<?php
$twit = file_get_contents('http://www.wrc.com/live-ticker/daten/2017/216/split.216.14.html');
