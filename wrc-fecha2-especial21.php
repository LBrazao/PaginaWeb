...
<table style="font-family:Arial, Helvetica, sans-serif" width="444" height="32" border="0" cellpadding="0">
  <tr>
    ...
    <td width="104" background="boton general.jpg"><div align="center"><a class="link" href="wrc-fecha2-parcial21.php">Parciales</a> </div></td>
  </tr>
</table>
<?php
$twit = file_get_contents('http://www.wrc.com/live-ticker/daten/2016/177/stage.177.21.html');
