...
<table style="font-family:Arial, Helvetica, sans-serif" width="437" height="32" border="0" cellpadding="0">
  <tr>
    ...
    <td width="101" background="boton general.jpg"><div align="center"><a class="link" href="wrc-fecha2-especial21.php">Especial</a></div></td>
    <td width="99" background="boton general.jpg"><div align="center"><a class="link" href="wrc-fecha2-general21.php">General</a></div></td>
    <td width="98" background="boton general activo.jpg"><div align="center"><em>Parciales</em></div></td>
  </tr>
</table>
<?php
$twit = file_get_contents('http://www.wrc.com/live-ticker/daten/2016/177/split.177.21.html');
