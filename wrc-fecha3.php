...
<title>WRC México | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
         ...
         <table width="671" height="405" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
           <tr>
             <td valign="bottom"><div id="resultados">
               <?php
$cadena=file_get_contents('wrc-fecha3-resultados.php');
echo $cadena;
?>
             </div></td>
           </tr>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineWRCf3.php");
        }, 100000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("wrc-fecha3-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("wrc-fecha3-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("wrc-fecha3-noticias.php");
        }, 60000);
    });
</script> 

<div id="actualizacion" class="news_wrc"><?php
$cadena=file_get_contents('onlineWRCf3.php');
echo $cadena;
?>
          </div>
...
<div id="TT_vxtALBthdBY9Y16U1AwkjkDEjtuUMz82rtEtkZy5q1j"><a href="http://www.tutiempo.net/guanajuato.html">Guanajuato</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vxtALBthdBY9Y16U1AwkjkDEjtuUMz82rtEtkZy5q1j"></script></td>
           </tr>
         </table></td>
   </tr>
 </table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/8lSf--p3p_8" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('wrc-fecha3-videos.php');
echo $cadena;
?>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="wrc-fecha3-jueves.php">Actividad del jueves </a></td>
                      </tr>
                    </table></td>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><a href="/2015/wrc-fecha3-domingo.php"><img style="border:#999999 solid 1px" src="/2015/wrc-fecha3-domingo.jpg" width="233" height="136" border="0"/></a><br />
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="/2015/wrc-fecha3-domingo.php">Las fotos de la última en México </a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table>
              ...
              <tr>
                <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                    <tr>
                      <td width="208" height="27"><span class="Estilo125">Sebastien Ogier (Jueves) </span></td>
                    ...
                    <tr>
                      <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                          ...
                          <span class="Verdanachico">&quot;Haber ganado los cortos especiales de esta noche no es una gran ventaja, pero es mejor que nada. Todo cuenta, y esta noche hemos hecho nuestro trabajo; ahora ya estamos deseando que comience realmente el rallye.&quot;</span><span class="Verdanachico"></span></td>
                    </tr>
                  </table>
                  <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                    <tr>
              ...
              <tr>
                <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
				  ...
				  <a href="tcpista-fecha2.php"><img src="boton fecha tc pista.png" width="187" height="34" border="0" /></a><br />
                    ...
                    <a href="nascar-fecha3.php"><img src="boton fecha nascar.png" width="187" height="34" border="0" /></a></div></td>
              </tr>
            </table>
