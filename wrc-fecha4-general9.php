...
<table style="font-family:Arial, Helvetica, sans-serif" width="445" height="32" border="0" cellpadding="0">
  <tr>
    ...
    <td width="103" background="boton general.jpg"><div align="center"><a class="link" href="wrc-fecha4-especial9.php">Especial</a> </div></td>
    <td width="94" background="boton general activo.jpg"><div align="center"><em>General</em></div></td>
    <td width="105" background="boton general.jpg"><div align="center"><a class="link" href="wrc-fecha4-parcial9.php">Parciales</a> </div></td>
  </tr>
</table>
<?php
$twit = file_get_contents('http://www.wrc.com/live-ticker/daten/2016/181/stage.181.9.html');
