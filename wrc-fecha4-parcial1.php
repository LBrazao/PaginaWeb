...
<table style="font-family:Arial, Helvetica, sans-serif" width="319" height="32" border="0" cellpadding="0">
  <tr>
    <td width="112">ESPECIAL 1: </td>
    <td width="101" background="boton general.jpg"><div align="center"><a class="link" href="wrc-fecha4-especial1.php">Especial</a></div></td>
    <td width="98" background="boton general activo.jpg"><div align="center"><em>Parciales</em></div></td>
  </tr>
</table>
<?php
$twit = file_get_contents('http://www.wrc.com/live-ticker/daten/2015/135/split.135.1.html');
...
$cadenaABuscar = str_replace('class="header_sort">Start</th>', 'class="header_sort">Órden</th>',$cadenaABuscar);
...
$cadenaABuscar = str_replace('data-lang-po="Czas odcinka">Stage Time</th>', 'data-lang-po="Czas odcinka">Tiempo final</th>',$cadenaABuscar);
$cadenaABuscar = str_replace('data-lang-po="Czas odcinka">Stage Time</th>', 'data-lang-po="Czas odcinka">Tiempo final</th>',$cadenaABuscar);
$cadenaABuscar = str_replace('<td class=""><img src', '<td class="" width="300px"><img src',$cadenaABuscar);
$cadenaABuscar = str_replace('<td class="highlight"><img src', '<td class="highlight" width="300px"><img src',$cadenaABuscar);
echo $cadenaABuscar;
