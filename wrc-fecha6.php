...
<title>WRC Portugal | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Italia<br />
    </div>
    <div class="subtitle">FECHA 6 | RALLY MUNDIAL </div></td>
         ...
         <table width="671" height="405" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
           <tr>
             <td valign="bottom"><div id="resultados">
               <?php
$cadena=file_get_contents('wrc-fecha6-resultados.php');
echo $cadena;
?>
             </div></td>
           </tr>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineWRCf6.php");
        }, 100000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("wrc-fecha6-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("wrc-fecha6-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("wrc-fecha6-noticias.php");
        }, 60000);
    });
</script> 

<div id="actualizacion" class="news_wrc"><?php
$cadena=file_get_contents('onlineWRCf6.php');
echo $cadena;
?>
          </div>
...
<div id="TT_vhjwbBYhdfIB1LDAMfw1z1zEz9nATjC2bt1YEcCIakD"><a href="http://www.tutiempo.net/alghero.html">Pronóstico meteorológico para Alghero</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vhjwbBYhdfIB1LDAMfw1z1zEz9nATjC2bt1YEcCIakD"></script></td>
           </tr>
         </table></td>
   </tr>
 </table>
            ...
            <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
              <tr>
                <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><iframe src="http://www.youtube.com/embed/D-2tXXw0yrY" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                  </tr>
                  <tr>
                    <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('wrc-fecha6-videos.php');
echo $cadena;
?>
              ...
              <tr>
                <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                    <tr>
                      <td width="208" height="27"><span class="Estilo125">Thierry Neuville (Viernes) </span></td>
                    ...
                    <tr>
                      <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                          <tr>
                            <td><img src="neuville.jpg" width="120" height="174" /></td>
                          </tr>
                        </table>
                          <span class="Verdanachico">&quot;Creo que todo el mundo está contento de vernos de nuevo al frente. Por la mañana me ayudaron las pistas más limpias, pero por la tarde hemos mantenido un buen ritmo y hemos ganado confianza. Espero que podamos continuar con el mismo ritmo mañana. Tuvimos muchos problemas al final del año pasado y este año, así que nos merecemos estar aquí&quot;</span><span class="Verdanachico"></span></td>
                    </tr>
                  </table>
                  <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                    <tr>
