...
<table style="font-family:Arial, Helvetica, sans-serif" width="137" height="32" border="0" cellpadding="0">
  <tr>
    <td width="133">ESPECIAL 1: </td>
  </tr>
</table>
<?php
$twit = file_get_contents('http://www.wrc.com/live-ticker/daten/2016/191/stage.191.1.html');
