...
<table width="341" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="535"><span style="font-family:Arial, Helvetica, sans-serif" class="Estilo9 Estilo1 Estilo7"><strong><i>1º Entrenamiento</i></strong></span></td>
  </tr>
</table> 

<?php

$twit = file_get_contents('http://www.touringcars.net/results/wtcc/2015/qttest.php');
