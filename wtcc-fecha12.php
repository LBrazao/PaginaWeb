...
<title>WTCC en Qatar | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Qatar</div>
        <div class="subtitle">FECHA 12 | WTCC </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">DURACIÓN:</span> 12 vueltas <br />
...
$cadena=file_get_contents('wtcc-fecha12-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineWTCCf12.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("wtcc-fecha12-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("wtcc-fecha12-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("wtcc-fecha12-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineWTCCf12.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_thjgrBdhdIha2MDAMfwlGFGFm9n1TAflrt1dEcCoaED"><a href="http://www.tutiempo.net">Tutiempo.net</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_thjgrBdhdIha2MDAMfwlGFGFm9n1TAflrt1dEcCoaED"></script></td>
  </tr>
</table>
              ...
              <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/Fri2Vt6rN14" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('wtcc-fecha12-videos.php');
echo $cadena;
?>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">José María López 
                                (Previo) </span></td>
                              ...
                              <tr>
                                ...
                                <span class="Verdanachico">&quot;Compartir la carrera con Nasser (Al-Attiyah) será fantástico y también a todos los chicos de aquí. Algunas cosas han cambiado. Vamos a extrañar Seb [Loeb]. Realmente lo admiro y ha sido un placer compartir el equipo con él. Para mí él es un ídolo y yo siempre he dicho que desde que tenía ocho años he estado siguiendo los rallyes y siguiéndolo mucho. Así que estoy muy feliz de estar con este equipo increíble por un año más. Hay mucho trabajo por hacer y voy a tener un compañero de equipo muy difícil de nuevo que es Yvan.&quot;</span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
						  ...
						  <a href="renault-fecha11.php"><img src="boton fecha renault.png" width="187" height="34" border="0" /></a><br />
                              ...
                              <a href="f1-fecha19.php"><img src="boton fecha f1.png" width="187" height="34" border="0" /></a>
                          </div></td>
                      </tr>
                    </table>
