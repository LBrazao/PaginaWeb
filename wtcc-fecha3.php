...
<title>WTCC en Marruecos | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Marruecos   <br />
    </div>
        <div class="subtitle">FECHA 4 | WTCC </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><img src="circuito marrakech1.png" width="238" height="108" border="0" /></td>
        </tr>
        <tr>
...
$cadena=file_get_contents('wtcc-fecha3-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineWTCCf3.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("wtcc-fecha3-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("wtcc-fecha3-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("wtcc-fecha3-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineWTCCf3.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_RxtgLBYBtzWcDTpU1AwlGl3lGtuUTDD2LdEdEZCoK1j"><a href="http://www.tutiempo.net">El tiempo por Tutiempo.net</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RxtgLBYBtzWcDTpU1AwlGl3lGtuUTDD2LdEdEZCoK1j"></script></td>
  </tr>
</table>
              ...
              <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/8rt5j0JkUJM" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('wtcc-fecha3-videos.php');
echo $cadena;
?>
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    ...
                                    <span class="Verdanachico">&quot;No sé mucho acerca del trazado pero no es el tradicional veloz y de chicanas de alta velocidad como era antes, cuando encarábamos los bordillos a pleno. Un circuito callejero es siempre difícil, la temperatura será elevada pero es un gran país y esperemos que podamos estar al frente como el año pasado. De todos modos, este año es otra historia, estamos padeciendo [al llevar 80 kilos de lastre] y estamos luchando muchísimo más con nuestros rivales.&quot;</span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
