...
<title>WTCC en Rusia | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Moscú<br />
    </div>
        <div class="subtitle">FECHA 6 | WTCC </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><img src="circuito moscu.png" width="238" height="108" border="0" /></td>
        </tr>
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">DURACIÓN:</span> 16 y 17 vueltas <br />
                    <span style="font-weight:bold">EXTENSI&Oacute;N:</span> 3931 metros </div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
$cadena=file_get_contents('wtcc-fecha6-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineWTCCf6.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("wtcc-fecha6-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("wtcc-fecha6-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("wtcc-fecha6-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineWTCCf6.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_RxtAbxdhdzU9W16UMfr1D1j1D9n1M1zFrtEY1ZCIq1z"><a href="http://www.tutiempo.net/moscu.html">Moscú</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_RxtAbxdhdzU9W16UMfr1D1j1D9n1M1zFrtEY1ZCIq1z"></script></td>
  </tr>
</table>
              ...
              <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/MZ9TGR3p7Kc" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <div id="actualizacion_videos">
                              <?php
$cadena=file_get_contents('wtcc-fecha6-videos.php');
echo $cadena;
?>
                ...
                <table width="498" height="170" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="170" valign="top"><table width="220" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="100"><div align="center"><img style="border:#999999 solid 1px" src="/2015/wtcc-fecha5-domingo.jpg" width="233" height="136" border="0"/><br />
                                <div class="playfoto"><a href="/2015/wtcc-fecha5-domingo.php"><img src="camarainactivo.png" name="camara1" width="233" height="136" border="0" id="camara1" /></a></div>
                        </div></td>
                      </tr>
                      <tr>
                        <td height="27"><a id="textofoto1" class="imagenfoto_btn" href="/2015/wtcc-fecha5-domingo.php">La última carrera en Moscú</a></td>
                      </tr>
                    </table></td>
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    ...
                                    <span class="Verdanachico">&quot;Moscú es siempre fue una muy buena pista para Yvan (Muller). A él le gusta mucho, y en mi caso voy a tener que trabajar mucho porque es la que más me costó: no es fácil, la pista es abrasiva y te gasta muy rápido la goma. Uno siempre está luchando contra las idas de cola. Tiene varios lugares de sobrepaso. Arriesgué mucho hasta ahora en el campeonato y gané todas las carreras que tenía que ganar, ahora es momento de dejar arriesgar a los demás y tal vez incluso pueda cuidar un poco más. Estoy en una posición envidiable en el campeonato, pero  no voy a descansar. No está en mi naturaleza. Voy a estar tan motivado como siempre, aunque mi objetivo principal va a ser terminar las dos carreras en los puntos, algo que nunca he logrado hacer en este circuito.&quot;</span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <div style="padding:4px"> <a href="stc2000-fecha4.php"><img src="boton fecha stc2000.png" width="187" height="34" border="0" /></a><br />
                              ...
                              <a href="nascar-fecha13.php"><img src="boton fecha nascar.png" width="187" height="34" border="0" /></a><br />
                          </div></td>
                      </tr>
                    </table>
