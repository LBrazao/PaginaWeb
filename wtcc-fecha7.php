...
<title>WTCC en Portugal | Tiempos en vivo, Fotos, Videos, Entrevistas</title>
...
<table width="990" height="168" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="501"><div class="titlecategoria">Vila Real <br />
    </div>
        <div class="subtitle">FECHA 7 | WTCC </div></td>
    <td width="489"><div align="right">
      <table width="238" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><img src="circuito vila real.png" width="238" height="108" border="0" /></td>
        </tr>
        <tr>
          <td><div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FFFFFF" align="center"><span style="font-weight:bold">DURACIÓN:</span> 13 y 14 vueltas <br />
                    <span style="font-weight:bold">EXTENSI&Oacute;N:</span> 4785 metros </div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
$cadena=file_get_contents('wtcc-fecha7-resultados.php');
echo $cadena;
?>
          </div>
		  </td>
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion").load("onlineWTCCf7.php");
        }, 100000);
    });
</script>
...
$(document).ready(function(){
        setInterval(function() {
            $("#resultados").load("wtcc-fecha7-resultados.php");
        }, 60000);
    });
</script> 
...
$(document).ready(function(){
        setInterval(function() {
            $("#actualizacion_videos").load("wtcc-fecha7-videos.php");
        }, 60000);
    });
</script> 
<script type="text/javascript">
$(document).ready(function(){
        setInterval(function() {
            $("#noticias").load("wtcc-fecha7-noticias.php");
        }, 60000);
    });
</script> 
...
$cadena=file_get_contents('onlineWTCCf7.php');
echo $cadena;
?>
          </div></div>
...
<div id="TT_vBtALBYxY1Y9aTpULAw1jED1jtaULzWFLtktksCIqED">Pronóstico de Tutiempo.net</div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vBtALBYxY1Y9aTpULAw1jED1jtaULzWFLtktksCIqED"></script></td>
  </tr>
</table>
              ...
              <table width="508" border="0" cellpadding="5" cellspacing="0" bgcolor="#F4F4F4">
                <tr>
                  <td valign="top"><table width="498" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><iframe src="http://www.youtube.com/embed/mjEg-KE6rkc" name="contenedor" width="498" height="280" frameborder="0" id="contenedor" allowfullscreen="allowfullscreen"></iframe></td>
                      </tr>
                  </table></td>
                </tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="97%" height="160" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:4px;">
                              <tr>
                                <td width="208" height="27"><span class="Estilo125">Tom Coronel (Ganador) </span></td>
                              ...
                              <tr>
                                <td height="111" colspan="2" valign="top"><table width="58" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td><img src="coronel1.jpg" width="120" height="179" /></td>
                                    </tr>
                                  </table>
                                    <span class="Verdanachico">&quot;Este es un circuito muy difícil, pero  sabía que tenía una buena oportunidad aquí. Siempre lo dije: Marruecos, Vila Real y Japón deben ser buenos para mí, y hasta ahora todo salió bien así que estoy realmente feliz. Mi carrera fue un poco bajo la presión de Chilton, que era un poco más rápido que yo en las partes rápidas pero finalmente pude alejarme un poco en las frenadas. &quot;</span></td>
                              </tr>
                            </table>
                            <table width="100%" height="6" border="0" cellpadding="0" cellspacing="0">
                              <tr>
