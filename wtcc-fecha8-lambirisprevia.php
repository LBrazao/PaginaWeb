...
<title>MAURICIO LAMBIRIS CORRER&Aacute; ESTE FIN DE SEMANA EN EL WTCC | TC La Revista</title>
...
<table width="990" height="91" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="819" valign="top"><div style="padding:8px;">
      <p><span class="Estilo9">MAURICIO LAMBIRIS CORRER&Aacute; ESTE FIN DE SEMANA EN EL WTCC </span></p>
          <table style="font-family:Arial, Helvetica, sans-serif; font-size:14px" width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
              <td width="65%" height="19"><span style="color:#666666">5 de Agosto de 2016 |</span> <span style="color:#DD0005; font-weight:bold">WTCC</span> </td>
              <td width="35%"><div align="right" class="Estilo15"></div></td>
            </tr>
            <tr>
              <td colspan="2"><span class="Estilo11"><img style="border:#999999 1px solid" src="wtcc-fecha8-lambirisprevia.jpg" width="754" height="425" /></span></td>
            </tr>
            <tr>
              <td colspan="2"><table width="514" height="44" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="134"><div class="fb-like" data-href="http://www.tclarevista.com.ar/2016/tc-fecha8-cronicaviernes.php" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div></td>
                </tr>
              </table></td>
            </tr>
          </table>
          <p><span class="Estilo11">En los &uacute;ltimos d&iacute;as se confirm&oacute; la ausencia del piloto h&uacute;ngaro Ferenc Ficza en la carrera del WTCC en Termas de R&iacute;o Hondo debido a que se someti&oacute; a la extracci&oacute;n de su ap&eacute;ndice la &uacute;ltima semana. El chofer del Honda n&uacute;mero 55 a&uacute;n no se ha recuperado para esta carrera y r&aacute;pidamente Mauricio Lambiris y su entorno han puesto marcha para poder ocupar la butaca que quedar&aacute; libre este fin de semana.</span></p>
          <p><span class="Estilo11">En las &uacute;ltimas horas la FIA ha aprobado su licencia y su participaci&oacute;n en el evento mientras que el uruguayo ya cerr&oacute; el trato con el Equipo Campos (propietarios del auto) para ocupar esta butaca durante el fin de semana.</span></p>
          <p><span class="Estilo11">En los pr&oacute;ximos minutos (18:30), Lambiris saldr&aacute; a pista para el primer entrenamiento del fin de semana... </span><span class="Estilo11"></span></p>
          <p><span class="Estilo11"><img style="border:#999999 1px solid" src="wtcc-fecha8-lambirisprevia1.jpg" width="362" height="202" />.</span><span class="Estilo11"></span><span class="Estilo11"><img style="border:#999999 1px solid" src="wtcc-fecha8-lambirisprevia2.jpg" width="385" height="201" /></span></p>
          <div id="fb-root"></div>
...
<div class="fb-comments" data-href="http://www.tclarevista.com.ar/2016/tc-fecha8-cronicaviernes.php" data-width="504" data-numposts="5" data-colorscheme="light"></div>
