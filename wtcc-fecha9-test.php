...
.resulttable tbody tr:nth-child(30n+1), .resulttable tbody tr:nth-child(30n+2), .resulttable tbody tr td:nth-child(30n+2),.resulttable tbody tr td:nth-child(30n+3), .resulttable tbody tr td:nth-child(30n+6){
display:none;
}
...
<table width="341" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="535"><span style="font-family:Arial, Helvetica, sans-serif" class="Estilo9 Estilo1 Estilo7"><strong><i>Reconocimiento </i>           </strong></span><span class="Estilo6"> - <u>FINALIZADO</u></span></td>
  </tr>
</table> 

<?php

$twit = file_get_contents('http://www.touringcars.net/results/wtcc/2015/jptest.php');
